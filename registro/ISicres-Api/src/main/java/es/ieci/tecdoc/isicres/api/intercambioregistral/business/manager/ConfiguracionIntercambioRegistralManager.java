...
public interface ConfiguracionIntercambioRegistralManager {
     ...
     * @param code
     * @param nombre
     * @return Lista de <code>EntidadRegistralDCO</code> del DCO que concuerden
     *         con el code y nombre pasado
     */
    public List<EntidadRegistralDCO> buscarEntidadesRegistralesDCO(
	String code, String nombre);
     ...
     * @param code
     * @param nombre
     * @return Lista de <code>UnidadTramitacionDCO</code> del DCO que concuerden
     *         con el code y nombre pasado
     */
    public List<UnidadTramitacionDCO> buscarUnidadesTramitacionDCO(
	String code, String nombre);

    /**
     * Método de búsqueda de Unidades de Tramitación
     * 
     * @param code
     * @param nombre
     * @return Lista de <code>UnidadTramitacionIntercambioRegistralSIRVO</code>
     *         que concuerden con el code y nombre pasado
     */
