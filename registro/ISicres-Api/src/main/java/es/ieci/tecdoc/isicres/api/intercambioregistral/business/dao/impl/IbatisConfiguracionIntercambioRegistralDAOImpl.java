...
public class IbatisConfiguracionIntercambioRegistralDAOImpl implements
	...
	try {
	    ...
	    logger
		.error(
		    "Error en la obtenci�n de una unidad administrativa a partir de lso codigos comunes de entidad registral",
		    exception);
	...
	try {
	    ...
	    logger
		.error(
		    "Error en la obtenci�n de una unidad administrativa a partir de lso codigos comunes de unidad de tramitacion",
		    exception);
	...
	try {
	    ...
	    logger.error(
		"Error en la obtenci�n de la configuraci�n de una entidad registral", exception);
	...
	try {
	    ...
	    logger
		.error(
		    "Error en la obtenci�n de la configuraci�n de una unidad de tramitaci�n",
		    exception);
	...
	try {
	    ...
	    logger.error(
		"Error en la obtenci�n de la unidad administrativa de la oficina", exception);
	...
	try {
	    ...
	    logger.error(
		"Error en la recuperación de la lista de unidades tramitadoras", e);
