...
/**
 * DAO para leer configuraciones de intercambio registral (mapeos de unidades
 * administrativas con entidades registrales o unidades de tramitación del
 * módulo comun
 * 
 * 
 */
public interface ConfiguracionIntercambioRegistralDAO {
	...
	getUnidadAdmimistrativaByCodigoEntidadRegistralYUnidadTramitacion(
	    String codigoUnidadTramitacion, String codigoEntidadRegistral);

    /**
     * Obtiene la unidad administrativa (ScrOrgs) que tiene asociada la oficina
     * <code>idOficina</code>
     * 
     * @param idOficina
     * @return
    ...
    /**
     * Obtiene la unidad de tramitación mapeada con la unidad administrativa con
     * codigo <code>codeSrcOrgs</code>
     * 
     * @param codeScrOrgs
     * @return
     */
    ...
    /**
     * Obtiene la lista de unidades de tramitación mapeada con la unidad
     * administrativa con codigo <code>code</code> o nombre <code>name</code>.
     * 
     * @param code
     * 		codigo de la unidad tramitadora.
     * @param name
     * 		nombre de la unidad tramitadora.
     * @return
     */
