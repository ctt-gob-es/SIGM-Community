...
public class CompulsaManagerImpl implements CompulsaManager {
	...
	public void compulsar(DocumentoCompulsarVO documentoCompulsar,
		...
		byte[] justificanteByteArray=generateJustificante(documentoCompulsar,configuracion);
		...
		registroManager.attachDocument(idRegistro, documentoRegistroJustificante, usuarioRegistro);
	...
	protected void populateCompulsaJustificanteVO(DocumentoCompulsarVO documentoCompulsar,ConfiguracionCompulsaVO configuracion,ISicresCompulsaJustificanteVO compulsaJustificanteVO){
		...
		DatosEspecificosCompulsaDefaultVO datosEspecificos=(DatosEspecificosCompulsaDefaultVO) documentoCompulsar.getDatosEspecificos();
		compulsaJustificanteVO.setCNcertificado(datosEspecificos.getUsuario());
	...
	protected byte [] generateJustificante(DocumentoCompulsarVO documentoCompulsar,ConfiguracionCompulsaVO configuracion){
		...
		result =((ByteArrayOutputStream)compulsaJustificanteVO.getPdfCompulsaStream()).toByteArray();
		return result;
