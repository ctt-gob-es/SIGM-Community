...
public class DistributionSession extends DistributionSessionUtil implements ServerKeys, Keys,
	HibernateKeys {
	...
	return getSizeFolderDistByState(sessionID, entidad, ISDistribution.STATE_PENDIENTE,
	...
	return getSizeFolderDistByStateByDeptId(sessionID, entidad, ISDistribution.STATE_PENDIENTE,
		LDAPAuthenticationPolicy.isLdap(entidad));
    }
	...
	return getSizeFolderDistByState(sessionID, entidad, ISDistribution.STATE_RECHAZADO,
		LDAPAuthenticationPolicy.isLdap(entidad));
    }
     ...
     * @throws ValidationException
     */
    public static int getRejectedFolderDistByDeptId(String sessionID, String entidad)
	    throws DistributionException, SessionException, ValidationException {

	return getSizeFolderDistByStateByDeptId(sessionID, entidad, ISDistribution.STATE_RECHAZADO,
		LDAPAuthenticationPolicy.isLdap(entidad));
    }

    public static DistributionResults getDistribution(String sessionID, int state, int firstRow,
	    int maxResults, int typeDist, String distWhere, String regWhere, boolean oficAsoc,
	    Locale locale, String entidad) throws DistributionException, SessionException,
	    ValidationException {

	return getDistribution(sessionID, state, firstRow, maxResults, typeDist, distWhere,
		regWhere, oficAsoc, locale, entidad, LDAPAuthenticationPolicy.isLdap(entidad));
    }

    public static DistributionResults getDistribution(String sessionID, int state, int firstRow,
	    int maxResults, int typeDist, String distWhere, String regWhere, boolean oficAsoc,
	    Locale locale, String entidad, List bookList) throws DistributionException,
    ...
    public static DistributionResults getDistribution(String sessionID, int state, int firstRow,
	    int maxResults, int typeDist, String distWhere, String regWhere, boolean oficAsoc,
	    Locale locale, String entidad, boolean isLdap) throws DistributionException,
	    SessionException, ValidationException {

	return getDistribution(sessionID, state, firstRow, maxResults, typeDist, distWhere,
		regWhere, oficAsoc, locale, entidad, isLdap, null);
    }
    ...
    public static DistributionResults getDistribution(String sessionID, int state, int firstRow,
	    int maxResults, int typeDist, String distWhere, String regWhere, boolean oficAsoc,
	    Locale locale, String entidad, boolean isLdap, List bookList)
	    throws DistributionException, SessionException, ValidationException {
	...
	try {
	    ...
	    StringBuffer querySize =
		    getDistributionQuerySize(session, user, iUserGroupUser, typeDist, distWhere,
			    bookList, oficAsoc, entidad);
		...
		List idArchs =
			DBEntityDAOFactory.getCurrentDBEntityDAO().getIdArchDistribution(
	    ...
	    DistributionResults distributionResults =
		    getDistributionResults(session, list, distributionCount, currentDate, typeDist,
	    ...
	    hibernateUtil.rollbackTransaction(tran);
	    log.error("Impossible to obtain the distribution for the session [" + sessionID + "]",
		    e);
     ...
     * @throws ValidationException
     */
    public static DistributionResults
	    getDistribution(String sessionID, int firstRow, int maxResults, int typeDist,
		    String sql, Locale locale, String entidad, boolean isLdap)
		    throws DistributionException, SessionException, ValidationException {
	BBDDUtils bbddUtils = new BBDDUtils();
	Validator.validate_String_NotNull_LengthMayorZero(sessionID,
		ValidationException.ATTRIBUTE_SESSION);
    ...
    public static int getDistribution(String sessionID, int typeDist, Integer bookId,
	    Integer folderId, String entidad) throws DistributionException, SessionException,
	    ValidationException {
	...
	try {
	    ...
	    int distributionCount =
		    DBEntityDAOFactory.getCurrentDBEntityDAO().getDistributionSize(
     ...
     * @throws ValidationException
     */
    public static int getAllDistributionByRegisterAndUser(String sessionID, Integer bookId,
	    Integer folderId, String entidad) throws DistributionException, SessionException,
	    ValidationException {
	...
	try {
	    ...
	    List iUserGroupUser =
		    getUserGroups(session, user, LDAPAuthenticationPolicy.isLdap(entidad));
	    ...
	    StringBuffer querySize =
		    getStringQueryAllDistributionByUserRegBook(bookId, folderId, user,
			    iUserGroupUser);
     ...
     */
    private static StringBuffer getStringQueryAllDistributionByUserRegBook(Integer bookId,
	    Integer folderId, AuthenticationUser user, List iUserGroupUser) {
	StringBuffer querySize = new StringBuffer();
	querySize.append("id_arch = ");
    ...
    public static int countDistribution(String sessionID, int state, int typeDist,
	    String distWhere, String regWhere, boolean oficAsoc, String entidad)
	    throws DistributionException, SessionException, ValidationException {

	return countDistribution(sessionID, state, typeDist, distWhere, regWhere, oficAsoc,
		entidad, LDAPAuthenticationPolicy.isLdap(entidad));
    }

    public static int countDistribution(String sessionID, int state, int typeDist,
	    String distWhere, String regWhere, boolean oficAsoc, String entidad, List bookList)
	    throws DistributionException, SessionException, ValidationException {

	return countDistribution(sessionID, state, typeDist, distWhere, regWhere, oficAsoc,
		entidad, LDAPAuthenticationPolicy.isLdap(entidad), bookList);
    }

    public static int countDistribution(String sessionID, int state, int typeDist,
	    String distWhere, String regWhere, boolean oficAsoc, String entidad, boolean isLdap)
	    throws DistributionException, SessionException, ValidationException {
    ...
    public static int countDistribution(String sessionID, int state, int typeDist,
	    String distWhere, String regWhere, boolean oficAsoc, String entidad, boolean isLdap,
	    List bookList) throws DistributionException, SessionException, ValidationException {
     ...
     * @throws ValidationException
     */
    public static String createDistribution(String sessionID, Integer bookId, List listIdsRegister,
	    Integer userType, Integer userId, String messageForUser, Locale locale, String entidad)
	...
	try {
	    ...
	    boolean distributionManualBookOut =
		    Configurator.getInstance().getPropertyBoolean(
			    ConfigurationKeys.KEY_SERVER_DISTRIBUTION_MANUAL_BOOK_OUT);

	    if (Repository.getInstance(entidad).isInBook(bookId).booleanValue()
		    || (Repository.getInstance(entidad).isOutBook(bookId).booleanValue() && distributionManualBookOut)) {
		Session session = hibernateUtil.currentSession(entidad);
		tran = session.beginTransaction();
		...
		result.append(createDistribution(session, sessionID, bookId, 2,
			scrOfic.getDeptid(), userId, userType, messageForUser, listIdsRegister,
			user, scrOfic, locale, entidad));
	    ...
	    hibernateUtil.rollbackTransaction(tran);
	    log.error("Impossible to create distribution for the session [" + sessionID
		    + "] and bookID [" + bookId + "]", e);
     ...
     */
    public static String createDistribution(String sessionID, Integer bookId, List listIdsRegister,
	    Integer senderType, Integer senderId, Integer userType, Integer userId,
	    String messageForUser, Locale locale, String entidad) throws BookException,
	...
	try {
		...
		result.append(createDistribution(session, sessionID, bookId, senderType, senderId,
			userId, userType, messageForUser, listIdsRegister, user, scrOfic, locale,
			entidad));
    ...
    public static Integer validateQueryDistribution(String sessionID, String code,
	    Integer validation, String entidad) throws DistributionException, SessionException,
	    ValidationException {
	...
	try {
		...
		privOrgs =
			DBEntityDAOFactory.getCurrentDBEntityDAO().getPrivOrgs(
    ...
    public static List rejectDistribution(String sessionID, List ids, String remarks, int state,
	    int firstRow, int maxResults, int typeDist, String distWhere, String regWhere,
	    Locale locale, String entidad) throws DistributionException, SessionException,
	    ValidationException {

	return rejectDistribution(sessionID, ids, remarks, state, firstRow, maxResults, typeDist,
		distWhere, regWhere, locale, entidad, LDAPAuthenticationPolicy.isLdap(entidad));
    }
	...
	try {
	    DistributionResults distributionResults =
		    getDistribution(sessionID, state, firstRow, maxResults, typeDist, distWhere,
			    regWhere, true, locale, entidad, isLdap);
	    ...
	    archidFdr.addAll(lockFolderDistById(session, user, ids,
		    distributionResults.getResults(), archidFdr, true, entidad));
		...
		if (scrDistReg.getState() == ISDistribution.STATE_PENDIENTE
		    ...
		    scrDistReg =
			    updateDistReg(session, user, sessionID, DISTRIBUTION_REJECT_EVENT,
				    scrDistReg, ISDistribution.STATE_RECHAZADO, ids1, remarks,
				    entidad);

		    DBEntityDAOFactory.getCurrentDBEntityDAO().deleteDistAccept(
			    new Integer(scrDistReg.getIdArch()), scrDistReg.getIdFdr(), entidad);
		}
		else {
	    ...
	    hibernateUtil.rollbackTransaction(tran);
	    log.error("Impossible to reject the distribution for the session [" + sessionID + "]",
		    e);
    ...
    public static List saveRemarks(String sessionID, int id, String remarks, String entidad)
	    throws DistributionException, SessionException, ValidationException {
	...
	try {
	    ...
	    if (!lockFolderDist(session, user, new Integer(distReg.getIdArch()),
		    distReg.getIdFdr(), entidad)) {
		throw new DistributionException(
	    ...
	    hibernateUtil.rollbackTransaction(tran);
	    log.error("Impossible to save message the distribution for the session [" + sessionID
		    + "]", e);
	    throw new DistributionException(DistributionException.ERROR_CANNOT_REJECT_DISTRIBUTION);
	}
	finally {
    ...
    public static List saveDistribution(String sessionID, List ids, int state, int firstRow,
	    int maxResults, int typeDist, String distWhere, String regWhere, Locale locale,
	    String entidad) throws DistributionException, SessionException, ValidationException {

	return saveDistribution(sessionID, ids, state, firstRow, maxResults, typeDist, distWhere,
		regWhere, locale, entidad, LDAPAuthenticationPolicy.isLdap(entidad));
    }

    public static List saveDistribution(String sessionID, List ids, int state, int firstRow,
	    int maxResults, int typeDist, String distWhere, String regWhere, Locale locale,
	    String entidad, boolean isLdap) throws DistributionException, SessionException,
	    ValidationException {
	...
	try {
		...
		if (scrDistReg.getState() != ISDistribution.STATE_ACEPTADO) {
		    ...
		    scrDistReg =
			    updateDistReg(session, user, sessionID, DISTRIBUTION_ARCHIVE_EVENT,
				    scrDistReg, ISDistribution.STATE_ARCHIVADO, ids1, null, entidad);
		}
	    }
    ...
    public static Object acceptDistribution(String sessionID, List ids, int state, int firstRow,
    ...
    public static void
	    changeDistribution(String sessionID, List dis, String code, int typeDist,
		    Integer launchDistOutRegister, Integer canDestWithoutList, Locale locale,
		    String entidad) throws BookException, SessionException, ValidationException,
		    DistributionException {
	Validator.validate_String_NotNull_LengthMayorZero(sessionID,
		ValidationException.ATTRIBUTE_SESSION);
	...
	try {
	    ...
	    criteria.add(Expression.not(Expression.and(Expression.eq("typeDest", new Integer(1)),
		    Expression.eq("idDest", user.getId()))));
	    criteria.add(Expression.not(Expression.and(Expression.eq("typeDest", new Integer(2)),
		    Expression.eq("idDest", new Integer(user.getDeptid().intValue())))));
		...
		scrs.add(scrDistReg);
		if (!lockFolderDist(session, user, new Integer(scrDistReg.getIdArch()),
	...
	updateChangeDistribution(sessionID, scrs, distList, typeDist, id, canDestWithoutList,
		entidad);

	updateFolderChangeDistribution(sessionID, scrs, scrOrg, launchDistOutRegister, locale,
		entidad);
    ...
    public static void distribute(boolean isUpdate, Session session, Integer bookID, int fdrid,
	    int distributionType, Integer fld8, Integer userID, Integer deptId, String userName,
	    String entidad, Locale locale) throws HibernateException, BookException, SQLException,
	    Exception {

	if (isUpdate) {
	    DBEntityDAOFactory.getCurrentDBEntityDAO().deleteDistributeForUpdate(bookID.intValue(),
		    fdrid, deptId.intValue(), entidad, ISDistribution.STATE_PENDIENTE);

	}

	Timestamp currentDate = DBEntityDAOFactory.getCurrentDBEntityDAO().getDBServerDate(entidad);
	String message =
		RBUtil.getInstance(locale).getProperty(ISicresKeys.DISTRIBUCION_AUTOMATICA_MENSAJE);
	...
	case 1: { // Distribución propia
		...
		for (Iterator it = distList.iterator(); it.hasNext();) {
		    ...
		    insertDistribute(session, bookID, fdrid, dirList.getTypeDest(),
			    dirList.getIdDest(), currentDate, 2, deptId.intValue(), userName,
	...
	case 2: { // Distribución externa
	    insertDistribute(session, bookID, fdrid, 4, fld8.intValue(), currentDate, 2,
		    deptId.intValue(), userName, userID, distributionType, message, entidad);
	    break;
	}
	default: {
    ...
    public static String getOrigDestDescription(String sessionID, ScrDistreg scr,
	    boolean isOrigDist, String entidad) throws ValidationException, DistributionException {
    ...
    public static String getOrigDestDescription(String sessionID, ScrDistreg scr,
	    boolean isOrigDist, String entidad, boolean isLdap) throws ValidationException,
	    DistributionException {
    ...
    public static List getDtrFdrResults(String sessionID, Integer bookID, int folderID,
	    String entidad, boolean isLdap) throws BookException, SessionException,
	    ValidationException {
	Validator.validate_String_NotNull_LengthMayorZero(sessionID,
		ValidationException.ATTRIBUTE_SESSION);
	Validator.validate_Integer(bookID, ValidationException.ATTRIBUTE_BOOK);
	...
	try {
		...
		for (Iterator it = list.iterator(); it.hasNext();) {
		    ...
		    dtrFdrResults.setSourceDescription(getDistributionSourceDescription(session,
			    scr, isLdap));
		    dtrFdrResults.setTargetDescription(getDistributionTargetDescription(session,
			    scr, isLdap));

		    dtrFdrResults.setFlowProcess(!ISicresQueries
			    .getScrProcReg(session, scr.getId()).isEmpty());
		    dtrFdrResults.setScrDistRegState(ISicresQueries.getScrDistregstate(session,
			    scr.getId()));
	    ...
	    hibernateUtil.rollbackTransaction(tran);
	    log.error("Impossible to close the book [" + bookID + "] and fdrid [" + folderID
     ...
     * @throws Exception
     */
    public static void redistributionDistribution(String sessionID, Locale locale, String entidad,
	    List dis, Integer userId, int typeDist, Integer canDestWithoutList,
	    String messageForUser, Integer userType) throws ValidationException,
	...
	try {
	    ...
	    Date currentDate =
		    new Date(DBEntityDAOFactory.getCurrentDBEntityDAO().getDBServerDate(entidad)
			    .getTime());
		...
		try {
		    ...
		    redistributionDistribution(session, sessionID, locale, scrDistReg, user,
			    canDestWithoutList, typeDist, scrOfic, currentDate, userType, distList,
	    ...
	    log.error("Impossible create the redistribution for the session [" + sessionID + "].",
		    bE);
	    hibernateUtil.rollbackTransaction(tran);
	    throw bE;
	}
