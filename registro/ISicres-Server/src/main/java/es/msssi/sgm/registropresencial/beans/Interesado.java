...
public class Interesado implements Serializable {
	...
	private String tipo = TIPO_PERSONA_FISICA;
	private Integer id;
	...
	public boolean equals(Object obj) {
		if(null == obj || !(obj instanceof Interesado)){
        	return false;
        }
        
        Interesado interesado = (Interesado) obj;
        
        boolean esIgualDocIdentidad = false;
        
        if (null == docIdentidad && null == interesado.getDocIdentidad()){
        	esIgualDocIdentidad = true;
        } else if (null == docIdentidad && null != interesado.getDocIdentidad()){
        	esIgualDocIdentidad = false;
        } else if (null != docIdentidad && null == interesado.getDocIdentidad()){
        	esIgualDocIdentidad = false;
        } else if (interesado.getDocIdentidad().equalsIgnoreCase(docIdentidad)){
        	esIgualDocIdentidad = true;
        }
