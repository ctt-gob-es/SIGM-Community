package es.ieci.tecdoc.isicres.document.manager.alfrescoCMIS;
 ...
 * 
 */
public class AlfrescoCMISRepositoryManager extends GenericRepositoryManager {

	public AlfrescoCMISRepositoryManager() {
		super();
		this.connector = new AlfrescoCMISDocumentConnector();
	}
	...
	//[Ruben incluyo el metodo que incluyó CR en CMIS --> Teresa # 1014] INICIO
	@Override
	...
	//[Ruben incluyo el metodo que incluyó CR en CMIS --> Teresa # 1014] FIN
}
