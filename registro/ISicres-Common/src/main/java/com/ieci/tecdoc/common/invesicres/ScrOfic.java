 ...
 *     
*/
public class ScrOfic implements Serializable {
    ...
    /** full constructor */
    public ScrOfic(Integer id, String code, String acron, String name, Date creationDate, Date disableDate, String stamp, int deptid, com.ieci.tecdoc.common.invesicres.ScrTypeofic scrTypeofic, com.ieci.tecdoc.common.invesicres.ScrOrg scrOrg, Set scrRegorigdocs, Set scrWs, Set scrRelations, Set scrOficadms, Set scrCaofics, Set scrReportofics, Set scrLockrelations) {
        this.id = id;
        this.code = code;
        this.acron = acron;
        this.name = name;
    ...
    /** minimal constructor */
    public ScrOfic(Integer id, String code, String acron, String name, int deptid, com.ieci.tecdoc.common.invesicres.ScrTypeofic scrTypeofic, com.ieci.tecdoc.common.invesicres.ScrOrg scrOrg, Set scrRegorigdocs, Set scrWs, Set scrRelations, Set scrOficadms, Set scrCaofics, Set scrReportofics, Set scrLockrelations) {
        this.id = id;
        this.code = code;
        this.acron = acron;
        this.name = name;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ScrOfic) ) return false;
        ScrOfic castOther = (ScrOfic) other;
