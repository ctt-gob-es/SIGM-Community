 ...
 *     
*/
public class ScrOficadm implements Serializable {
    ...
    /** full constructor */
    public ScrOficadm(int id, int iduser, com.ieci.tecdoc.common.invesicres.ScrOfic scrOfic) {
        this.id = id;
        this.iduser = iduser;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ScrOficadm) ) return false;
        ScrOficadm castOther = (ScrOficadm) other;
