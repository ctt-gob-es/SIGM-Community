...
/** 
 *        @hibernate.class
 *         table="IDOCARCHHDR_EU"
 *     
*/
public class Idocarchhdreu implements Serializable {
    ...
    /** full constructor */
    public Idocarchhdreu(Integer id, String name, String tblprefix, int type, int flags, String remarks, int accesstype, int acsid, int crtrid, Date crtndate, Integer updrid, Date upddate, Set scrRegstates) {
        this.id = id;
        this.name = name;
    ...
    /** default constructor */
    public Idocarchhdreu() {
    }

    /** minimal constructor */
    public Idocarchhdreu(Integer id, String name, String tblprefix, int type, int flags, int accesstype, int acsid, int crtrid, Date crtndate, Set scrRegstates) {
        this.id = id;
        this.name = name;
        this.tblprefix = tblprefix;
        this.type = type;
