...
public class AxSfQuery implements Serializable {
    ...
    private String whereField9 = " fdrid in (select id_fdr from scr_regint where translate(upper(name),'аюбихймлнсртзыш', 'AAAEEEIIIOOOUUU') ";
	...
	private String whereField1001_02 = "xf X WHERE X.FLDID=1001 AND TO_CHAR(TEXT) = 'S' and '1'=? and X.FDRID=R.FDRID ) " ;
