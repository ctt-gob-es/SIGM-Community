 ...
 *     
*/
public class ScrOficgl implements Serializable {
    ...
    /** persistent field */
    private com.ieci.tecdoc.common.invesicres.ScrOrggl scrOrg;
    ...
    /** full constructor */
    public ScrOficgl(Integer id, String code, String acron, String name, Date creationDate, Date disableDate, String stamp, int deptid, com.ieci.tecdoc.common.invesicres.ScrTypeofic scrTypeofic, com.ieci.tecdoc.common.invesicres.ScrOrggl scrOrg, Set scrRegorigdocs, Set scrWs, Set scrRelations, Set scrOficadms, Set scrCaofics, Set scrReportofics, Set scrLockrelations) {
        this.id = id;
        this.code = code;
        this.acron = acron;
        this.name = name;
    ...
    /** minimal constructor */
    public ScrOficgl(Integer id, String code, String acron, String name, int deptid, com.ieci.tecdoc.common.invesicres.ScrTypeofic scrTypeofic, com.ieci.tecdoc.common.invesicres.ScrOrggl scrOrg, Set scrRegorigdocs, Set scrWs, Set scrRelations, Set scrOficadms, Set scrCaofics, Set scrReportofics, Set scrLockrelations) {
        this.id = id;
        this.code = code;
        this.acron = acron;
        this.name = name;
     ...
     *         
     */
    public com.ieci.tecdoc.common.invesicres.ScrOrggl getScrOrg() {
        return this.scrOrg;
    }

    public void setScrOrg(com.ieci.tecdoc.common.invesicres.ScrOrggl scrOrg) {
        this.scrOrg = scrOrg;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ScrOficgl) ) return false;
        ScrOficgl castOther = (ScrOficgl) other;
