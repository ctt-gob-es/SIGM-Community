 ...
 *     
*/
public class ScrCagl implements Serializable {
    ...
    /** full constructor */
    public ScrCagl(Integer id, String code, String matter, Integer forEreg, Integer forSreg, Integer allOfics, int idArch, Date creationDate, Date disableDate, Integer enabled, int idOrg, Set scrCaadms) {
        this.id = id;
        this.code = code;
        this.matter = matter;
    ...
    /** minimal constructor */
    public ScrCagl(Integer id, String code, String matter, int idArch, Date creationDate, int idOrg, Set scrCaadms) {
        this.id = id;
        this.code = code;
        this.matter = matter;
        this.idArch = idArch;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ScrCagl) ) return false;
        ScrCagl castOther = (ScrCagl) other;
