 ...
 *     
*/
public class ScrSendreg implements Serializable {
    ...
    /** full constructor */
    public ScrSendreg(int id, int idMsg, int idArch, int idFdr, String regorigCode, String regorigNum, Date regorigDate, int regorigType, int attachPages, int attachDoc, Integer idAckmsg, int rcvState, String rcvNumreg, Date rcvDatereg, com.ieci.tecdoc.common.invesicres.ScrOrg scrOrg) {
        this.id = id;
        this.idMsg = idMsg;
        this.idArch = idArch;
        this.idFdr = idFdr;
     ...
     *             not-null="true"
     *            @hibernate.column name="ID_ENTREG_DEST"         
     *         
     */
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ScrSendreg) ) return false;
        ScrSendreg castOther = (ScrSendreg) other;
