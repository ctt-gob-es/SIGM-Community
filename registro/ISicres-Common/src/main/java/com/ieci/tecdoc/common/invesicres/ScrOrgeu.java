 ...
 *     
*/
public class ScrOrgeu implements Serializable {
    ...
    /** persistent field */
    private com.ieci.tecdoc.common.invesicres.ScrTypeadmeu scrTypeadm;
    ...
    /** full constructor */
    public ScrOrgeu(Integer id, String code, Integer idFather, String acron, String name, Date creationDate, Date disableDate, int enabled, String cif, com.ieci.tecdoc.common.invesicres.ScrTypeadmeu scrTypeadm, Set scrSendmsgsBySender, Set scrSendmsgsByDestination, Set scrRecvmsgsBySender, Set scrRecvmsgsByDestination, Set scrRecvdistregs, Set scrRegorigdocs, Set scrOfics, Set scrSendregs, Set scrRelations) {
        this.id = id;
        this.code = code;
    ...
    /** minimal constructor */
    public ScrOrgeu(Integer id, String code, String acron, String name, Date creationDate, int enabled, com.ieci.tecdoc.common.invesicres.ScrTypeadmeu scrTypeadm, Set scrSendmsgsBySender, Set scrSendmsgsByDestination, Set scrRecvmsgsBySender, Set scrRecvmsgsByDestination, Set scrRecvdistregs, Set scrRegorigdocs, Set scrOfics, Set scrSendregs, Set scrRelations) {
        this.id = id;
        this.code = code;
        this.acron = acron;
        this.name = name;
     ...
     *         
     */
    public com.ieci.tecdoc.common.invesicres.ScrTypeadmeu getScrTypeadm() {
        return this.scrTypeadm;
    }

    public void setScrTypeadm(com.ieci.tecdoc.common.invesicres.ScrTypeadmeu scrTypeadm) {
        this.scrTypeadm = scrTypeadm;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ScrOrgeu) ) return false;
        ScrOrgeu castOther = (ScrOrgeu) other;
