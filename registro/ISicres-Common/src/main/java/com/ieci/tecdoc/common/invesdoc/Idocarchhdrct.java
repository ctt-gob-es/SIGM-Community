 ...
 *     
*/
public class Idocarchhdrct implements Serializable {
    ...
    /** full constructor */
    public Idocarchhdrct(Integer id, String name, String tblprefix, int type, int flags, String remarks, int accesstype, int acsid, int crtrid, Date crtndate, Integer updrid, Date upddate, Set scrRegstates) {
        this.id = id;
        this.name = name;
    ...
    /** default constructor */
    public Idocarchhdrct() {
    }

    /** minimal constructor */
    public Idocarchhdrct(Integer id, String name, String tblprefix, int type, int flags, int accesstype, int acsid, int crtrid, Date crtndate, Set scrRegstates) {
        this.id = id;
        this.name = name;
        this.tblprefix = tblprefix;
        this.type = type;
