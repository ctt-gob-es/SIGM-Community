...
/** 
 *        @hibernate.class
 *         table="IUSERLDAPUSERHDR"
 *     
*/
public class Iuserldapuserhdr implements Serializable {
    ...
    /** full constructor */
    public Iuserldapuserhdr(int id, String ldapguid, String ldapfullname) {
        this.id = id;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof Iuserldapuserhdr) ) return false;
        Iuserldapuserhdr castOther = (Iuserldapuserhdr) other;
