 ...
 *     
*/
public class Idocpreffmt implements Serializable {
    ...
    /** full constructor */
    public Idocpreffmt(int archid, int fmttype, int userid, int fmtid) {
        this.archid = archid;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof Idocpreffmt) ) return false;
        Idocpreffmt castOther = (Idocpreffmt) other;
