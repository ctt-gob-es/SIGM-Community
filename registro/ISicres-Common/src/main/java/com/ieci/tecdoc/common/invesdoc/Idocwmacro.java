 ...
 *     
*/
public class Idocwmacro implements Serializable {
    ...
    /** full constructor */
    public Idocwmacro(int id, String name, String text, String remarks, int crtrid, Date crtndate, Integer updrid, Date upddate) {
        this.id = id;
        this.name = name;
        this.text = text;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof Idocwmacro) ) return false;
        Idocwmacro castOther = (Idocwmacro) other;
