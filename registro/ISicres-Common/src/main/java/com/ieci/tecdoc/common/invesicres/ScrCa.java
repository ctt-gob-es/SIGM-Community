 ...
 *     
*/
public class ScrCa implements Serializable {
    ...
    /** minimal constructor */
    public ScrCa(Integer id, String code, String matter, int idArch, Date creationDate, int idOrg, Set scrCaadms) {
        this.id = id;
        this.code = code;
        this.matter = matter;
        this.idArch = idArch;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ScrCa) ) return false;
        ScrCa castOther = (ScrCa) other;
