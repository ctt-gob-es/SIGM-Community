 ...
 *     
*/
public class ScrSrptauxf implements Serializable {
    ...
    /** full constructor */
    public ScrSrptauxf(BigDecimal id, BigDecimal fdrid, BigDecimal fldid, String text, Date timestamp) {
        this.id = id;
        this.fdrid = fdrid;
        this.fldid = fldid;
        this.text = text;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ScrSrptauxf) ) return false;
        ScrSrptauxf castOther = (ScrSrptauxf) other;
