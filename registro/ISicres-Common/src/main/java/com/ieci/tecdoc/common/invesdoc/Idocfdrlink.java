 ...
 *     
*/
public class Idocfdrlink implements Serializable {
    ...
    /** full constructor */
    public Idocfdrlink(int id, String name, int cntrdbid, int cntrarchid, int cntrfdrid, int cntrclfid, int srvrdbid, int srvrarchid, int srvrfdrid, int flags, int stat, int crtrid, Date crtndate) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof Idocfdrlink) ) return false;
        Idocfdrlink castOther = (Idocfdrlink) other;
