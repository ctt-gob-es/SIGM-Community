 ...
 *     
*/
public class ScrOficct implements Serializable {
    ...
    /** persistent field */
    private com.ieci.tecdoc.common.invesicres.ScrOrgct scrOrg;
    ...
    /** full constructor */
    public ScrOficct(Integer id, String code, String acron, String name, Date creationDate, Date disableDate, String stamp, int deptid, com.ieci.tecdoc.common.invesicres.ScrTypeofic scrTypeofic, com.ieci.tecdoc.common.invesicres.ScrOrgct scrOrg, Set scrRegorigdocs, Set scrWs, Set scrRelations, Set scrOficadms, Set scrCaofics, Set scrReportofics, Set scrLockrelations) {
        this.id = id;
        this.code = code;
        this.acron = acron;
        this.name = name;
    ...
    /** minimal constructor */
    public ScrOficct(Integer id, String code, String acron, String name, int deptid, com.ieci.tecdoc.common.invesicres.ScrTypeofic scrTypeofic, com.ieci.tecdoc.common.invesicres.ScrOrgct scrOrg, Set scrRegorigdocs, Set scrWs, Set scrRelations, Set scrOficadms, Set scrCaofics, Set scrReportofics, Set scrLockrelations) {
        this.id = id;
        this.code = code;
        this.acron = acron;
        this.name = name;
     ...
     *         
     */
    public com.ieci.tecdoc.common.invesicres.ScrOrgct getScrOrg() {
        return this.scrOrg;
    }

    public void setScrOrg(com.ieci.tecdoc.common.invesicres.ScrOrgct scrOrg) {
        this.scrOrg = scrOrg;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ScrOficct) ) return false;
        ScrOficct castOther = (ScrOficct) other;
