 ...
 *     
*/
public class ScrOrgct implements Serializable {
    ...
    /** persistent field */
    private com.ieci.tecdoc.common.invesicres.ScrTypeadmct scrTypeadm;
    ...
    /** full constructor */
    public ScrOrgct(Integer id, String code, Integer idFather, String acron, String name, Date creationDate, Date disableDate, int enabled, String cif, com.ieci.tecdoc.common.invesicres.ScrTypeadmct scrTypeadm, Set scrSendmsgsBySender, Set scrSendmsgsByDestination, Set scrRecvmsgsBySender, Set scrRecvmsgsByDestination, Set scrRecvdistregs, Set scrRegorigdocs, Set scrOfics, Set scrSendregs, Set scrRelations) {
        this.id = id;
        this.code = code;
    ...
    /** minimal constructor */
    public ScrOrgct(Integer id, String code, String acron, String name, Date creationDate, int enabled, com.ieci.tecdoc.common.invesicres.ScrTypeadmct scrTypeadm, Set scrSendmsgsBySender, Set scrSendmsgsByDestination, Set scrRecvmsgsBySender, Set scrRecvmsgsByDestination, Set scrRecvdistregs, Set scrRegorigdocs, Set scrOfics, Set scrSendregs, Set scrRelations) {
        this.id = id;
        this.code = code;
        this.acron = acron;
        this.name = name;
     ...
     *         
     */
    public com.ieci.tecdoc.common.invesicres.ScrTypeadmct getScrTypeadm() {
        return this.scrTypeadm;
    }

    public void setScrTypeadm(com.ieci.tecdoc.common.invesicres.ScrTypeadmct scrTypeadm) {
        this.scrTypeadm = scrTypeadm;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ScrOrgct) ) return false;
        ScrOrgct castOther = (ScrOrgct) other;
