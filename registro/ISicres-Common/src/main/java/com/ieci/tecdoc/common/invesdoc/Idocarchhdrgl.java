...
/** 
 *        @hibernate.class
 *         table="IDOCARCHHDR_GL"
 *     
*/
public class Idocarchhdrgl implements Serializable {
    ...
    /** full constructor */
    public Idocarchhdrgl(Integer id, String name, String tblprefix, int type, int flags, String remarks, int accesstype, int acsid, int crtrid, Date crtndate, Integer updrid, Date upddate, Set scrRegstates) {
        this.id = id;
        this.name = name;
    ...
    /** default constructor */
    public Idocarchhdrgl() {
    }

    /** minimal constructor */
    public Idocarchhdrgl(Integer id, String name, String tblprefix, int type, int flags, int accesstype, int acsid, int crtrid, Date crtndate, Set scrRegstates) {
        this.id = id;
        this.name = name;
        this.tblprefix = tblprefix;
        this.type = type;
