...
public class ISicresRPAdminDAOException extends ISicresRPAdminException {
	...
	public ISicresRPAdminDAOException(long errorCode) {
		this(errorCode, null);
	}

	public ISicresRPAdminDAOException(String message) {
		this(message, null);
	}

	public ISicresRPAdminDAOException(Throwable cause) {
		this(0, cause);
	}

	public ISicresRPAdminDAOException(long errorCode, String message, Throwable cause){
		super(message,cause);
		this.errorCode = errorCode;
		errorMessage = loadMessage(Locale.getDefault());
	}

   public ISicresRPAdminDAOException(long errorCode, Throwable cause) {
	   super(cause);
	   this.errorCode = errorCode;
	   errorMessage = loadMessage(Locale.getDefault());
   }

   public ISicresRPAdminDAOException(String message, Throwable cause) {
	   super(message, cause);
