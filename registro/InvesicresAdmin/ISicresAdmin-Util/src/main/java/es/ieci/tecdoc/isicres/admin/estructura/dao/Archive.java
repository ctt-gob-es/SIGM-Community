...
public interface Archive
{
   ...
   public void update(ArchiveUpdInfo updInfo, String entidad) throws Exception;
	...
	/** Actualiza la información del archivador teniendo en cuenta los formatos y constraints utilizados a la hora de recrear el archivador,
	 * ya que a la hora de actualizar, en el caso de que el archivador esté vacío, se hace una eliminación y recreación de toda la estructura
	 * y en el método update anterior esto no se estaba teniendo en cuenta.
	 *
	 * @param archUpdInfo
	 ...
	 *             Errores
	 *
	 * @return true si ha habido un borrado del archivador durante la actualización y false en caso contrario
	 */
   	public boolean updateCheckArchiveDeletion(ArchiveUpdInfo archUpdInfo, String entidad) throws Exception;
   	//public void update(ArchiveUpdInfo archUpdInfo, String entidad, boolean recrearFormatosYConstraints) throws Exception;
