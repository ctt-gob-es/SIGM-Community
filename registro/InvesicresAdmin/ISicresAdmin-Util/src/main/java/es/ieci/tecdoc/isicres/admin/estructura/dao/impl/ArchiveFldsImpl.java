...
public class ArchiveFldsImpl implements ArchiveFlds
{
   ...
   public void addFld(ArchiveFld fld) throws Exception
   {
      ...
      {
         ISicresAdminBasicException.throwException(ISicresAdminArchiveKeys.EC_FLD_NAME_NO_VALID);
      }
      if (!isValidName(fld.getName()))
      {
         ISicresAdminBasicException.throwException(ISicresAdminArchiveKeys.EC_FLD_EXISTS);
      }
    ...
    * @throws Exception Errores
    */
   public ArchiveFlds getFtsFlds() throws Exception
   {
      int              i;
