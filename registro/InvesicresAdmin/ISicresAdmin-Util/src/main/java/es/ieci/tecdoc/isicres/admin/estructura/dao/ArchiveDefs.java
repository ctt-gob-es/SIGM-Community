...
import es.ieci.tecdoc.isicres.admin.sbo.idoc.archive.base.ArchiveFlag;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.dao.DaoArchDetType;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.dao.DaoDATNodeType;
...
public class ArchiveDefs
{
   ...
   public static int IDOC_FLD_FMT_TYPE_NUM = 1;
   public static int IDOC_FLD_FMT_TYPE_DT = 2;
    /**
