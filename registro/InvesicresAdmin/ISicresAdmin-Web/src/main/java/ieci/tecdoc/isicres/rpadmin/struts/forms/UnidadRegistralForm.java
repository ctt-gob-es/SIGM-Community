...
public class UnidadRegistralForm extends RPAdminBaseForm {
	...
	public String getIdEntityReg() {
		return idEntityReg;
	}

	public void setIdEntityReg(String idEntityReg) {
		this.idEntityReg = idEntityReg;
	}
