...
public class LdapGroupTree extends LdapBaseTree {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		loadTree(request, Constantes.LDAP_GROUP_TREE, Constantes.LDAP_SERVICE_GROUP_TREE, authCfg.getGroupStart(), LdapConstants.LDAP_TYPE_TREE_GROUP);
