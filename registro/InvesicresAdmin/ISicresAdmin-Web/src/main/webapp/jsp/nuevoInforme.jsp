...
<html:form action="/nuevoInforme.do" enctype="multipart/form-data">
	...
	<div id="migas"><bean:message
		key="ieci.tecdoc.sgm.rpadmin.botones.nuevo" /></div>
	...
	<table>
		<tr>
			...
			<td class="col_guardar"
				onclick="llamadaAction('<html:rewrite page="/guardarNuevoInforme.do"/>')">
		...
		<div id="informe">
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr class="col">
					...
					<td class="txt"><html:radio property="typeArch" value="1"><bean:message
						key="ieci.tecdoc.sgm.rpadmin.informes.entrada" /></html:radio>
					<html:radio property="typeArch" value="2"><bean:message
						key="ieci.tecdoc.sgm.rpadmin.informes.salida" /></html:radio></td>
				</tr>
				<tr class="col">
					<td class="txt" nowrap="nowrap" valign="top"><bean:message
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					...
					<input type="hidden" name="urlAddOficina" id="urlAddOficina"
							value='<html-el:rewrite page="/addOficinaNuevoInforme.do"/>' />
					</td>
				</tr>
			</table>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td colspan="2"><logic:notEmpty name="listaPerfilesInforme">
				...
				value='<html-el:rewrite page="/addPerfilNuevoInforme.do"/>' />
			</td>
		</tr>
	...
	<div id="libros" style="display: none">
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr>
				...
				value='<html-el:rewrite page="/addLibroNuevoInforme.do"/>' />
				</td>
			</tr>
		</table>
	</div>
