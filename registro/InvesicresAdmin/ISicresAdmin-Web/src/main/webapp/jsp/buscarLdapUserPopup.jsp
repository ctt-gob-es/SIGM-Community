...
<title><bean:message key="ieci.tecdoc.sgm.pgadmin.title.aplication"/> - <bean:message key="ieci.tecdoc.sgm.rpadmin.usuarios.seleccione.usuario"/></title>
...
<script language="Javascript">
	...
	function llamadaActionAceptarPopup() {
		...
		if( idTipo == undefined && idSelect == undefined &&
		    nombreSel == undefined) {
			alert("<bean:message key="ieci.tecdoc.sgm.rpadmin.error.mensaje.required.select.usuario"/>");
			return;
		} else {
	...
	function loadingUser() {
		if( document.getElementById('iframeUser').src != "null") {
							...
							<tr>
								<td valign="top">
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
										...
										<tr>
											<td>
												<div id="capaCargandoUser" style="width:100px; height:100px;display:block">
											...
											<td>
												<div id="capaUser" style="display:none">
													<table cellpadding="0" cellspacing="0" border="0" width="100%">
														<tr>
															<td class="cuadro">
																<iframe src="<html:rewrite page="/ldapUserTree.do"/>" id="iframeUser" frameborder='0' width="400" height="280"></iframe>
															</td>
														</tr>
													</table>
												</div>
