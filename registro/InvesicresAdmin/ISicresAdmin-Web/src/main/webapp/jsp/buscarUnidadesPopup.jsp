...
<script language="Javascript">
	...
	function llamadaActionAceptarPopup() {
		...
		if( idTipo == undefined && idSelect == undefined &&
			...
			window.opener.document.forms[0].filtros_valor_<%=request.getParameter("fila")%>.value = codigoUnidad;
			//window.opener.document.forms[0].id.value = idSelect;
			window.close();
		}
	}
											...
											<td>
												<div id="capaDept" style="display:none">
													<table cellpadding="0" cellspacing="0" border="0" width="100%">
														<tr>
															<td class="cuadro">
																<iframe src="<html:rewrite page="/cargarUnidades.do"/>?idCampoFiltro=<%=request.getParameter("fila")%>" id="iframeDept" frameborder='0' width=300" height="400"></iframe>
															</td>
														</tr>
													</table>
												</div>
