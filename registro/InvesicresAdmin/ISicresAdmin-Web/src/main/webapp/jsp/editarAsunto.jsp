					...
					<div class="cuerpomid">
						...
						<div class="cuadro">
								<div id="migas">
									...
									<span class="migasElementoSeleccionado"><bean:write name="asuntoForm" property="nombre"/></span>&nbsp;
								</div>
								...
								<table>
									<tr>
										...
										<td class="col_guardar" onclick="llamadaAction('<html:rewrite page="/guardarEdicionAsunto.do"/>')">
											...
											<table cellpadding="0" cellspacing="0" border="0" width="100%">
												...
												<tr>
													...
													<display:table name="sessionScope.listaOficinasAsuntos" uid="fila" sort="page" style="width:100%">
																...
																<table><tr>
																	<logic:equal name="fila" property="estado" value="1">
																		<c:set var="funcioneliminarOficina">
																			eliminarOficina("<html-el:rewrite page='/removeOficinaEditarAsunto.do'/>","<bean:write name='fila_rowNum' filter='false'/>","<bean:message key='ieci.tecdoc.sgm.rpadmin.oficinas.eliminar.oficina'/>","<bean:write name='fila' property='nombreOficina' filter='false'/>",ESTADO_ELIMINADO_NUEVO)
																		</c:set>
																		<td class="col_eliminar" onclick="<c:out value="${funcioneliminarOficina}"/>">
																			<bean:message key="ieci.tecdoc.sgm.rpadmin.botones.eliminar"/>
																		</td>
																	</logic:equal>
																	<logic:notEqual name="fila" property="estado" value="1">
																		<c:set var="funcioneliminarOficina">
																			eliminarOficina("<html-el:rewrite page='/removeOficinaEditarAsunto.do'/>","<bean:write name='fila_rowNum' filter='false'/>","<bean:message key='ieci.tecdoc.sgm.rpadmin.oficinas.eliminar.oficina'/>","<bean:write name='fila' property='nombreOficina' filter='false'/>",ESTADO_ELIMINADO)
																		</c:set>
																		<td class="col_eliminar" onclick="<c:out value="${funcioneliminarOficina}"/>">
																				<bean:message key="ieci.tecdoc.sgm.rpadmin.botones.eliminar"/>
																		</td>
														...
														<input type="hidden" name="urlAddOficina" id="urlAddOficina" value='<html-el:rewrite page="/addOficinaEditarAsunto.do"/>'/>
													</td>
												</tr>
																...
																<td class="txt" valign="top">
																	<table><tr>
																			<c:set var="funcionaddDocumento">
																				addDocumento("<html-el:rewrite page='/addDocumentoEditarAsunto.do'/>","<bean:message key='ieci.tecdoc.sgm.rpadmin.asuntos.documento.obligatorio'/>")
																			</c:set>
																...
																<span id='btnAceptar_<bean:write name="fila_rowNum"/>' style="display:none;text-align:center">
																	...
																	<logic:equal name="fila" property="estado" value="1">
																		<c:set var="funcionaceptarEdicionDocumento">
																			aceptarEdicionDocumento("<html-el:rewrite page='/editDocumentoEditarAsunto.do'/>","<bean:message key='ieci.tecdoc.sgm.rpadmin.asuntos.documento.obligatorio'/>",ESTADO_NUEVO)
																		</c:set>
																	...
																	<logic:notEqual name="fila" property="estado" value="1">
																		<c:set var="funcionaceptarEdicionDocumento">
																			aceptarEdicionDocumento("<html-el:rewrite page='/editDocumentoEditarAsunto.do'/>","<bean:message key='ieci.tecdoc.sgm.rpadmin.asuntos.documento.obligatorio'/>",ESTADO_MODIFICADO)
																		</c:set>
																		<td class="col_aceptar" nowrap="nowrap" onclick="<c:out value="${funcionaceptarEdicionDocumento}"/>" title='<bean:message key="ieci.tecdoc.sgm.rpadmin.asuntos.documentos.aceptar.edicion"/>'>
																			<bean:message key="ieci.tecdoc.sgm.rpadmin.asuntos.documentos.aceptar.edicion"/>
																		</td>
															...
															<display:column style="width: 75px;">
																...
																<table><tr>
																	...
																	<c:set var="funcioneliminarDocumento">
																		eliminarDocumento("<html-el:rewrite page='/removeDocumentoEditarAsunto.do'/>","<bean:write name='fila_rowNum' filter='false'/>","<bean:message key='ieci.tecdoc.sgm.rpadmin.asuntos.eliminar.documento'/>","<bean:write name='fila' property='description' filter='false'/>",ESTADO_ELIMINADO_NUEVO)
																	</c:set>
																	...
																	<logic:notEqual name="fila" property="estado" value="1">
																		<c:set var="funcioneliminarDocumento">
																			eliminarDocumento("<html-el:rewrite page='/removeDocumentoEditarAsunto.do'/>","<bean:write name='fila_rowNum' filter='false'/>","<bean:message key='ieci.tecdoc.sgm.rpadmin.asuntos.eliminar.documento'/>","<bean:write name='fila' property='description' filter='false'/>",ESTADO_ELIMINADO)
																		</c:set>
																		<td class="col_eliminar" nowrap="nowrap" onclick="<c:out value="${funcioneliminarDocumento}"/>">
																			<bean:message key="ieci.tecdoc.sgm.rpadmin.botones.eliminar"/>
																		</td>
																...
																<span id='btnCancelar_<bean:write name="fila_rowNum"/>' style="display:none;text-align:center">
																	...
																	<logic:notEqual name="fila" property="estado" value="1">
																		<c:set var="funcioncancelarEdicionDocumento">
																			cancelarEdicionDocumento("<bean:write name='fila_rowNum' filter='false'/>","<bean:write name='fila' property='description' filter='false'/>")
																		</c:set>
																		<td class="col_cancelar" nowrap="nowrap" onclick="<c:out value="${funcioncancelarEdicionDocumento}"/>" title='<bean:message key="ieci.tecdoc.sgm.rpadmin.asuntos.documentos.cancelar.edicion"/>'>
																			<bean:message key="ieci.tecdoc.sgm.rpadmin.asuntos.documentos.cancelar.edicion"/>
																		</td>
																	</logic:notEqual>
