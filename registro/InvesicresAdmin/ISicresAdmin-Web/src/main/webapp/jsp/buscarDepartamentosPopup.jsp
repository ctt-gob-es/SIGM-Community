...
<title><bean:message key="ieci.tecdoc.sgm.pgadmin.title.aplication"/> - <bean:message key="ieci.tecdoc.sgm.rpadmin.oficinas.seleccione.departamento"/></title>
...
<script language="Javascript">
	...
	function llamadaActionAceptarPopup() {
		...
		if( idTipo == undefined && idSelect == undefined &&
			...
			alert("<bean:message key="ieci.tecdoc.sgm.rpadmin.error.mensaje.required.select.departamento"/>")
			return;
		} else {
			window.opener.document.forms[0].nombreDept.value = nombreDept;
			window.opener.document.forms[0].deptId.value = idSelect;
			window.close();
											...
											<td>
												<div id="capaDept" style="display:none">
													<table cellpadding="0" cellspacing="0" border="0" width="100%">
														<tr>
															<td class="cuadro">
																<iframe src="<html:rewrite page="/cargarDepartamentosNuevaOficina.do"/>" id="iframeDept" frameborder='0' width=250" height="180"></iframe>
															</td>
														</tr>
													</table>
												</div>
