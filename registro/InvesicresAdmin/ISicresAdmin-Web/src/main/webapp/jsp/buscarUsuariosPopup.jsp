...
<script language="Javascript">
	...
	function llamadaActionAceptarPopup() {
		...
		//alert("idTipo: " + idTipo);
		//alert("nombreUser: " + nombreUser);

		if( nombreUser == undefined || nombreUser == "") {
			alert("<bean:message key="ieci.tecdoc.sgm.rpadmin.error.mensaje.required.select.usuario"/>")
			return;
		} else {
			window.opener.document.forms[0].nombre.value = nombreUser;
			window.close();
		}
	}
											...
											<td>
												<div id="capaDept" style="display:none">
													<table cellpadding="0" cellspacing="0" border="0">
														<tr>
															<td class="cuadro">
																<iframe src="<html:rewrite page="/cargarDepartamentos.do?accion=nuevoUsuario"/>" id="iframeDept" frameborder='0' width=250" height="180"></iframe>
															</td>
														</tr>
													</table>
												</div>
