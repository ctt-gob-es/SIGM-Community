...
<body>
<html:form action="/permisosOficinasAsociadas.do">
<div id="contenedora">
  <!-- Inicio Cabecera -->
    ...
    <div class="cuerpo">
      <div class="cuerporight">
        <div class="cuerpomid">
          ...
          <div class="cuadro">
    		<div id="migas">
				<bean:message key="ieci.tecdoc.sgm.rpadmin.libros.permisos.oficinas.asociadas"/>
			</div>
			...
			<table cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<td class="col_nuevo" onclick="llamadaAction('<html:rewrite page="/permisosOficinasAsociadas.do"/>' + '?idLibro=' + '<bean:write name="libro" property="id"/>' + '&accion=GUARDAR_PERMISOS')"><bean:message key="ieci.tecdoc.sgm.rpadmin.botones.guardar"/></td>
					<td class="col_eliminar" onclick="llamadaAction('<html:rewrite page="/editarLibro.do"/>' + '?idLibro=' + '<bean:write name="libro" property="id"/>')"><bean:message key="ieci.tecdoc.sgm.rpadmin.botones.cancelar"/></td>
				</tr>
			</table></div>
						...
						<display:table name="permisosSicres.lista" uid="fila"
							 requestURI="/listadoAsociacion.do" class="tablaListado" sort="page" style="width:100%">
								<display:column property="nombre" titleKey="ieci.tecdoc.sgm.rpadmin.libros.oficina"
									 sortable="false" style="width: 60%;"/>
								<display:column style="width: 10%;" titleKey="ieci.tecdoc.sgm.rpadmin.libros.asociacion.editar.consultar">
								...
								<display:column style="width: 10%;" titleKey="ieci.tecdoc.sgm.rpadmin.libros.asociacion.editar.crear">
									<table cellspacing="0" cellpadding="0" border="0" align="center">
										<tr>
											<td>
								...
								<display:column style="width: 10%;" titleKey="ieci.tecdoc.sgm.rpadmin.libros.asociacion.editar.modificar">
									<table cellspacing="0" cellpadding="0" border="0" align="center">
										<tr>
											<td>
