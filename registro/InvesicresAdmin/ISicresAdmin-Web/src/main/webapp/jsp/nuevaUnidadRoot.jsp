 	 ...
 	 <!-- Inicio Contenido -->
			<table cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<td align="right" class="col_guardar" onclick="chequear('<html:rewrite page="/guardarNuevaUnidadRoot.do"/>')"><bean:message key="ieci.tecdoc.sgm.rpadmin.botones.aceptar"/></td>
					...
					<div id="nuevaUnidad">
						...
						<table cellpadding="0" cellspacing="0" border="0">
								...
								<tr class="col" style="width:100%">
									...
									<td><html:text property="uid" styleClass="textInput" style="width:360px" maxlength="1" /></td>
								</tr>
								<tr class="col" style="width:100%">
