...
<script>
	...
	function guardar() {
		...
		window.opener.addOficina(id, codigo, nombre);
		window.close();
	}
	...
	<tr>
		<td valign="top">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					<td>
						<div id="tablaListas" style="overflow:scroll; width:370px; height:250px; ">

						<display:table name="listas.lista" uid="fila" requestURI="/listadoSeleccionOficinas.do" class="tablaListado" sort="page">
						 	<display:column style="width:5%" titleKey="ieci.tecdoc.sgm.rpadmin.libros.asociacion.select">
