...
<script language="Javascript">
	...
	function llamadaActionAceptarPopup() {
		if( idTipo == undefined && idSelect == undefined && nombreDept == undefined) {
											...
											<td>
												<div id="capaDept" style="display:none">
													<table cellpadding="0" cellspacing="0" border="0" width="100%">
														<tr>
															<td class="cuadro">
																<iframe src="<html:rewrite page="/cargarDepartamentosImportarUnidad.do"/>" id="iframeDept" frameborder='0' width=250" height="150"></iframe>
															</td>
														</tr>
													</table>
												</div>
