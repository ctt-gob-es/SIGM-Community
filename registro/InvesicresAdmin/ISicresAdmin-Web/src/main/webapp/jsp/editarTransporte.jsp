...
<body>
<html:form action="/editarTransporte.do">
	<div id="contenedora">
		<!-- Inicio Cabecera -->
	...
	<div class="cuadro">
		<div id="migas">
			...
			<span class="migasElementoSeleccionado"><bean:write name="transporteForm" property="transport"/></span>&nbsp;
		</div>
	...
	<table>
		<tr>
			...
			<td class="col_guardar" onclick="llamadaActionIdTransporte('<html:rewrite page="/guardarEdicionTransporte.do"/>', <bean:write name="idTransporte" />)"><bean:message key="ieci.tecdoc.sgm.rpadmin.botones.guardar"/></td>
			<td class="col_volver" onclick="llamadaAction('<html:rewrite page="/listadoTransportes.do"/>')"><bean:message key="ieci.tecdoc.sgm.rpadmin.botones.volver"/></td>
		</tr>
	</table>
	</div>
