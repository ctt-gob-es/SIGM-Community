...
public class DbConnectionConfig
{
   ...
   /** Nombre de esquema de base de datos */
   private static String m_schema = new String();
   private static String m_userGranted = new String();
   ...
   public static String getUserGranted(){
	   return m_userGranted;
   }
   public static void setUserGranted(String userGranted){
	   m_userGranted = userGranted;
   }
   // fin eschema
   /**
    * @see Object#toString()
   ...
   public String toString() {
      ...
      buffer.append(", schema = ").append(m_schema);
      buffer.append("]");
