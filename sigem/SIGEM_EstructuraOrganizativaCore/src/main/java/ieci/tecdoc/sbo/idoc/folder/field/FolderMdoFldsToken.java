...
public class FolderMdoFldsToken
{
   ...
   public static FolderTokenMultFlds createMultFldsToken(DbConnection dbConn, ArchiveToken arch,
                                                         int fdrId)
                                     throws Exception
   {
      ...
      for (i = 0; i < multFlds.count(); i++)
      {
         ...
         switch (fldType)
         {
            ...
            case ArchiveFldType.SHORT_TEXT:
               ...
               {
                  addMultFldsToken(dbConn, arch, fdrId, fldType,
                                   token);                                 
   ...
   private static void addMultFldsToken(DbConnection dbConn, ArchiveToken arch, int fdrId,
                       ...
                       throws Exception
   {
      ...
      rs = multTbl.selectAllColumnRows(dbConn, fdrId);
   ...
   public static FolderTokenExtFlds createExtFldsToken(DbConnection dbConn, ArchiveToken arch,
                                                       int fdrId)
                              throws Exception
   {
      ...
      extTbl.selectRows(dbConn, fdrId, rs);      
