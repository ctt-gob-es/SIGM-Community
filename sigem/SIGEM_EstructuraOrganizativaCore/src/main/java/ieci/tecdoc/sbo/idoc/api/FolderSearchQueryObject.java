...
public final class FolderSearchQueryObject
{
    ...
    * order by
    */   
   public String getSqlQual(DbConnection dbConn, int dbEngine) throws Exception
   {
      return m_query.getSqlQual(dbConn, dbEngine);
   }
    ...
    */
   public String getSqlWhere(DbConnection dbConn, int dbEngine) throws Exception
   {
      return m_query.getSqlWhere(dbConn, dbEngine);
   }
