...
// **************************************************************************
   ...
   public DynDaoRs selectData(String entidad)
                               throws Exception
   {
      ...
      rs = super.selectRows(colsDef ,qual, entidad);

      return rs;
   }

   public DynDaoRs selectByVal(String Qual, String entidad)
                               throws Exception
   {
      ...
      DynDaoRs  rs = new DynDaoRs(colsDef);
      rs = super.selectRows(colsDef ,qualVal, entidad);

      return rs;
   }

   public DynDaoRec selectDataByPk(int id, String entidad)
                               throws Exception
   {
      if ( logger.isDebugEnabled() )
      ...
      super.selectRow(getPkQual(id), rec, entidad);
