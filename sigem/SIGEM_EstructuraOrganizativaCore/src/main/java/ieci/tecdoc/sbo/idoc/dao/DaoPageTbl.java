...
public final class DaoPageTbl
{
   ...
   public void insertRow(DbConnection connection, DaoPageRow row) throws Exception
   {  
   ...
   public void updateRow(DbConnection connection, int id, int fdrId, DaoInputXRow row) throws Exception
   {  
   ...
   public  void deleteRow(DbConnection connection, int id, int fdrId) throws Exception
   {
      DbDeleteFns.delete(connection, m_tblName, getDefaultQual(id, fdrId));
   }
   
   public  void deleteFolderRows(DbConnection connection, int fdrId) throws Exception
   {
      DbDeleteFns.delete(connection, m_tblName, getQualByFdrId(fdrId, false));
   }
   
   // **************************************************************************
   
   public void selectFolderRows(DbConnection connection, int fdrId, DaoOutputXRows rows)
                               throws Exception
   {  
    ...
    public IeciTdLongIntegerArrayList selectFolderFileIds(DbConnection connection, int fdrId)
                                      throws Exception
   {  
      
      IeciTdLongIntegerArrayList vals = new IeciTdLongIntegerArrayList();   
            
      DbSelectFns.select(connection, m_tblName, CD_FILEID.getName(),
    ...
    public void createTable(DbConnection connection) throws Exception
    {
       ...
       idxDef4 = new DbIndexDef(indexName,colNamesIndex,false);
       ...
       DbTableFns.createIndex(connection, m_tblName,idxDef4);
