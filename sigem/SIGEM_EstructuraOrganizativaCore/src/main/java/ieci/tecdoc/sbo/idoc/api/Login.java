...
public final class Login
{
    ...
    * @see LoginMethod
    */
   public int getLoginMethod(String entidad) throws Exception
   {
      int login = 0;
      ...
      {        
    	...
    	LoginManager loginManager=new LoginManager();
         login = loginManager.getLoginMethod(dbConn);
								 ...
								 throws Exception
   {
      ...
      AcsAccessObject acs         = null; 
         ...
         accessToken = LoginManager.doLoginStd(name, pwd, cntsTriesNum, entidad);
												  ...
												  int cntsTriesNum, String entidad) throws Exception
   {
      ...
      try
      {
         ...
         accessToken = LoginManager.doLoginLdap(name, pwd, cntsTriesNum, entidad);
   ...
   public AcsAccessObject doSsoLoginLdap(String name, String entidad)
								  throws Exception
   {
      ...
      try
      {
         ...
         accessToken = LoginManager.doSsoLoginLdap(name, entidad);
