...
public final class DaoClfTbl
{
  ...
  // **************************************************************************
   ...
   public void insertRow(DbConnection connection, DaoClfRow row) throws Exception
   {  
   ...
   public void selectFolderRows(DbConnection connection, int fdrId, boolean orderByName, 
                                DaoOutputXRows rows)
               throws Exception
   {  
      ...
      DbSelectFns.select(connection, m_tblName, rows.getColumnNames(m_tblName), qual, false, rows);
