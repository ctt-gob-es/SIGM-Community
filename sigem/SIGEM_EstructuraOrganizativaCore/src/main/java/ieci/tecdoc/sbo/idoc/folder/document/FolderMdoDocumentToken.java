...
public class FolderMdoDocumentToken
{
   ...
   public static FolderTokenDocuments createDocumentsToken(DbConnection dbConn, String tblPrefix, int archId,
                                                           int fdrId)
                                      throws Exception
   {  
