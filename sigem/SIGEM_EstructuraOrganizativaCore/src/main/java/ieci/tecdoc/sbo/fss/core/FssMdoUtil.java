 ...
 */
   public static final String NEXT_ID_TBL_NAME   = DbConnectionConfig.getSchema() + "IVOLNEXTID";
 ...
 *02-may-2006 / antmaria
 */
   private static final String FTP_PWD_TO_CRYPT  = DbConnectionConfig.getSchema() + "IVOLFTP";	
   private static final String CENTERA_PWD_TO_CRYPT = DbConnectionConfig.getSchema() + "IVOLCENTERA";
