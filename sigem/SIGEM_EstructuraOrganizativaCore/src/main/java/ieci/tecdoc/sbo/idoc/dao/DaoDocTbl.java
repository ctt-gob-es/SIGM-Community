...
public final class DaoDocTbl
{
   ...
   public void insertRow(DbConnection connection, DaoDocRow row) throws Exception
   {  
   ...
   public  void deleteFolderRows(DbConnection connection, int archId, int fdrId) throws Exception
   {
      DbDeleteFns.delete(connection, m_tblName, getDefaultQual(archId, fdrId, false));
   }
   
   // **************************************************************************
   public void selectFolderRows(DbConnection connection, int archId, int fdrId, DaoOutputXRows rows)
               throws Exception
   {  
