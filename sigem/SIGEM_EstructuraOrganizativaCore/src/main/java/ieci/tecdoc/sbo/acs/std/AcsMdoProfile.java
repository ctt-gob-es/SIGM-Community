...
public final class AcsMdoProfile
{
   ...
   public static String getiDocProfile(int userId, String entidad)
                        throws Exception
   {
      String profile = null;
      int    type;
      ...
      {
         if ( isSysSuperuserProfile(userId, entidad) )
            profile = AcsProfile.SYS_SUPERUSER;
         else
         {
            type = AcsDaoUserTypeTbl.selectType(userId, AcsProduct.IDOC, entidad);
   ...
   public static boolean isSysSuperuserProfile(int userId, String entidad)
                         throws Exception
   {
      ...
      try
      {         
         type = AcsDaoUserTypeTbl.selectType(userId, AcsProduct.ISYS, entidad);
   ...
   public static String getiUserProfile(int userId, String entidad)
                        throws Exception
   {
      String profile = null;
      int    type;
      ...
      else
      {
         ...
         {
            type = AcsDaoUserTypeTbl.selectType(userId, AcsProduct.IUSER, entidad);
   ...
   public static String getiVolProfile(int userId, String entidad)
                        throws Exception
   {
      String profile = null;
      int    type;
      ...
      else
      {
         ...
         {
            type = AcsDaoUserTypeTbl.selectType(userId, AcsProduct.IVOL, entidad);
