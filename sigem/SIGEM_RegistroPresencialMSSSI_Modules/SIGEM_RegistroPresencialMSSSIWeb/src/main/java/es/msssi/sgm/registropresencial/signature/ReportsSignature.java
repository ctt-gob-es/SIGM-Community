...
public class ReportsSignature implements IGenericBo, Serializable {
     ...
     */
    public static SignResponse signReport( byte[] pdfReportByteArray, String entidadId) {
     ...
     * @return pdfSignedReportByteArray Datos firmados.
     */
    public static SignResponse signReport( byte[] pdfReportByteArray, String nameFile, String entidadId) {
