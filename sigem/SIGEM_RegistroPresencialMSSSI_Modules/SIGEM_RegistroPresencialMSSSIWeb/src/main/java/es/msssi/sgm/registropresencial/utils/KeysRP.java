...
/**
 * Variables estáticas útiles para la aplicación.
 * 
 * @author cmorenog
 * */
public class KeysRP {
	/**
	 * Constante correspondiente al nombre de la variable de sesión que contiene
	...
	/**
	 * Constante correspondiente al nombre de la variable de sesión que contiene
	 * el valor de si está habilitado el intercambio registral.
	 */
	public static final String J_ENABLEDINTREGISTRAL = "J_ENABLEDINTREGISTRAL";
	/**
	 * Constante correspondiente al nombre de la variable de sesión que contiene
	 * el libro registral con el que se está trabajando.
	 */
	public static final String J_BOOK = "J_BOOK";
	/**
	 * Constante correspondiente al nombre de la variable de sesión que contiene
	 * parámetros del libro registral.
	 */
	 ...
	 * nueva rechazada.
	 */
	public static final String I18N_DISTRIBUTION_NEW_FOLDER_ORVE_FOR_USER = "distribution.new.folder.orve.for.user";
	/**
	 * Constante correspondiente al nombre de la variable de distribución del
	 * archivo de propiedades que contiene el texto de que existen entradas
	 * nuevas rechazadas.
	 */
	public static final String I18N_DISTRIBUTION_NEW_FOLDERS_ORVE_FOR_USER = "distribution.new.folders.orve.for.user";
	 ...
	 * distribuido.
	 */
	public static final String I18N_BOOKUSECASE_DISTRIBUTIONHISTORY_MINUTA_DIST_STATE = "distributionhistory.minuta.dist.state.";
	/**
	 ...
	 */
	public static final String REPORT_PROCEEEDING_TEXT = "De conformidad con lo establecido en el art. 16.3 de la ley 39/2015, "
			+ "de 1 de octubre, de Procedimiento Administrativo Común de las Administraciones Públicas, "
			+ "se emite el presente recibo a efectos de acreditación de la presentación de los documentos de referencia.";

	/**
	 * Constante correspondiente al máximo de regsitros a mostrar en un informe.
	 */
	...
	/** Constante que indica la extensión del fichero final. */
	public static final String REPORT_CERTIFICATE_EXTENSION_FILE = ".pdf";
	/** Constante que indica la extensión del archivo compresión de ficheros. */
	public static final String REPORT_CERTIFICATE_EXTENSION_ZIP = ".zip";
	/** Nombre de la plantilla de un acuse de recibo. */
	public static final String IR_REPORT_CERTIFICATE_TEMPLATE_NAME = "RPInputRegistersCertificatesReport.jasper";
	/** Nombre del informe final en formato PDF. */
	public static final String IR_REPORT_CERTIFICATE_NAME = "JustificanteRE";
	/** Nombre de la plantilla de informe de certificados. */
	public static final String IR_REPORT_ORIGIN_RELATIONS_TEMPLATE_NAME = "InputRegistersOriginRelationsReport.jasper";
	/** Nombre del informe final en formato PDF. */
	public static final String IR_REPORT_ORIGIN_RELATIONS_NAME = "InformeRelacionesOrigenRegistrosEntrada.pdf";
	/** Nombre de la plantilla de informe de certificados. */
	public static final String IR_REPORT_DESTINATION_RELATIONS_TEMPLATE_NAME = "InputRegistersDestinationRelationsReport.jasper";
	/** Nombre del informe final en formato PDF. */
	public static final String IR_REPORT_DESTINATION_RELATIONS_NAME = "InformeRelacionesDestinoRegistrosEntrada.pdf";
	/** Nombre de la plantilla de informe de certificados. */
	public static final String OR_REPORT_CERTIFICATE_TEMPLATE_NAME = "RPOutputRegistersCertificatesReport.jasper";
	/** Nombre del informe final en formato PDF. */
	public static final String OR_REPORT_CERTIFICATE_NAME = "JustificanteRS";
	/** Nombre de la plantilla de informe de certificados. */
	public static final String OR_REPORT_ORIGIN_RELATIONS_TEMPLATE_NAME = "OutputRegistersOriginRelationsReport.jasper";
	/** Nombre del informe final en formato PDF. */
	public static final String OR_REPORT_ORIGIN_RELATIONS_NAME = "InformeRelacionesOrigenRegistrosSalida.pdf";
	/** Nombre de la plantilla de informe de certificados. */
	public static final String OR_REPORT_DESTINATION_RELATIONS_TEMPLATE_NAME = "OutputRegistersDestinationRelationsReport.jasper";
	/** Nombre del informe final en formato PDF. */
	public static final String OR_REPORT_DESTINATION_RELATIONS_NAME = "InformeRelacionesDestinoRegistrosSalida.pdf";
	...
	public static final String LABEL_TEMPLATE_NAME = "label.jasper";
	...
	public static final int NUM_REGISTERINFORM = 1500;
}
