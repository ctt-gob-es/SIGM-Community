...
//    public static final String LOGO = "/images/logoDoc.png";
    public static final String LOGO = "/logos/logo.gif";
	...
	UseCaseConf useCaseConf =
		...
		.get(
		    Keys.J_USECASECONF);
	SearchInputRegisterFormAction action = (SearchInputRegisterFormAction) FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("searchInputRegisterAction");
	...
	UseCaseConf useCaseConf =
		...
		.get(
		    Keys.J_USECASECONF);
	SearchOutputRegisterFormAction action = (SearchOutputRegisterFormAction) FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("searchOutputRegisterAction");
