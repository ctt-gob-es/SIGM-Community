...
public class UpdateStatesSIRJobSigem  extends QuartzJobBean {
	...
	private static Logger logger = LoggerFactory.getLogger(UpdateStatesSIRJobSigem.class);
    ...
    public UpdateStatesSIRJobSigem() {
    	super();
    	if (manager == null){
    		manager = IsicresManagerProvider.getInstance().getIntercambioRegistralActualizadorEstadosManager();
    	}
    }
