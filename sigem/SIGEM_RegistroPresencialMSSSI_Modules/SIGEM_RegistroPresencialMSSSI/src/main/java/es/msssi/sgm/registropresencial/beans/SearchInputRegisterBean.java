	...
	public AxSfQueryField fieldtoQuery(String fld, Integer idbook) {
		...
		try {
			if ("fld2".equals(fld) || "fld4".equals(fld)) {
				Object valorDesde = SearchInputRegisterBean.class.getDeclaredField(fld + "ValueDesde").get(this);
				Object valorHasta = SearchInputRegisterBean.class.getDeclaredField(fld + "ValueHasta").get(this);
				if (valorDesde != null && valorHasta == null) {
					valor = SearchInputRegisterBean.class.getDeclaredField( fld + "ValueDesde").get(this);
					...
					if (valorDesde != null && valorHasta != null) {
						...
						if (valorDesde == null && valorHasta != null) {
							valor = SearchInputRegisterBean.class.getDeclaredField( fld + "ValueHasta").get(this);
							operador = Keys.QUERY_LESSER_EQUAL_TEXT_VALUE;
						}
					}
				}
			} else if ("fld16".equals(fld)) {
				try {
					valor = ((ScrCa) SearchInputRegisterBean.class.getDeclaredField( fld + "Value").get(this)).getId();
				...
				try {
					valor = ((ScrOrg) SearchInputRegisterBean.class.getDeclaredField(fld + "Value").get(this)).getId();
				} catch (NullPointerException e) {
					throw e;
				}
				operador = (String) SearchInputRegisterBean.class.getDeclaredField( fld + "Select").get(this);
			} else if ("fld1002".equals(fld)){
	    		...
	    		Object valorDesde = SearchInputRegisterBean.class.getDeclaredField(fld + "Value").get(this);
	    		Object valorHasta = SearchInputRegisterBean.class.getDeclaredField(fld + "ValueHasta").get(this);
	    		operador = (String) SearchInputRegisterBean.class.getDeclaredField( fld + "Select").get(this);
