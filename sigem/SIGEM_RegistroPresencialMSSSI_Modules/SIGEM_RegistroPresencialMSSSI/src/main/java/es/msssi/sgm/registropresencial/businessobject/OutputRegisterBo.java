...
//	private static final String FLD1004 = "fld1004";
	...
	private static AxSf mappingOutputRegisterModifyToAxSF( HashMap<String, Object> fieldsModify) {
		...
		while (it.hasNext()) {
			...
			if (idKey == FIELD14 || idKey == FIELD501 || idKey == FIELD502 || idKey == FIELD507 /* || idKey == FIELD1003 */ || idKey == FIELD1004) {
				AxXf axXf = new AxXf();
				axXf.setFldId(idKey);
	 ...
	 */
	public OutputRegisterBean loadOutputRegisterBean(UseCaseConf useCaseConf, ScrRegstate book, Integer fdrid) throws RPOutputRegisterException, RPGenericException {
		...
		try {
			axsf = (AxSfOut) FolderSession.getBookFolder( useCaseConf.getSessionID(), book.getIdocarchhdr().getId(), fdrid, useCaseConf.getLocale(), useCaseConf.getEntidadId());
			...
			throw new RPOutputRegisterException( RPOutputRegisterErrorCode.LOAD_OUTPUT_REGISTER_ERROR, ErrorConstants.LOAD_OUTPUT_REGISTER_ERROR_MESSAGE, bookException);
		...
		outputRegisterBean.setFld6Name(RBUtil.getInstance( useCaseConf.getLocale()).getProperty( "book.fld6." + axsf.getAttributeValueAsString(FLD6)));
		...
		outputRegisterBean.setFld12Name((axsf.getFld12() != null) ? axsf.getFld12().getCode() : null);
		...
		outputRegisterBean.setFld21((axsf.getExtendedFields().get(FIELD21) != null) ? ((AxXf) axsf.getExtendedFields().get(FIELD21)).getText() : null);
		outputRegisterBean.setFld22((axsf.getExtendedFields().get(FIELD22) != null) ? ((AxXf) axsf.getExtendedFields().get(FIELD22)).getText() : null);
		outputRegisterBean.setFld503((axsf.getAttributeValueAsString("fld503") != null) ? Integer.parseInt(axsf.getAttributeValueAsString("fld503")) : null);
		outputRegisterBean.setFld504((axsf.getAttributeValueAsString("fld504") != null) ? Integer.parseInt(axsf.getAttributeValueAsString("fld504")) : null);
		outputRegisterBean.setFld505((axsf.getAttributeValueAsString("fld505") != null) ? Integer.parseInt(axsf.getAttributeValueAsString("fld505")) : null);
		outputRegisterBean.setFld506((axsf.getAttributeValueAsString("fld506") != null) ? Integer.parseInt(axsf.getAttributeValueAsString("fld506")) : null);
		outputRegisterBean.setFld501((axsf.getExtendedFields().get(FIELD501) != null) ? ((AxXf) axsf.getExtendedFields().get(FIELD501)).getText() : null);
		outputRegisterBean.setFld502((axsf.getExtendedFields().get(FIELD502) != null) ? ((AxXf) axsf.getExtendedFields().get(FIELD502)).getText() : null);
		outputRegisterBean.setFld507((axsf.getExtendedFields().get(FIELD507) != null) ? ((AxXf) axsf.getExtendedFields().get(FIELD507)).getText() : null);
		
		if (null != axsf.getExtendedFields().get(FIELD1003)) {
			outputRegisterBean.setFld1003(Integer.parseInt(((AxXf) axsf.getExtendedFields().get(FIELD1003)).getText()));
			
		} else if (null != axsf.getAttributeValueAsString(FLD1003)) {
			outputRegisterBean.setFld1003(Integer.parseInt(axsf.getAttributeValueAsString(FLD1003)));
			
		} else {
			outputRegisterBean.setFld1003(null);
		}
		
		outputRegisterBean				.setFld1004((axsf.getExtendedFields().get(FIELD1004) != null) ? ((AxXf) axsf.getExtendedFields().get(FIELD1004)).getText() : null);
		
		// Auditamos el acceso al registro
		ISicresAuditHelper.auditarAccesoRegistro(useCaseConf.getSessionID(), book.getIdocarchhdr().getId(), outputRegisterBean.getFdrid(), axsf, book.getIdocarchhdr().getName(), 2);
	 ...
	 *             si se ha producido un error genérico en el proceso.
	 */
	public static Integer saveOrUpdateFolder(UseCaseConf useCaseConf, Integer bookId, Integer fldid, List<?> files, OutputRegisterBean outputRegisterBean, List<Interesado> inter, Map<?, ?> documents) throws RPGenericException, RPOutputRegisterException {
		...
		AxSf newAxSF = new AxSfOut();
		newAxSF.setLiteralBookType(RBUtil.getInstance(useCaseConf.getLocale()).getProperty(Keys.I18N_BOOKUSECASE_NODE_OUTBOOK_NAME));
		...
		if (fldid == null) {
			...
			if (inter != null && inter.size() > 0) {
				...
				outputRegisterBean.setFld9((docIdentidad + " " + nombre + " " + pApellido + " " + sApellido).trim());
			...
			try {
				...
				throw new RPOutputRegisterException( RPOutputRegisterErrorCode.CREATE_OUTPUT_REGISTER_ERROR, ErrorConstants.CREATE_OUTPUT_REGISTER_ERROR_MESSAGE, bookException);
			...
			if (inter != null && inter.size() > 0) {
				outputRegisterBean.setFld9(inter.get(0).getNombre() + " " + inter.get(0).getSapellido());
			...
			try {
				...
				throw new RPOutputRegisterException( RPOutputRegisterErrorCode.UPDATE_OUTPUT_REGISTER_ERROR, ErrorConstants.GET_OUTPUT_REGISTER_ERROR_MESSAGE, bookException);
	 ...
	 *             si se ha producido un error genérico en el proceso.
	 */
	public OutputRegisterBean copyOutputRegisterBean(UseCaseConf useCaseConf, ScrRegstate book, Integer fdrid) throws RPGenericException, RPOutputRegisterException {
		...
		try {
			...
			throw new RPOutputRegisterException( RPOutputRegisterErrorCode.GET_OUTPUT_REGISTER_ERROR, ErrorConstants.GET_OUTPUT_REGISTER_ERROR_MESSAGE, bookException);
	 ...
	 *             si se ha producido un error genérico en el proceso.
	 */
	public Integer updateOnlyFolder(UseCaseConf useCaseConf, Integer bookId, Integer fldid, OutputRegisterBean outputRegisterBean) throws RPGenericException, RPInputRegisterException {
		...
		try {
			FolderSession.updateFolder(useCaseConf.getSessionID(), bookId, fldid, newAxSF, outputRegisterBean.getInteresados(), null, updateDate, launchDistOutRegister, useCaseConf.getLocale(), useCaseConf.getEntidadId());
			...
			LOG.error(ErrorConstants.UPDATE_OUTPUT_REGISTER_ERROR_MESSAGE, bookException);
			throw new RPInputRegisterException( RPInputRegisterErrorCode.UPDATE_INPUT_REGISTER_ERROR, ErrorConstants.GET_OUTPUT_REGISTER_ERROR_MESSAGE, bookException);
