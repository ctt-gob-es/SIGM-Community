...
public class InputRegisterBean extends GenericBean {
     ...
     * - <i>fld22</i>: Número de registro general (WS). 
    ...
    // obligatoriedad del número de registro
    ...
    /**
     * Obtiene el valor del parámetro fld18.
     * 
    ...
    /**
     * Guarda el valor del parámetro fld18.
     * 
     * @param fld18
     *            valor del campo a guardar.
     */
    ...
    /**
     * Guarda el valor del parámetro fld14Name.
     * 
     * @param fld14Name
     *            valor del campo a guardar.
     */
