...
<%@page import="es.dipucr.sigem.arbolDocumental.utils.Defs"%>
...
<head>
	...
	%>
    <META HTTP-EQUIV="Refresh" CONTENT="0;URL=arbolDocumental.do?ENTIDAD_ID=<%=entidadId%>&SESION_ID=<%=sessionId%>&idioma=<%=idioma%>"/>
</head>
