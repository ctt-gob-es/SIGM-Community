		...
		<script language="javascript">
			...
			function validarFormulario() {
				...
				if (campoOperadorFechas.value == "" && (campoFechaHasta.value != "" || campoFechaDesde.value != "")) {
					...
					return false;
				} else if (campoAsunto.value == "" && campoOperadorNumeroRegistro.value == "" && (campoOperadorFechas.value == "" || (campoOperadorFechas.value != "" && campoFechaDesde.value == "")) && (campoOperadorFechasEfectivas.value == "" || (campoOperadorFechasEfectivas.value != "" && campoFechaEfectivaDesde.value == ""))){
		...
		<div class="contenedor_centrado">
			...
			<div class="cuerpo">
				...
				<div class="tabs_submenus">
					<ul>
						<li class="subOff">
							<h3><a href="listadoRegistros.do"><bean:message key="menu.listaRegistros"/></a></h3>
						</li>
						<li class="subOn">
				...
				<div class="cuerpo_subs clearfix" >
					...
					<div class="seccion">
						...
						<p class="fila_sub">
							...
							<html:text property="cnifUsuario" styleClass="sml disabled" readonly="true"></html:text>
						...
						<p class="fila_sub">
							...
							<html:text property="fechaDesde" styleId="fechaDesde" styleClass="sml disabled" maxlength="10" readonly="true"></html:text><img src="img/<%=rutaImagenes%>calendario.bmp" onclick="return showCalendar('fechaDesde', '%d-%m-%Y');" style="vertical-align: bottom; cursor: hand;" alt='<bean:message key="busqueda.calendario.mostrar"/>'	/><span name="Desde" id="f"></span>
							...
							<span id="fechaH" style="visibility:hidden">
								...
								<html:text property="fechaHasta" styleId="fechaHasta" styleClass="sml disabled" maxlength="10" readonly="true"></html:text><img id="botonFechaHasta" src="img/<%=rutaImagenes%>calendario.bmp" onclick="return showCalendar('fechaHasta', '%d-%m-%Y');" style="vertical-align: bottom; cursor: hand;" alt='<bean:message key="busqueda.calendario.mostrar"/>' /><span name="Desde" id="f"></span>
							</span>
						...
						<p class="fila_sub">
				           ...
				           <label for="fecha" class="sml"><bean:message key="busqueda.fechaEfectiva"/>: </label>
							...
							<html:text property="fechaEfectivaDesde" styleId="fechaEfectivaDesde" styleClass="sml disabled" maxlength="10" readonly="true"></html:text><img src="img/<%=rutaImagenes%>calendario.bmp" onclick="return showCalendar('fechaEfectivaDesde', '%d-%m-%Y');" style="vertical-align: bottom; cursor: hand;" alt='<bean:message key="busqueda.calendario.mostrar"/>'/><span name="Desde" id="fe"></span>
