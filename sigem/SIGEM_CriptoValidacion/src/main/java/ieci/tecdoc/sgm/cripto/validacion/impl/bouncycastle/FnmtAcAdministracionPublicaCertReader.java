...
public class FnmtAcAdministracionPublicaCertReader implements IReaderCert {
	...
	public InfoCertificado getInfo(X509Certificate cert) {
	    ...
	    //[Ruben #578546] dejamos en getInfo_antiguo la recuperación de datos de los certificados como se hacia antes buscando en posiciones fijas
	    //Incluimos aquí nueva forma de búsqueda con bucle for e ifs para buscar los campos independiente de posiciones fijas para no tener problemas con
	    // cambios en los aasuntos de los certificados al renovarlos (ha pasado con el de Sello de Organo que trae un nuevo campo).
	...
	public InfoCertificado getInfo_antiguo(X509Certificate cert) {
