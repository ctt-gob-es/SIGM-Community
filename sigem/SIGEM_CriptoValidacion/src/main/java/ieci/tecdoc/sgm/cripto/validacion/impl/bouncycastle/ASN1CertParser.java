 ...
 */
public class ASN1CertParser {

	public static final Logger logger = Logger.getLogger(ASN1CertParser.class);
	
	public ASN1CertParser() {
		super();
	}
	
	/***
	 * Devuelve HaspMap con todas las propiedades del certificado cargadas
	 * oid = valor
	 * 
	 * @param signature
	 */
