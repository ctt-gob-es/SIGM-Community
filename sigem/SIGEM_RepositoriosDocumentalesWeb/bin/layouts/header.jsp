...
<html:html>
	<head>
		...
		<script>
			...
			function showHelp()
			{
				var width = 1050;
				var height = 580;
				path = appBase + '/help/adminVolume.htm';
	...
	<body>
			<div id="cabecera">
		   		<div id="logo">
		   			<img src="include/images/minetur.jpg" alt="GOBIERNO DE ESPAÑA‘A. MINISTERIO DE INDUSTRIA, ENERGÍA Y TURISMO " />
			    		...
			    		<tr>
			    			...
			    			<td>
					      		<div style="padding-top: 8px; padding-right: 24px;">
							   		<a href="javascript:showHelp()"><img src="include/images/help.gif" style="border: 0px" alt="ayuda" width="16" height="16" /></a>
							   	</div>
							</td>
						</tr>
					</table>
			...
			<div id="migas">
				...
				<label class="status" id="status" name="status"><bean:message key="message.header.init"/></label>
			</div>
