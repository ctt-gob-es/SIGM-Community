...
public class BookId  implements java.io.Serializable {
    ...
    /**
     * Gets the bookId value for this BookId.
     * 
     * @return bookId
     */
    ...
    /**
     * Sets the bookId value for this BookId.
     * 
     * @param bookId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BookId)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BookId.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://server.ws.registropresencial.sgm.tecdoc.ieci", "BookId"));
