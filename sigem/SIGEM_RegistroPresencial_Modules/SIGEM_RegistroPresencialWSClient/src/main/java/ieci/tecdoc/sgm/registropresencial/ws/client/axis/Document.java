...
public class Document  extends ieci.tecdoc.sgm.registropresencial.ws.client.axis.RetornoServicio  implements java.io.Serializable {
    ...
    private ieci.tecdoc.sgm.registropresencial.ws.client.axis.Folder folder;
     ...
     * @return folder
     */
    public ieci.tecdoc.sgm.registropresencial.ws.client.axis.Folder getFolder() {
        return folder;
    }
     ...
     * @param folder
     */
    public void setFolder(ieci.tecdoc.sgm.registropresencial.ws.client.axis.Folder folder) {
        this.folder = folder;
    }
