...
public class DocumentsWithPage  implements java.io.Serializable {
    ...
    private ieci.tecdoc.sgm.registropresencial.ws.client.axis.Page[] pages;
    ...
    public DocumentsWithPage(
           ...
           ieci.tecdoc.sgm.registropresencial.ws.client.axis.Page[] pages) {
           this.bookId = bookId;
           this.docID = docID;
     ...
     * @return pages
     */
    public ieci.tecdoc.sgm.registropresencial.ws.client.axis.Page[] getPages() {
        return pages;
    }
     ...
     * @param pages
     */
    public void setPages(ieci.tecdoc.sgm.registropresencial.ws.client.axis.Page[] pages) {
        this.pages = pages;
    }
