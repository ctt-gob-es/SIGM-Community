...
public class BooksInfo  extends ieci.tecdoc.sgm.registropresencial.ws.client.axis.RetornoServicio  implements java.io.Serializable {
    private ieci.tecdoc.sgm.registropresencial.ws.client.axis.BookInfo[] booksInfo;
    ...
    public BooksInfo(
           ...
           ieci.tecdoc.sgm.registropresencial.ws.client.axis.BookInfo[] booksInfo) {
        super(
            errorCode,
            returnCode);
     ...
     * @return booksInfo
     */
    public ieci.tecdoc.sgm.registropresencial.ws.client.axis.BookInfo[] getBooksInfo() {
        return booksInfo;
    }
     ...
     * @param booksInfo
     */
    public void setBooksInfo(ieci.tecdoc.sgm.registropresencial.ws.client.axis.BookInfo[] booksInfo) {
        this.booksInfo = booksInfo;
    }
