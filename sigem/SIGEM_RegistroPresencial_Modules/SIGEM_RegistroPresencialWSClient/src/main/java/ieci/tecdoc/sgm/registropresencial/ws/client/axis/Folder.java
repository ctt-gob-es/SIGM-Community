...
public class Folder  extends ieci.tecdoc.sgm.registropresencial.ws.client.axis.RetornoServicio  implements java.io.Serializable {
    private ieci.tecdoc.sgm.registropresencial.ws.client.axis.BookId bookId;

    private ieci.tecdoc.sgm.registropresencial.ws.client.axis.DocumentsWithPage[] docWithPage;

    private ieci.tecdoc.sgm.registropresencial.ws.client.axis.Documents documentos;

    private ieci.tecdoc.sgm.registropresencial.ws.client.axis.Fields fields;
    ...
    public Folder(
           ...
           ieci.tecdoc.sgm.registropresencial.ws.client.axis.BookId bookId,
           ieci.tecdoc.sgm.registropresencial.ws.client.axis.DocumentsWithPage[] docWithPage,
           ieci.tecdoc.sgm.registropresencial.ws.client.axis.Documents documentos,
           ieci.tecdoc.sgm.registropresencial.ws.client.axis.Fields fields,
     ...
     * @return bookId
     */
    public ieci.tecdoc.sgm.registropresencial.ws.client.axis.BookId getBookId() {
        return bookId;
    }
     ...
     * @param bookId
     */
    public void setBookId(ieci.tecdoc.sgm.registropresencial.ws.client.axis.BookId bookId) {
        this.bookId = bookId;
    }
     ...
     * @return docWithPage
     */
    public ieci.tecdoc.sgm.registropresencial.ws.client.axis.DocumentsWithPage[] getDocWithPage() {
        return docWithPage;
    }
     ...
     * @param docWithPage
     */
    public void setDocWithPage(ieci.tecdoc.sgm.registropresencial.ws.client.axis.DocumentsWithPage[] docWithPage) {
        this.docWithPage = docWithPage;
    }
     ...
     * @return documentos
     */
    public ieci.tecdoc.sgm.registropresencial.ws.client.axis.Documents getDocumentos() {
        return documentos;
    }
     ...
     * @param documentos
     */
    public void setDocumentos(ieci.tecdoc.sgm.registropresencial.ws.client.axis.Documents documentos) {
        this.documentos = documentos;
    }
     ...
     * @return fields
     */
    public ieci.tecdoc.sgm.registropresencial.ws.client.axis.Fields getFields() {
        return fields;
    }
     ...
     * @param fields
     */
    public void setFields(ieci.tecdoc.sgm.registropresencial.ws.client.axis.Fields fields) {
        this.fields = fields;
    }
