...
public class ServicioRegistroWebServiceServiceLocator extends org.apache.axis.client.Service implements ieci.tecdoc.sgm.registropresencial.ws.client.axis.ServicioRegistroWebServiceService {
    ...
    public ieci.tecdoc.sgm.registropresencial.ws.client.axis.ServicioRegistroWebService_PortType getServicioRegistroWebService() throws javax.xml.rpc.ServiceException {
    ...
    public ieci.tecdoc.sgm.registropresencial.ws.client.axis.ServicioRegistroWebService_PortType getServicioRegistroWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ieci.tecdoc.sgm.registropresencial.ws.client.axis.ServicioRegistroWebServiceSoapBindingStub _stub = new ieci.tecdoc.sgm.registropresencial.ws.client.axis.ServicioRegistroWebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ieci.tecdoc.sgm.registropresencial.ws.client.axis.ServicioRegistroWebService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                ieci.tecdoc.sgm.registropresencial.ws.client.axis.ServicioRegistroWebServiceSoapBindingStub _stub = new ieci.tecdoc.sgm.registropresencial.ws.client.axis.ServicioRegistroWebServiceSoapBindingStub(new java.net.URL(ServicioRegistroWebService_address), this);
                _stub.setPortName(getServicioRegistroWebServiceWSDDServiceName());
                return _stub;
            }
        }
