...
public class ListaPersonInfo extends RetornoServicio implements java.io.Serializable {
    private java.lang.String errorCode;

    private ieci.tecdoc.sgm.registropresencial.ws.client.axis.PersonInfo[] personsInfo;
    ...
    public ListaPersonInfo(
           ...
           ieci.tecdoc.sgm.registropresencial.ws.client.axis.PersonInfo[] personsInfo,
     ...
     * @return personsInfo
     */
    public ieci.tecdoc.sgm.registropresencial.ws.client.axis.PersonInfo[] getPersonsInfo() {
        return personsInfo;
    }
     ...
     * @param personsInfo
     */
    public void setPersonsInfo(ieci.tecdoc.sgm.registropresencial.ws.client.axis.PersonInfo[] personsInfo) {
        this.personsInfo = personsInfo;
    }
