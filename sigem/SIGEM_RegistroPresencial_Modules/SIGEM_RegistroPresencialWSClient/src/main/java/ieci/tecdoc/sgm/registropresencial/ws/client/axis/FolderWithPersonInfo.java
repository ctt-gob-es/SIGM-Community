...
public class FolderWithPersonInfo  extends ieci.tecdoc.sgm.registropresencial.ws.client.axis.Folder  implements java.io.Serializable {
    private ieci.tecdoc.sgm.registropresencial.ws.client.axis.PersonInfo[] persons;
    ...
    public FolderWithPersonInfo(
           ...
           ieci.tecdoc.sgm.registropresencial.ws.client.axis.PersonInfo[] persons) {
        super(
            errorCode,
            returnCode,
            bookId,
     ...
     * @return persons
     */
    public ieci.tecdoc.sgm.registropresencial.ws.client.axis.PersonInfo[] getPersons() {
        return persons;
    }
     ...
     * @param persons
     */
    public void setPersons(ieci.tecdoc.sgm.registropresencial.ws.client.axis.PersonInfo[] persons) {
        this.persons = persons;
    }
