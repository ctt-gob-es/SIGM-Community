...
function validateEntidadRegistralOficina(menssageError){
	...
	if(campoError){
		//seleccionamos la pesta�a de Intercambio Registral
...
/**
 * Funcion que cambia el estilo a la pesta�a que contiene los campos erroneos,
...
function changeStylesPestanaWithError(menssageError, campoError){
	//cambiamos el estilo a la pesta�a
	choosebox(3,2);
