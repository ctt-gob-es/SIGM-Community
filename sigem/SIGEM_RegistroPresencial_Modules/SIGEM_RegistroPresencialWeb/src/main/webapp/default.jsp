...
<%
	...
	String idioma = RequestUtils.parseRequestParameterAsString(request, "Idioma");
	// Número del idioma. Ej: 10
	Long numIdioma = RequestUtils.parseRequestParameterAsLong(request, "numIdioma");
...
<html>
	...
	<script language="javascript">
		//Default de SIGEM_RegistroPresencialWeb
		function GetUserDn()
		{
			var e;
	...
	<script language="javascript">
		...
		if (top.g_FolderView)	{
			...
			document.write('<frameset rows="0px,83px, *" name="frSetMain" id="frSetMain" scrolling="no" border="0" onbeforeunload="top.CloseWindow();">');
			document.write('<frame name="frBlank" id="frBlank" SRC="blank.htm" scrolling="no" noresize tabIndex="-1">');
