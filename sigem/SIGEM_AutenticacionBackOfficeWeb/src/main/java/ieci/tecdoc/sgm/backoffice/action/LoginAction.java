...
public class LoginAction extends Action{
	...
	protected ActionForward createSession(ActionMapping mapping,
		...
		// Introducimos una nueva 'llave' en la sesi�n que s�lo se
		// usar� cuando entremos en el m�dulo de Registro
		// Presencial. Se crea una 'llave' con el usuario codificado
		// en BASE64 por si su nombre de usuario contiene alg�n
		// car�cter no ANSI.
		...
		if (!Utilidades.isNuloOVacio(idAplicacion)){
			// Si no es la aplicaci�n de Archivo
