 ...
 * 
 */
public class MultiEntityDataSourceScheduler extends AbstractDataSource {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = LoggerFactory.getLogger(MultiEntityDataSourceScheduler.class);

	/**
	 * propiedad que se encargará de obener realmente el datasource
	 */
	protected MultiEntityDatasourceSchedulerHelper multiEntityDatasourceSchedulerHelper;

	public MultiEntityDatasourceSchedulerHelper getMultiEntityDatasourceSchedulerHelper() {
		return multiEntityDatasourceSchedulerHelper;
	}

	public void setMultiEntityDatasourceHelper( MultiEntityDatasourceSchedulerHelper multiEntityDatasourceSchedulerHelper) {
		this.multiEntityDatasourceSchedulerHelper = multiEntityDatasourceSchedulerHelper;
	}
	...
	public Connection getConnection() throws SQLException {
		...
		Connection result = multiEntityDatasourceSchedulerHelper.getDatasource().getConnection();
		return result;
	}
	...
	public Connection getConnection(String username, String password)throws SQLException {
		...
		Connection result = multiEntityDatasourceSchedulerHelper.getDatasource().getConnection(username, password);
		return result;
	}
