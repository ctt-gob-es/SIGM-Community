...
public class CertificacionException extends Exception {

	private static String RESOURCE_FILE = "ieci.tecdoc.sgm.core.services.certificacion.CertificacionExceptionMessages";
	
	// Tipos de excepcion
	public static final long EC_PREFIX = 771000000;
	...
	protected String errorMessage;
	   ...
	   public CertificacionException(long errorCode) {
	   ...
	   public CertificacionException(String message) {
	   ...
	   public CertificacionException(Throwable cause) {

	      this(0, cause);
	   }

	   public CertificacionException(long errorCode, String message, Throwable cause){
	     super(message,cause);
	   ...
	   public CertificacionException(long errorCode, Throwable cause) {
	   ...
	   public CertificacionException(String message, Throwable cause) {
