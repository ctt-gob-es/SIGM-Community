...
public class Via {
	...
	private ConjuntoCoordenadas coordenadas;
	...
	public Via(String nombreVia, int idVia, String tipoVia, String claseNombre, String idioma, String estatus, String fuente, ConjuntoCoordenadas coordenadas, Portales portales, int codigoINEMunicipio, int provincia) {
	...
	public ConjuntoCoordenadas getCoordenadas() {
		return coordenadas;
	}

	public void setCoordenadas(ConjuntoCoordenadas coordenadas) {
		this.coordenadas = coordenadas;
	}
	...
	public Portales getPortales() {
		return portales;
	}

	public void setPortales(Portales portales) {
		this.portales = portales;
	}
