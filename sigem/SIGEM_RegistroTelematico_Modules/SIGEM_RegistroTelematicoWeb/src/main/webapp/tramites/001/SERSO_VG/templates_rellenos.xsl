			...
			<td>
				<div class="submenu" style="width:100%">
   				...
   				<div class="col" style="padding-left:10px;">
					<label class="gr">
						<xsl:attribute name="style">width:120%; font-weight: bold;</xsl:attribute>
				...
				<div class="col" style="padding-left:10px;">
					...
					<label>
						<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/*[name()=$param_direccionCentro]"/>
					</label>
				</div>
				<div class="col" style="padding-left:10px;">
					<label class="gr">
				...
				<div class="col" style="padding-left:10px;">
					...
					<br/>
					<label>
						<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/*[name()=$param_contactoCentro2]"/>
					</label>
				</div>
				<div class="col" style="padding-left:10px;">
					<label class="gr">
					...
					<br/>
					<label>
						<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/*[name()=$param_contactoCentro3]"/>
					</label>
				</div>
				<div class="col" style="padding-left:10px;">
					<label class="gr">
					...
					<br/>
					<label>
						<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/*[name()=$param_contactoCentro4]"/>
					</label>
				</div>
				...
				<div class="col" style="padding-left:10px;">
					...
					<label class="gr">
						<xsl:attribute name="style">width:270px;padding-left:0px; font-weight: bold; display:none;</xsl:attribute>
					...
					<label class="gr">
						<xsl:attribute name="style">width:350px;padding-left:50px; display:none;</xsl:attribute>
						<b><xsl:value-of select="$lang.a"/></b>
				...
				<div class="col" style="padding-left:10px;">
					...
					<label>
						<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/*[name()=$param_numGrupos2]"/>
					</label>
					<br/>
					<br/>
					<label class="gr">
					...
					<label class="gr">
						<xsl:attribute name="style">width:350px;padding-left:50px;</xsl:attribute>
						<b><xsl:value-of select="$lang.a"/></b>
							<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/*[name()=$param_a2]"/>
						<b><xsl:value-of select="$lang.b"/></b>
							<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/*[name()=$param_b2]"/>
						<b><xsl:value-of select="$lang.c"/></b>
							<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/*[name()=$param_c2]"/>
						<b><xsl:value-of select="$lang.d"/></b>
							<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/*[name()=$param_d2]"/>
						<b><xsl:value-of select="$lang.e"/></b>
							<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/*[name()=$param_e2]"/>
					</label>
					<br/>
					<br/>
					<label class="gr">
						<xsl:attribute name="style">width:450px;padding-left:20px; font-weight: bold;</xsl:attribute>
						<xsl:value-of select="$lang.numTotalBullying"/>:
					</label>
					<label>
						<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/*[name()=$param_numTotalBullying]"/>
					</label>
				</div>
			</td>
		</tr>
