	...
	<xsl:template name="DATOS_SOLICITANTE_REPRESENTANTE">
		...
		<script>
			function getDatosObligado(nif){
				window.open('tramites/001/buscaObligado.jsp?valor=' + nif + ';001', '', 'width=3,height=3');
			}
			function getDatosRepresentante(nif){
				window.open('tramites/001/buscaRepresentante.jsp?valor=' + nif + ';001', '', 'width=3,height=3');
			}
