...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.THosteleria" select="'GAL-Hostelería (CÍBER incluídos)'"/>
	<xsl:variable name="lang.TConcurrencia" select="'GAL-Concurrencia pública'"/>
	<xsl:variable name="lang.TTalleres" select="'GAL-Talleres'"/>
	<xsl:variable name="lang.TGarajes" select="'GAL-Garajes o gasolineras'"/>
	<xsl:variable name="lang.TCarnicerias" select="'GAL-Carnicerías y pescaderías'"/>
	<xsl:variable name="lang.TClinicas" select="'GAL-Clínicas médicas'"/>
	...
	<xsl:variable name="lang.TPeluquerias" select="'GAL-Peluquerías con solarium '"/>
