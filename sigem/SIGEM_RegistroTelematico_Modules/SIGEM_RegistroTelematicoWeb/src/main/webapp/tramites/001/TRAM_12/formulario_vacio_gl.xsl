...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.ubicacion" select="'GAL-Ubicación'"/>
	...
	<xsl:variable name="lang.numero" select="'GAL-Número de plazas para vehículos'"/>
	...
	<xsl:variable name="lang.TMinusvalidos" select="'GAL-Minusválidos'"/>
	...
	<xsl:variable name="lang.planoSituacion" select="'GAL-Plano de situación a escala 1/200'"/>
