...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.opcion-b1" select="'1.- Aplazamiento:'"/>
	<xsl:variable name="lang.opcion-b11" select="'Plazo máximo 24 meses'"/>
	<xsl:variable name="lang.opcion-b2" select="'2.- Fraccionamiento:'"/>
	<xsl:variable name="lang.opcion-b21" select="'Plazo máximo 24 meses, siempre que las cuotas mensuales sean iguales o superiores a 50 euros'"/>
	<xsl:variable name="lang.opcion-b22" select="'Pago mensual en el plazo máximo de 10 días a partir del día 20 de cada mes.'"/>
	...
	<xsl:variable name="lang.notas1" select="'1.- El plazo máximo de resolución de su solicitud es de 6 meses. No obstante se entenderán tácitamente concedidas sin necesidad de emitir resolución expresa en el plazo máximo de 3 meses, si la solitud cumple todos los requisitos indicados en las notas informativas y no se comunica modificación alguna de dicha solicitud. Dentro de dicho plazo recibirá el acuerdo correspondiente o las liquidaciones  aplazadas o fraccionadas. Los efectos del silencio serán NEGATIVOS.'"/>
	...
	<xsl:template match="/" xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			especificos[37] = new Array('opcion-b11','opcion-b11');
			especificos[38] = new Array('opcion-b21','opcion-b21');
			especificos[39] = new Array('opcion-b22','opcion-b22');
			especificos[40] = new Array('opcion-b23','opcion-b23');
			
			especificos[41] = new Array('nombresolihidden','nombresolihidden');
			especificos[42] = new Array('nifsolihidden','nifsolihidden');
			especificos[43] = new Array('ciudad','ciudad')
			especificos[44] = new Array('region','region');
			especificos[45] = new Array('observaciones','observaciones');

			especificos[46] = new Array('rcalle','rcalle');
			especificos[47] = new Array('rc_postal','rc_postal');
			especificos[48] = new Array('rciudad','rciudad')
			especificos[49] = new Array('rregion','rregion');

			especificos[50] = new Array('iban','iban');
			especificos[51] = new Array('ccc1','ccc1');
			especificos[52] = new Array('ccc2','ccc2');
			especificos[53] = new Array('ccc3','ccc3');
			especificos[54] = new Array('ccc4','ccc4');
			especificos[55] = new Array('titular','titular');
			especificos[56] = new Array('nifTitular','nifTitular');
			especificos[57] = new Array('telefonoTitular','telefonoTitular');
			
			especificos[58] = new Array('texto_legal_comun','texto_legal_comun');
			especificos[59] = new Array('texto_datos_personales_comun','texto_datos_personales_comun');
			...
			function verificacionesEspecificas() {
				...
				if(document.getElementById('municipio_liq').value == '000'){
					alert('Debe indicar el municipio al que se corresponde la liquidación.');
					document.getElementById('municipio_liq').focus();
					return false;
				}

				if(!document.getElementById('aplazamiento').checked &amp;&amp; !document.getElementById('fraccionamiento').checked){
					alert('Debe indicar si se trata de un aplazamiento o de un fraccionamiento');
					document.getElementById('aplazamiento').focus();
					return false;
				}
				
				if(document.getElementById('fraccionamiento').checked &amp;&amp; !document.getElementById('opcion-b21').checked  &amp;&amp; !document.getElementById('opcion-b22').checked){
					alert('Para los fraccionamientos debe indicar el plazo.');
					document.getElementById('opcion-b21').focus();
					return false;
				}
			...
			function getDatosObligado(nif){
				window.open('tramites/001/REC_02_VOL/buscaObligado.jsp?valor='+nif+';001','','width=3,height=3');
			}
			function getDatosRepresentante(nif){
				window.open('tramites/001/REC_02_VOL/buscaRepresentante.jsp?valor='+nif+';001','','width=3,height=3');
			}
		</script>
		...
		<xsl:variable name="fileAyuntam" select="java:es.dipucr.sigem.registroTelematicoWeb.formulario.common.XmlCargaDatos.getDatosTablaValidacionConSustituto('REC_VLDTBL_MUNICIPIOS','001')"/>
   		...
   		<div class="cuadro" style="">	
			...
			<input type="text">
				<xsl:attribute name="style">width:190px;margin-left:10px;margin-bottom:1px;margin-top:5px;</xsl:attribute>
			...
			<input type="text">
				<xsl:attribute name="style">width:190px;margin-bottom:1px;</xsl:attribute>
			...
			<br/>
			<input type="text">
				<xsl:attribute name="style">width:190px;margin-left:10px;margin-bottom:1px;</xsl:attribute>
			...
			<div style="margin-bottom:5px;color:#006699;">
				<label for="opcion-b11" style="margin-left:50px;"><xsl:value-of select="$lang.opcion-b11"/></label>
				<input type="text" disabled="disabled">
					<xsl:attribute name="style">width:250px;margin-left:75px; display:none;</xsl:attribute>
			...
			<div style="margin-bottom:5px;color:#006699; margin-left:25px;">
				<input type="checkbox" id="opcion-b21" disabled="disabled" style="width:25px;" onclick="unCheckOthersFracc('opcion-b21')"/>
				<label for="opcion-b21"><xsl:value-of select="$lang.opcion-b21"/></label>
			</div>
			<div style="margin-bottom:5px;color:#006699; margin-left:25px;">
				<input type="checkbox" id="opcion-b22" disabled="disabled" style="width:25px;" onclick="unCheckOthersFracc('opcion-b22')"/>
				<label for="opcion-b22"><xsl:value-of select="$lang.opcion-b22"/></label>				
			</div>
			<div style="margin-bottom:5px;color:#006699; display:none;">
