...
opener.document.getElementById('nif_repre').value = '<%=cif%>';
opener.document.getElementById('nombre_repre').value = '<%=nombre%>';
opener.document.getElementById('domicilio_repre').value = '<%=domicilio%>';
opener.document.getElementById('ciudad_repre').value = '<%=localidad%>';
opener.document.getElementById('region_repre').value = '<%=provincia%>';
opener.document.getElementById('c_postal_repre').value = '<%=cp%>';
opener.document.getElementById('movil_repre').value = '<%=telefono%>';
opener.document.getElementById('d_email_repre').value = '<%=email%>';
window.close();
</script>
