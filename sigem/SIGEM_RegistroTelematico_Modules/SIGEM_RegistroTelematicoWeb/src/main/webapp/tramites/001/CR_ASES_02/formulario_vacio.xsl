		...
		<br/>
   		...
   		<div class="cuadro" style="">	
   			<div class="col">
				...
				<xsl:variable name="fileMateria" select="java:es.dipucr.sigem.registroTelematicoWeb.formulario.common.XmlCargaDatos.getDatosTablaValidacionConSustituto('DPCR_VLDTBL_MATERIA','001')"/>
