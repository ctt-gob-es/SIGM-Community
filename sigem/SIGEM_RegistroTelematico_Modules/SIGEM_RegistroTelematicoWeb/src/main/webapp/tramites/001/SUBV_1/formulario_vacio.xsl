...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.conv249" select="'Subvenciones para la realizacion de Auditorias energeticas de alumbrado para Ayuntamientos de menos de 5.000 habitantes y EATIM.'"/>
	<xsl:variable name="lang.convTitulo" select="'Convocatoria de subvenciones para la realizacion de Auditorias energeticas de alumbrado para Ayuntamientos de menos de 5.000 habitantes y EATIM.'"/>
	...
	<xsl:template match="/">
		<script language="Javascript">
			...
			especificos[23] = new Array('texto_datos_personales_comun','texto_datos_personales_comun');
   		...
   		<div class="cuadro" style="">
   			<div class="col">
				...
				<select class="gr">
					...
					<!--<option value=""></option>-->
					<xsl:choose>
				       	<xsl:when test="$clas='DPCR2010/6052'">
				           		<option value="DPCR2010/6052" selected="selected"><xsl:value-of select="$lang.conv249"/></option>
				       	</xsl:when>
				      		<xsl:otherwise>
				           		<option value="DPCR2010/6052"><xsl:value-of select="$lang.conv249"/></option> 
				       	</xsl:otherwise>
				    </xsl:choose>
				</select>		
