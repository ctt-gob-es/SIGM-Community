...
<xsl:include href="../templates_comunes.xsl" /><xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.expone2" select="', que considerando que tiene derecho al disfrute del beneficio fiscal en el IBI que se indica (seleccionar de las opciones que figuran aquella a la que crea tiene derecho), en el inmueble que se identificará a continuación:'"/>
	...
	<xsl:variable name="lang.notas_motivos1" select="'Opcion 1: Se deberá aportar copia de la cédula de calificación definitiva y de las escrituras de compra venta.'"/>
	<xsl:variable name="lang.notas_motivos2" select="'Opcion 2: Se deberá aportar copia de la licencia de obra, certificado de inicio de obras, y en el caso de que éstas hubieren finalizado certificación final de obra.'"/>
	<xsl:variable name="lang.notas_motivos3" select="'Opcion 3: Se deberá aportar certificado de inscripción en el registro de cooperativas.'"/>
	<xsl:variable name="lang.notas_motivos4" select="'Opcion 4: Se deberá aportar copia del libro de familia numerosa y certificado de empadronamiento.'"/>
