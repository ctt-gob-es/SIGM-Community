	...
	<xsl:template match="/">
		<script language="Javascript">
			...
			function getDatosObligado(nif){
				window.open('tramites/001/REC_10/buscaObligado.jsp?valor='+nif+';001','','width=3,height=3');
			}
			function getDatosRepresentante(nif){
				window.open('tramites/001/REC_10/buscaRepresentante.jsp?valor='+nif+';001','','width=3,height=3');
			}
		</script>
		...
		<br/>
   		...
   		<div class="cuadro" style="">	
			...
			<table style="font-size:10px; margin:5 auto 20 auto; width:90%" cellspacing="0" border="1">
				<tr>
					<td style="width:30%;background-color:#dee1e8;text-align:center"><xsl:value-of select="$lang.liquidacion"/></td>
