...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:template match="/" xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			especificos[52] = new Array('texto_legal_comun','texto_legal_comun');
			especificos[53] = new Array('texto_datos_personales_comun','texto_datos_personales_comun');
			...
			function getDatosObligado(nif){
				window.open('tramites/001/REC_01/buscaObligado.jsp?valor='+nif+';001','','width=3,height=3');
			}
			function getDatosRepresentante(nif){
				window.open('tramites/001/REC_01/buscaRepresentante.jsp?valor='+nif+';001','','width=3,height=3');
			}	
		...
		<br/>
   		...
   		<div class="cuadro" style="">	
			...
			<xsl:variable name="fileTributos" select="java:es.dipucr.sigem.registroTelematicoWeb.formulario.common.XmlCargaDatos.getDatosTablaValidacionConSustituto('REC_VLDTBL_MOT_DEVOLUCION','001')"/>
