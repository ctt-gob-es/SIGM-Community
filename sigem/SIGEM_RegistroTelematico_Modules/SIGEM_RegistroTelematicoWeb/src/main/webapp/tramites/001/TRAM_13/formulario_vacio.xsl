...
<xsl:include href="../templates_comunes.xsl" /><xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.titulo" select="'Formulario de solicitud de Licencia de Apertura de Actividad No Clasificada'"/>
	...
	<xsl:template match="/">
		<script language="Javascript">
			...
			validar[8] = new Array('TRAM13D1','<xsl:value-of select="$lang.fotocopiaDni"/>');
			validar[9] = new Array('TRAM13D2','<xsl:value-of select="$lang.instancia"/>');
			validar[10] = new Array('TRAM13D3','<xsl:value-of select="$lang.proyecto"/>');
			validar[11] = new Array('TRAM13D4','<xsl:value-of select="$lang.croquis"/>');
			validar[12] = new Array('TRAM13D5','<xsl:value-of select="$lang.justificante"/>');
		...
		<div class="submenu">
   		...
   		<div class="cuadro" style="">
			...
			<div class="col">
				...
				<input type="file">
					<xsl:attribute name="style">position: relative; width:400px; </xsl:attribute>
					<xsl:attribute name="name">TRAM13D1</xsl:attribute>
					<xsl:attribute name="id">TRAM13D1</xsl:attribute>
					<xsl:attribute name="value"></xsl:attribute>
				</input>
				<input type="hidden">
					<xsl:attribute name="name">TRAM13D1_Tipo</xsl:attribute>
					<xsl:attribute name="id">TRAM13D1_Tipo</xsl:attribute>
			...
			<div class="col">
				...
				<input type="file">
					<xsl:attribute name="style">position: relative; width:400px; </xsl:attribute>
					<xsl:attribute name="name">TRAM13D2</xsl:attribute>
					<xsl:attribute name="id">TRAM13D2</xsl:attribute>
					<xsl:attribute name="value"></xsl:attribute>
				</input>
				<input type="hidden">
					<xsl:attribute name="name">TRAM13D2_Tipo</xsl:attribute>
					<xsl:attribute name="id">TRAM13D2_Tipo</xsl:attribute>
					<xsl:attribute name="value">pdf,jpg,jpeg,gif,tif,tiff,bmp</xsl:attribute>
				</input>
			</div>
			<br/>
			...
			<div class="col">
				...
				<input type="file">
					<xsl:attribute name="style">position: relative; width:400px; </xsl:attribute>
					<xsl:attribute name="name">TRAM13D3</xsl:attribute>
					<xsl:attribute name="id">TRAM13D3</xsl:attribute>
					<xsl:attribute name="value"></xsl:attribute>
				</input>
				<input type="hidden">
					<xsl:attribute name="name">TRAM13D3_Tipo</xsl:attribute>
					<xsl:attribute name="id">TRAM13D3_Tipo</xsl:attribute>
					<xsl:attribute name="value">pdf,jpg,jpeg,gif,tif,tiff,bmp</xsl:attribute>
				</input>
			</div>
			<br/>
			...
			<div class="col">
				...
				<input type="file">
					<xsl:attribute name="style">position: relative; width:400px; </xsl:attribute>
					<xsl:attribute name="name">TRAM13D4</xsl:attribute>
					<xsl:attribute name="id">TRAM13D4</xsl:attribute>
					<xsl:attribute name="value"></xsl:attribute>
				</input>
				<input type="hidden">
					<xsl:attribute name="name">TRAM13D4_Tipo</xsl:attribute>
					<xsl:attribute name="id">TRAM13D4_Tipo</xsl:attribute>
					<xsl:attribute name="value">pdf,jpg,jpeg,gif,tif,tiff,bmp</xsl:attribute>
				</input>
			</div>
			<br/>
			...
			<div class="col">
				...
				<input type="file">
					<xsl:attribute name="style">position: relative; width:400px; </xsl:attribute>
					<xsl:attribute name="name">TRAM13D5</xsl:attribute>
					<xsl:attribute name="id">TRAM13D5</xsl:attribute>
					<xsl:attribute name="value"></xsl:attribute>
				</input>
				<input type="hidden">
					<xsl:attribute name="name">TRAM13D5_Tipo</xsl:attribute>
					<xsl:attribute name="id">TRAM13D5_Tipo</xsl:attribute>
					<xsl:attribute name="value">pdf,jpg,jpeg,gif,tif,tiff,bmp</xsl:attribute>
				</input>
			</div>
			<br/>
			...
			<div class="col">
				...
				<input type="file">
					<xsl:attribute name="style">position: relative; width:400px; </xsl:attribute>
					<xsl:attribute name="name">TRAM13D6</xsl:attribute>
					<xsl:attribute name="id">TRAM13D6</xsl:attribute>
					<xsl:attribute name="value"></xsl:attribute>
				</input>
				<input type="hidden">
					<xsl:attribute name="name">TRAM13D6_Tipo</xsl:attribute>
					<xsl:attribute name="id">TRAM13D6_Tipo</xsl:attribute>
					<xsl:attribute name="value">pdf,jpg,jpeg,gif,tif,tiff,bmp</xsl:attribute>
				</input>
			</div>
			<br/><br/>
