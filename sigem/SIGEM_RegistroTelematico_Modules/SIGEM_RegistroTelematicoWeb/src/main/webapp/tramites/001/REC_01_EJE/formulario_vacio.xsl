...
<xsl:include href="../templates_comunes.xsl" /><xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.expone2" select="', que habiendo efectuado el pago de las liquidaciones que se indican por (seleccionar la causa):'"/>
	...
	<xsl:variable name="lang.notas_motivos1" select="'Opcion 1: deberá aportarse copia de la liquidación ingresada en 1º lugar y original de las restantes.'"/>
	<xsl:variable name="lang.notas_motivos2" select="'Opcion 3: deberá aportarse copia de la liquidación ingresada en ventanilla cuando se solicite la devolución del embargo u original en otro caso.'"/>
	<xsl:variable name="lang.notas_motivos3" select="'Opcion 4: deberán aportar copia resolución en la que basan la petición.'"/>
	<xsl:variable name="lang.notas_motivos4" select="'Opcion 5: deberá aportar copia de la resolución de anulación, o si ésta procediese de esta Administración indicar el nº de expediente:'"/>
	...
	<xsl:template match="/">
		<script language="Javascript">
			...
			validar[7] = new Array('cuantia','Cuantía solicitada');
			...
			especificos[53] = new Array('motivo','motivo');
			especificos[54] = new Array('expediente','expediente');
			especificos[55] = new Array('cuantia','cuantia');
		...
		<br/>
   		...
   		<div class="cuadro" style="">	
			...
			<select class="gr">
				<xsl:attribute name="style">margin-top:10px; width:99%;color:#006699;</xsl:attribute>
				...
				<option value="MOTIVO_6"><xsl:value-of select="$lang.motivo6"/></option>
				<option value="MOTIVO_7"><xsl:value-of select="$lang.motivo7"/></option>
			</select>
			<br/>
