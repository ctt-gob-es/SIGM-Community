...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.titulo" select="'Formulario de Comunicaciones al Servicio de Gestión Tributaria y Recaudación - Ciudadanos'"/>
	...
	<xsl:template match="/">
		...
		<xsl:call-template name="DATOS_OBLIGADO_SIN_LUPA" />
		<br/>
		<div class="submenu">
