...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:template match="/">
		...
		<xsl:if test="Solicitud_Registro/Datos_Firmados/Datos_Especificos/motivo='4'">
			<div class="col">
				<label class="gr" style="position: relative; width:150px;">
		...
		<xsl:if test="Solicitud_Registro/Datos_Firmados/Datos_Especificos/opcion1='true'">
			<div class="col">
		...
		<xsl:if test="Solicitud_Registro/Datos_Firmados/Datos_Especificos/opcion2='true'">
			<div class="col">
				<label class="gr" style="position: relative; width:650px">
		...
		<div class="col" style="color: grey; text-align:justify">
			...
			<label class="gr" style="position: relative; width:650px">
				<i><xsl:value-of select="$lang.notas4"/></i>
			</label>
		</div>
		<br/>
		<br/>
