...
<xsl:output encoding="ISO-8859-1" method="html"/>
	<xsl:variable name="lang.titulo" select="'CAT-Formulario de solicitud de Licencia de Apertura de Actividad Clasificada (RAMINP)'"/>
	...
	<xsl:variable name="lang.TIndustriales" select="'CAT-Industriales'"/>
	<xsl:variable name="lang.THosteleria" select="'CAT-Hostelería (CÍBER incluídos)'"/>
	<xsl:variable name="lang.TConcurrencia" select="'CAT-Concurrencia pública'"/>
	<xsl:variable name="lang.TTalleres" select="'CAT-Talleres'"/>
	<xsl:variable name="lang.TGarajes" select="'CAT-Garajes o gasolineras'"/>
	<xsl:variable name="lang.TCarnicerias" select="'CAT-Carnicerías y pescaderías'"/>
	<xsl:variable name="lang.TClinicas" select="'CAT-Clínicas médicas'"/>
	<xsl:variable name="lang.TVeterinarias" select="'CAT-Veterinarias'"/>
	<xsl:variable name="lang.TTiendas" select="'CAT-Tiendas de animales'"/>
	<xsl:variable name="lang.TAlmacenaje" select="'CAT-Almacenaje de materiales peligrosos'"/>
	<xsl:variable name="lang.TPeluquerias" select="'CAT-Peluquerías con solarium '"/>
	<xsl:variable name="lang.TOtros" select="'CAT-Otros'"/>
