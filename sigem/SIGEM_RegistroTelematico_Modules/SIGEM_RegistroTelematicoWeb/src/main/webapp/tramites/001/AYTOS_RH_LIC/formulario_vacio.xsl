...
<xsl:output encoding="ISO-8859-1" method="html"/>
	<xsl:variable name="lang.titulo" select="'Formulario General de Solicitud de '"/>
	...
	<xsl:variable name="lang.organoAsignado" select="'Órgano al que se dirige: Registro del Ayuntamiento (Recursos Humanos)'"/>
	<xsl:variable name="lang.anexar" select="'Anexar ficheros'"/>
	<xsl:variable name="lang.docAnexar" select="'Documentación obligatoria: '"/>
	<xsl:variable name="lang.docAnexar2" select="'Debe presentar la documentación escaneada. Si no dispusiera de dicha documentación en el momento de la solicitud dispone de 10 días naturales para presentarla en el Departamento de Personal, computados a partir de la fecha del disfrute de la licencia.'"/><!--[eCenpri-Felipe #549]-->
	<xsl:variable name="lang.docAnexar3" select="'El solicitante manifiesta bajo su responsabilidad que el documento que se adjunta escaneado es fiel reproducción del original y se compromete a custodiarlo y tenerlo a disposición del Servicio de Personal del Ayuntamiento durante 6 meses. Asimismo, el solicitante autoriza al Servicio de Personal a efectuar las comprobaciones que estime pertinentes ante la persona o entidad que ha expedido el citado documento.'"/><!--[eCenpri-Felipe #549]-->
	...
	<xsl:template match="/">
		<script language="Javascript">
			...
			especificos[0] = new Array('documentoIdentidad','NIF'); //[eCenpri-Felipe #41]
			especificos[1] = new Array('nombreSolicitante','Nombre'); //[eCenpri-Felipe #41]
			especificos[2] = new Array('codigoDepartamento','Cod_Departamento');
			especificos[3] = new Array('departamento','Departamento');
			especificos[4] = new Array('contratado','Contratado');
			especificos[5] = new Array('codigoPeticion','Codigo_Peticion');
			especificos[6] = new Array('tipoPeticion','Tipo_Peticion');
			especificos[7] = new Array('anio','Anio'); //[eCenpri-Felipe #39]
			especificos[8] = new Array('fechaInicio','Fecha_Inicio');
			especificos[9] = new Array('fechaFin','Fecha_Fin');
			especificos[10] = new Array('numDiasSolicitados','Num_Dias_Solicitados');
			especificos[11] = new Array('diasSolicitados','Dias_Solicitados');
			especificos[12] = new Array('observaciones','Observaciones');
			especificos[13] = new Array('info','Info');
			especificos[14] = new Array('docs','Docs');
			
			especificos[15] = new Array('texto_legal_comun','texto_legal_comun');
			especificos[16] = new Array('texto_datos_personales_comun','texto_datos_personales_comun');
		...
		<h1><xsl:value-of select="$lang.titulo"/><xsl:value-of select="Datos_Registro/datos_especificos/Tipo_Peticion"/></h1>
			<!-- INICIO [eCenpri-Felipe #549]
				Necesario tipo input para que lo cargue en la siguiente página -->
			<input type="hidden">
