...
<xsl:output encoding="ISO-8859-1" method="html"/>
	<xsl:variable name="lang.titulo" select="'CAT-Formulario de Reclamación económico-administrativa de Tributos'"/>
	...
	<xsl:variable name="lang.datosReclamacion" select="'CAT-Datos de la Reclamación'"/>
	...
	<xsl:variable name="lang.escrito" select="'CAT-Escrito de Interposición (solicitud)'"/>
	<xsl:variable name="lang.justificante" select="'CAT-Documentos justificantes del motivo de la reclamación (recibo duplicado, cambio de titularidad, datos erróneos, etc.)'"/>
