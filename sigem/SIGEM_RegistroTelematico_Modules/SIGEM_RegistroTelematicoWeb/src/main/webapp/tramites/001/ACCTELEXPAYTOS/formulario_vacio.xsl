...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:template match="/"  xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			especificos[18] = new Array('texto_legal_comun','texto_legal_comun');
			especificos[19] = new Array('texto_datos_personales_comun','texto_datos_personales_comun');
			...
			function getDatos(anio){
				window.open('tramites/001/ACCTELEXPAYTOS/dameExpedientes.jsp?valor='+document.getElementById('cif').value+';'+anio.value+';001','','width=3,height=3,left=10000,top=10000');
			}
