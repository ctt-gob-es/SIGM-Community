	...
	<xsl:template match="/"  xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			function getDatos(anio){
				window.open('tramites/001/ACCTELEXPCIU/dameExpedientes.jsp?valor='+document.getElementById('documentoIdentidad').value+';'+anio.value+';001','','width=3,height=3,left=10000,top=10000');
			}
		</script>
