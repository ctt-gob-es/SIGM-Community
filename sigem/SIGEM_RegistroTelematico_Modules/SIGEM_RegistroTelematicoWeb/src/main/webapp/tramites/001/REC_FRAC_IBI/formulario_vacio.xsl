...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:template match="/" xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			especificos[107] = new Array('observaciones','observaciones');

			especificos[108] = new Array('texto_legal_comun','texto_legal_comun');
			especificos[109] = new Array('texto_datos_personales_comun','texto_datos_personales_comun');
			...
			function getDatosObligado(nif){
				window.open('tramites/001/REC_FRAC_IBI/buscaObligado.jsp?valor='+nif+';001','','width=3,height=3');
			}
			function getDatosRepresentante(nif){
				window.open('tramites/001/REC_FRAC_IBI/buscaRepresentante.jsp?valor='+nif+';001','','width=3,height=3');
			}			
		</script>
