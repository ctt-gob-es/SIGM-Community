...
<%
	...
	if(tercero != null){
		...
		if(tercero.getNombreCompleto()!=null)nombre = tercero.getNombreCompleto();
...
opener.document.getElementById('nifcif').value = '<%=cif%>';
opener.document.getElementById('entidad').value = '<%=nombre%>';
