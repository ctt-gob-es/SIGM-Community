...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:template match="/"  xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			especificos[17] = new Array('texto_legal_comun','texto_legal_comun');
			especificos[18] = new Array('texto_datos_personales_comun','texto_datos_personales_comun');
...
//				document.getElementById('domicilioNotificacion').value = document.getElementById('domicilio_repre').value;
		...
		<br/>
   		...
   		<div class="cuadro" style="">	
			...
			<xsl:variable name="convocatoria" select="java:es.dipucr.sigem.registroTelematicoWeb.formulario.common.XmlCargaDatos.getDatosConsulta('Contratacion', 'select numexp, asunto from spac_expedientes where codprocedimiento IN ( select valor from DPCR_CONTR_EXP_CONTR) and fcierre is null and estadoadm=#PR#','001')"/>
