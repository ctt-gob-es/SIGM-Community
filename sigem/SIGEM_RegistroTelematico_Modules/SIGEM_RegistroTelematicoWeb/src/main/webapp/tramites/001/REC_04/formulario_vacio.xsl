	...
	<xsl:template match="/">
		<script language="Javascript">
			...
			function getDatosObligado(nif){
				window.open('tramites/001/REC_04/buscaObligado.jsp?valor='+nif+';001','','width=3,height=3');
			}

			function getDatosRepresentante(nif){
				window.open('tramites/001/REC_04/buscaRepresentante.jsp?valor='+nif+';001','','width=3,height=3');
			}
		</script>
