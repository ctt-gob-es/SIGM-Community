...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.opcion-b11" select="'Vía ejecutiva - Aplazamiento. Plazo máximo 24 meses.'"/>
	<xsl:variable name="lang.opcion-b21" select="'Vía ejecutiva - Fraccionamiento. Plazo máximo 24 meses, siempre que las cuotas mensuales sean iguales o superiores a 50 euros.'"/>
	<xsl:variable name="lang.opcion-b22" select="'Vía ejecutiva - Fraccionamiento. Pago mensual el 20 de cada mes.'"/>
