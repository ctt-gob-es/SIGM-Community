...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.titulo" select="'Formulario de solicitud de Licencia de Obra'"/>

	<xsl:include href="../TRAM_COMUNES/lang_comunes_es.xsl" />

	<xsl:variable name="lang.expone1" select="'EXPONE'"/>
	<xsl:variable name="lang.expone2" select="'Que teniendo interés en la ejecución de las obras que se indican y conocimiento de la obligación legal de solicitar y obtener con carácter previo a su inicio la preceptiva licencia municipal, de conformidad con lo dispuesto en el art. 165 y 166 del Decreto Legislativo 1/2010, de 18 de mayo, por el que se aprueba el texto refundido de la Ley de Ordenación del Territorio y de la Actividad Urbanística de Castilla - La Mancha, y normas concordantes'"/>
	<xsl:variable name="lang.solicita1" select="'SOLICITA'"/>
	<xsl:variable name="lang.solicita2" select="'Que teniendo por presentado el presente escrito, con la documentación que al mismo se acompaña, lo admita y previos los trámites pertinentes, resuelva conceder licencia para ejecución de las siguientes obras'"/>
	<xsl:variable name="lang.finalidad" select="'Finalidad'"/>
	<xsl:variable name="lang.ejemplo" select="'Por ejemplo'"/>
	<xsl:variable name="lang.solicita_defecto" select="'Construcción de Vivienda Unifamiliar en C) .............., nº ...., según proyecto básico y de ejecución suscrito por el Arquitecto D./Dª. ................., visado en fecha .... de .......... de ......, con un presupuesto de .............. euros.'"/>

	<xsl:variable name="doc.docodt" select="'LICOBRA_D1'"/>
	<xsl:variable name="doc.pdf" select="'LICOBRA_D2'"/>
	<xsl:variable name="doc.jpg" select="'LICOBRA_D3'"/>
	<xsl:variable name="doc.zip" select="'LICOBRA_D4'"/>
