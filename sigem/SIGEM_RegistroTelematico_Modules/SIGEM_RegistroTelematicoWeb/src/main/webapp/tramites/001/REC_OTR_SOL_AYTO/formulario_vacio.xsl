...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.titulo" select="'Formulario de Comunicaciones al Servicio de Gestión Tributaria y Recaudación - Ayuntamientos'"/>
	...
	<xsl:template match="/"  xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			especificos[21] = new Array('texto_legal_comun','texto_legal_comun');
			especificos[22] = new Array('texto_datos_personales_comun','texto_datos_personales_comun');
