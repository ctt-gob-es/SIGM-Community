...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.documento5" select="'GAL_Plano de situación de la parcela a escala 1:1000.'"/>
	<xsl:variable name="lang.documento6" select="'GAL-Documentación gráfica de la edificación (planta y secciones transversales).'"/>
