			...
			<tr id="row_{$row_id}" style="{$row_style}">
				<td>
					<select class="gr">
						...
						<option value=''></option>
						<option value='33990000-3'>Equipo de control, seguridad, señalización e iluminación</option>
						<option value='39000000-2'>Mobiliario</option>
						<option value='44000000-0'>Estructuras y materiales de construcción, productos auxiliares para construcción, ferretería, pinturas</option>
						<option value='31000000-6'>Máquinas, aparatos, equipo y productos consumibles eléctricos, iluminación</option>
						<option value='50112000-3'>Servicio de reparación y mantenimiento de automóviles</option>
						<option value='50116500-6'>Servicio de reparación de neumáticos</option>
						<option value='30192000-1'>Artículos de oficina</option>
						<option value='30120000-6'>Fotocopiadoras, máquinas offset e impresoras</option>
						<option value='30200000-1'>Equipo y material informático</option>
						<option value='30230000-0'>Equipo relacionado con la informática</option>
						<option value='09134100-8'>Gasoil</option>
						<option value='09135100-5'>Petroleo para calefacción</option>
						...
						<option value='03300000-2'>Productos de la ganadería la caza y la pesca</option>
