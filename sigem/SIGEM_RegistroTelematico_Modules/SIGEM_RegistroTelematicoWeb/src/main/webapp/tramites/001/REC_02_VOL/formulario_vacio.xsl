...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.opcion-a11" select="'Plazo máximo 12 meses'"/>
	<xsl:variable name="lang.opcion-a2" select="'2.- Fraccionamiento:'"/>
	<xsl:variable name="lang.opcion-a21" select="'Plazo máximo 12 meses, siempre que las cuotas mensuales sean iguales o superiores a 50 euros.'"/>
	<xsl:variable name="lang.opcion-a22" select="'Pago mensual el 20 de cada mes.'"/>
	...
	<xsl:template match="/" xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			especificos[49] = new Array('iban','iban');
			especificos[50] = new Array('ccc1','ccc1');
			especificos[51] = new Array('ccc2','ccc2');
			especificos[52] = new Array('ccc3','ccc3');
			especificos[53] = new Array('ccc4','ccc4');
			especificos[54] = new Array('titular','titular');
			especificos[55] = new Array('nifTitular','nifTitular');
			especificos[56] = new Array('telefonoTitular','telefonoTitular');
			
			especificos[57] = new Array('texto_legal_comun','texto_legal_comun');
			especificos[58] = new Array('texto_datos_personales_comun','texto_datos_personales_comun');
		...
		<xsl:variable name="fileAyuntam" select="java:es.dipucr.sigem.registroTelematicoWeb.formulario.common.XmlCargaDatos.getDatosTablaValidacionConSustituto('REC_VLDTBL_MUNICIPIOS','001')"/>
   		...
   		<div class="cuadro" style="">	
			...
			<div style="margin-bottom:5px;color:#006699;">
				...
				<input type="checkbox" id="aplazamiento" style="border:0px; width:20px;vertical-align:middle;" onclick="checkAplaz(); document.getElementById('opcion-a11').checked=true; a11Clicked();" />
			</div>
			<div style="margin-bottom:20px;color:#006699;">
				...
				<input type="checkbox" id="fraccionamiento" style="border:0px; width:20px;vertical-align:middle;" onclick="checkFracc(); document.getElementById('opcion-a21').checked=true; unCheckOthersFracc('opcion-a21');" />
			</div>
			...
			<div style="margin-bottom:5px;color:#006699;">
				...
				<input type="checkbox" id="opcion-a11" disabled="disabled" style="border:0px; width:20px;vertical-align:middle; display:none;" onclick="a11Clicked()"/>
			</div>

			<div style="margin-bottom:10px;margin-left:15px;"><xsl:value-of select="$lang.opcion-a2"/></div>
			<div style="margin-bottom:5px;color:#006699; margin-left:25px;">
				<input type="checkbox" id="opcion-a21" disabled="disabled" style="border=0; width:25px;" onclick="unCheckOthersFracc('opcion-a21')"/>
				<label for="opcion-a21" style=""><xsl:value-of select="$lang.opcion-a21"/></label>
			</div>
			<div style="margin-bottom:5px;color:#006699; margin-left:25px;">
				<input type="checkbox" id="opcion-a22" disabled="disabled" style="border=0; width:25px;" onclick="unCheckOthersFracc('opcion-a22')"/>
				<label for="opcion-a22" style=""><xsl:value-of select="$lang.opcion-a22"/></label>
			</div>
