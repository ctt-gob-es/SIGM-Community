...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:template match="/"  xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			especificos[24] = new Array('texto_legal_comun','texto_legal_comun');
			especificos[25] = new Array('texto_datos_personales_comun','texto_datos_personales_comun');
