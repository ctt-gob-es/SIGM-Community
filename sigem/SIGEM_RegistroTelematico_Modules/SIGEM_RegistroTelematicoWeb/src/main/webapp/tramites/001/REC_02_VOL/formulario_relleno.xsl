...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.opcion-a11" select="'Vía voluntaria - Aplazamiento. Plazo máximo 12 meses'"/>
	<xsl:variable name="lang.opcion-a21" select="'Vía voluntaria - Fraccionamiento. Plazo máximo 12 meses, siempre que las cuotas mensuales sean iguales o superiores a 50 euros.'"/>
	<xsl:variable name="lang.opcion-a22" select="'Vía voluntaria - Fraccionamiento. Pago mensual el 20 de cada mes.'"/>
	...
	<xsl:template match="/">
		...
		<div class="col">
			...
			<label class="gr" style="position: relative; width:500px;">
				<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/Descripcion_municipio_liq"/>
			</label>
			<br/>
		</div>
		<div class="col">
