...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:template match="/">
		...
		<div class="col">
			<label class="gr" style="position: relative; width:130px;margin-left:7px;">
			...
			<label class="gr" style="position: relative; width:500px;">
				<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/sucursal"/>
			</label>
			<br/>
			<label class="gr" style="position: relative; width:130px;margin-left:7px">
			...
			<label class="gr" style="position: relative; width:500px;">
				<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/dc"/>
			</label>
			<br/>
			<label class="gr" style="position: relative; width:130px;margin-left:7px">
			...
			<label class="gr" style="position: relative; width:500px;">
				<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Especificos/ncc"/>
			</label>
			<br/>
		</div>

		<div class="col">
			<label class="gr" style="position: relative; width:130;margin-left:7px;">
