...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:template match="/"  xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			especificos[27] = new Array('cargo','cargo');
			...
			function getDatosObligado(nif){
				window.open('tramites/000/DPCR_SUBVNOM_OTRASENT_INTERNO/buscaObligado.jsp?valor='+nif+';000','','width=3,height=3');
			}
			function getDatosObligadoEntidad(nif){
				window.open('tramites/000/DPCR_SUBVNOM_OTRASENT_INTERNO/buscaObligadoEntidad.jsp?valor='+nif+';000','','width=3,height=3');
			}
		...
		<br/>
   		...
   		<div class="cuadro" style="">	
			...
			<br/><br/>
			<div style="color: red; text-align:justify; font-weight: bold">
				<label class="gr">
					<xsl:attribute name="style">position: relative; width:650px;</xsl:attribute>
					Recuerde: Es obligatorio que la entidad se haya dado de alta previamente en la Plataforma de Notificaciones Electrónicas (Rápido, gratuito, sin papel)
				</label>
			</div>
			<br/>
			<div align="center">
				<a  title="COMPARECE" href="https://comparece.dipucr.es:8443/CompareceNotificadorInterfaz/"><img src="img/icono_comparece.png" /></a>
			</div>
			<br/><br/>
