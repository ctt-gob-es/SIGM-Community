...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.expone2" select="', que considerando que tiene derecho al disfrute del beneficio fiscal en el IBI por Sociedades Cooperativas (IBI-RUSTICA) correspondientes al municipio de: '"/>
	<xsl:variable name="lang.notas_motivos1" select="'Se deberá aportar  la escritura de constitución de la sociedad y el certificado de inscripción en el registro de cooperativas.'"/>
	...
	<xsl:template match="/" xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			function getDatosObligado(nif){
				window.open('tramites/000/REC_05_III_INTERNO/buscaObligado.jsp?valor='+nif+';000','','width=3,height=3');
			}
			function getDatosRepresentante(nif){
				window.open('tramites/000/REC_05_III_INTERNO/buscaRepresentante.jsp?valor='+nif+';000','','width=3,height=3');
			}			
		</script>
