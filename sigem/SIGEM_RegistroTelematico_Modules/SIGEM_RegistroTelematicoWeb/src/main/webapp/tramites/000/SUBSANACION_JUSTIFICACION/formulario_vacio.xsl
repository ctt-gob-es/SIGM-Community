	...
	<xsl:template match="/"  xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			function getDatosObligado(nif){
				window.open('tramites/000/SUBSANACION_JUSTIFICACION/buscaObligado.jsp?valor='+nif+';000','','width=3,height=3');
			}
			...
			function getAsuntoNumexp(numExpediente){
				window.open('tramites/000/SUBSANACION_JUSTIFICACION/buscaAsuntoNumExp.jsp?valor='+numExpediente+';000','','width=700,height=300,resizable=1');
			}
			function getDatosObligadoEntidad(nif){
				window.open('tramites/000/SUBSANACION_JUSTIFICACION/buscaObligadoEntidad.jsp?valor='+nif+';000','','width=3,height=3');
			}
			function getDatos(anio){
				window.open('tramites/000/SUBSANACION_JUSTIFICACION/dameExpedientes.jsp?valor='+document.getElementById('cif').value+';'+anio.value+';000','','width=3,height=3,left=10000,top=10000');
			}
