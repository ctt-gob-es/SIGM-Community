...
if(document.getElementById('total').value=='')
	document.getElementById('total').value=0;
			...
			<div class="col">
				...
				</input>SOLICITANTE HABITUAL DE AYUDAS ECONÓMICAS (USUARIOS/AS HABITUALES DE SERVICIOS SOCIALES)
				<br/>
				<label>      - </label>
				<input type="checkbox">
					<xsl:attribute name="style">width:17px; </xsl:attribute>
				...
				</input>FAMILIA INCLUIDA EN EL PROGRAMA DE INTERVENCIÓN FAMILIAR
				<br/>
				<label>      - </label>
				<input type="checkbox">
					<xsl:attribute name="style">width:17px; </xsl:attribute>
				...
				</input>FAMILIA NORMALIZADA EN SITUACIÓN DE NECESIDAD DERIVADA DE DESEMPLEO PROLONGADO
				<br/>
				<label>      - </label>
				<input type="checkbox">
					<xsl:attribute name="style">width:17px; </xsl:attribute>
