...
<%
	...
	if(tercero != null){
		...
		if(tercero.getNombreCompleto()!=null)nombre = tercero.getNombre() + " " + tercero.getApellidos();
...
opener.document.getElementById('repres_nif').value = '<%=cif%>';
opener.document.getElementById('repres_nombre').value = '<%=nombre%>';
opener.document.getElementById('rcalle').value = '<%=domicilio%>';
//opener.document.getElementById('rnumero').value = '<%=numero%>';
//opener.document.getElementById('rnumero').value = '';
//opener.document.getElementById('rescalera').value = '';
//opener.document.getElementById('rplanta_puerta').value = '<%=piso%>/<%=puerta%>';
//opener.document.getElementById('rplanta_puerta').value = '';
opener.document.getElementById('rciudad').value = '<%=localidad%>';
opener.document.getElementById('rregion').value = '<%=provincia%>';
opener.document.getElementById('rc_postal').value = '<%=cp%>';
opener.document.getElementById('repres_movil').value = '<%=telefono%>';
opener.document.getElementById('repres_d_email').value = '<%=email%>';
window.close();
</script>
