...
<%
	...
	if(tercero.getDireccionPostalPredeterminada()!=null){
		if(tercero.getDireccionPostalPredeterminada().getDireccionPostal()!=null)domicilio=tercero.getDireccionPostalPredeterminada().getDireccionPostal();
		if(tercero.getDireccionPostalPredeterminada().getMunicipio()!=null)localidad=tercero.getDireccionPostalPredeterminada().getMunicipio();
		if(tercero.getDireccionPostalPredeterminada().getProvincia()!=null)provincia=tercero.getDireccionPostalPredeterminada().getProvincia();
		if(tercero.getDireccionPostalPredeterminada().getCodigoPostal()!=null)cp=tercero.getDireccionPostalPredeterminada().getCodigoPostal();
		if(tercero.getDireccionPostalPredeterminada().getTelefono()!=null)telefono=tercero.getDireccionPostalPredeterminada().getTelefono();
	}
	if(tercero.getDireccionElectronicaPredeterminada()!=null)
		if(tercero.getDireccionElectronicaPredeterminada().getDireccion()!=null)email=tercero.getDireccionElectronicaPredeterminada().getDireccion();
