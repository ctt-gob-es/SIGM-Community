...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.titulo" select="'AYUDAS DIRECTAS A ENTIDADES LOCALES'"/>
	...
	<xsl:variable name="lang.anexarInfo1" select="'1.- Debe anexar la Memoria descriptiva y valorada económicamente del proyecto, programa, servicio o actividad a subvencionar.'"/>
	...
	<xsl:template match="/"  xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			especificos[28] = new Array('declaro3','declaro3');
			
			especificos[19] = new Array('nif_repre','nif_repre');
			especificos[20] = new Array('nombre_repre','nombre_repre');
			especificos[21] = new Array('domicilio_repre','domicilio_repre');
			especificos[22] = new Array('ciudad_repre','ciudad_repre');
			especificos[23] = new Array('c_postal_repre','c_postal_repre');
			especificos[24] = new Array('region_repre','region_repre');
			especificos[25] = new Array('movil_repre','movil_repre');
			especificos[26] = new Array('d_email_repre','d_email_repre');
			
			especificos[27] = new Array('asunto','asunto');
			...
			function getDatosObligado(nif){
				window.open('tramites/001/DPCR_SUBVNOM_INTERNO/buscaObligado.jsp?valor='+nif+';001','','width=3,height=3');
			}
   		...
   		<div class="cuadro" style="">	
   			<div class="col">
				...
				<input type="text">
					...
					<xsl:attribute name="value"><xsl:value-of select="Datos_Registro/datos_especificos/asunto"/>Ayudas Directas a Entidades Locales</xsl:attribute>
					<xsl:attribute name="disabled"></xsl:attribute>
				</input>
			...
			<div class="col">
				...
				<textarea class="gr">
					...
					<xsl:attribute name="rows">7</xsl:attribute>
					<xsl:value-of select="Datos_Registro/datos_especificos/solicita"/>Que la Diputación Povincial de Ciudad Real conceda a esta Entidad Local la subvención indicada o, en su defecto, la mayor cuantía que sea posible.
				</textarea>
			</div>
			...
			<div class="col">
				...
				<input type="file">
					...
					<xsl:attribute name="name">CR_AYUDIREELL_D1</xsl:attribute>
					<xsl:attribute name="id">CR_AYUDIREELL_D1</xsl:attribute>
					<xsl:attribute name="value"></xsl:attribute>
				</input>
				<input type="hidden">
					<xsl:attribute name="name">CR_AYUDIREELL_D1_Tipo</xsl:attribute>
					<xsl:attribute name="id">CR_AYUDIREELL_D1_Tipo</xsl:attribute>
				...
				<input type="file">
					<xsl:attribute name="style">position: relative; width:400px; size:400px;</xsl:attribute>
					<xsl:attribute name="name">CR_AYUDIREELL_D2</xsl:attribute>
					<xsl:attribute name="id">CR_AYUDIREELL_D2</xsl:attribute>
					<xsl:attribute name="value"></xsl:attribute>
				</input>
				<input type="hidden">
					<xsl:attribute name="name">CR_AYUDIREELL_D2_Tipo</xsl:attribute>
					<xsl:attribute name="id">CR_AYUDIREELL_D2_Tipo</xsl:attribute>
				...
				<input type="file">
					<xsl:attribute name="style">position: relative; width:400px; size:400px;</xsl:attribute>
					<xsl:attribute name="name">CR_AYUDIREELL_D3</xsl:attribute>
					<xsl:attribute name="id">CR_AYUDIREELL_D3</xsl:attribute>
					<xsl:attribute name="value"></xsl:attribute>
				</input>
				<input type="hidden">
					<xsl:attribute name="name">CR_AYUDIREELL_D3_Tipo</xsl:attribute>
					<xsl:attribute name="id">CR_AYUDIREELL_D3_Tipo</xsl:attribute>
				...
				<input type="file">
					<xsl:attribute name="style">position: relative; width:400px; size:400px;</xsl:attribute>
					<xsl:attribute name="name">CR_AYUDIREELL_D4</xsl:attribute>
					<xsl:attribute name="id">CR_AYUDIREELL_D4</xsl:attribute>
					<xsl:attribute name="value"></xsl:attribute>
				</input>
				<input type="hidden">
					<xsl:attribute name="name">CR_AYUDIREELL_D4_Tipo</xsl:attribute>
					<xsl:attribute name="id">CR_AYUDIREELL_D4_Tipo</xsl:attribute>
