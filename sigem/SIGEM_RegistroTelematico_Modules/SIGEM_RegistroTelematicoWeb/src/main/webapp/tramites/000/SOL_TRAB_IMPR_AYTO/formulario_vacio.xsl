	...
	<xsl:template match="/"  xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			function verificacionesEspecificas() {
				...
				document.getElementById('nombreAytoAsocia').value = 'AYUNTAMIENTO DE ' + document.getElementById('ayuntamiento').options[document.getElementById('ayuntamiento').selectedIndex].text;
