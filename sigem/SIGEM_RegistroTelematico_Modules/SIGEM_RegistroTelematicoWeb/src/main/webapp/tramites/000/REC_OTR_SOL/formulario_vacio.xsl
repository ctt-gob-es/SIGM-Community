	...
	<xsl:template match="/">
		<script language="Javascript">
			...
			function getDatosObligado(nif){
				window.open('tramites/000/REC_OTR_SOL/buscaObligado.jsp?valor='+nif+';000','','width=3,height=3');
			}

			function getDatosRepresentante(nif){
				window.open('tramites/000/REC_OTR_SOL/buscaRepresentante.jsp?valor='+nif+';000','','width=3,height=3');
			}
