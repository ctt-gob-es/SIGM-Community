...
<%
	...
	String ficheroSolAyto = XmlCargaDatos.getDatosConsulta("Subsanacion", "select a.numexp, trim(a.numexp || # - # ||a.asunto) from  spac_expedientes a where upper(a.nifciftitular) like upper(#%"+ nifCif +"%#) and a.numexp like #%"+anio+"/%# and a.estadoadm in (#PR#,#RS#,#AP#,#NT#,#NE#,#JF#,#DC#,#DI#,#ES#,#EJ#,#CT#,#JP#,#VE#,#PENREI#) and a.fcierre is null and nombreprocedimiento not like #%BOP - Solicitud de inserción de anuncio%# and nombreprocedimiento not like #%Datos del Tercero y Gestión de Representantes%# and nombreprocedimiento not like #%Comunicación administrativa electrónica Registro (Carta digital)%#",entidad);	
	Document dom;
