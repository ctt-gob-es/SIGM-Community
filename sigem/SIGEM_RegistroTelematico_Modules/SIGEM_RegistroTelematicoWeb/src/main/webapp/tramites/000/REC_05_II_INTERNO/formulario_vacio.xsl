...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.expone2" select="', que considerando que tiene derecho al disfrute del beneficio fiscal en el IBI por Empresas de Construcción  Promoción Inmobiliaria (IBI-URBANA) correspondientes al municipio de: '"/>


	<xsl:variable name="lang.notas_motivos1" select="'Se deberá aportar copia de la licencia de obra, certificado de inicio de obras, y en el caso de que éstas hubieren finalizado certificación final de obra.'"/>
	...
	<xsl:template match="/" xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			function getDatosObligado(nif){
				window.open('tramites/000/REC_05_II_INTERNO/buscaObligado.jsp?valor='+nif+';000','','width=3,height=3');
			}
			function getDatosRepresentante(nif){
				window.open('tramites/000/REC_05_II_INTERNO/buscaRepresentante.jsp?valor='+nif+';000','','width=3,height=3');
			}			
		</script>
