...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.contactoCentro" select="'Nombre del/a responsable o persona de contacto del colegio o I.E.S.'"/>
	...
	<xsl:template match="/" xmlns:java="http://xml.apache.org/xslt/java">
		...
		<div class="cuadro" style="">
			<div class="col">
				...
				<br/>
				<xsl:variable name="convocatoria" select="java:es.dipucr.sigem.registroTelematicoWeb.formulario.common.XmlCargaDatos.getDatosConsulta('Convocatoria', 'select numexp, asunto from spac_expedientes where codprocedimiento IN (#CAMP-ERR-VG#) and fcierre is null and estadoadm=#PR#','000')"/>
