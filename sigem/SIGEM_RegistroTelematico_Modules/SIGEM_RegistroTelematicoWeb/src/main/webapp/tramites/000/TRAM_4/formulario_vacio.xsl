...
<xsl:include href="../templates_comunes.xsl" /><xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.apellido1" select="'Primer apellido'"/>
	<xsl:variable name="lang.apellido2" select="'Segundo apellido'"/>
   		...
   		<div class="cuadro" style="">
			...
			<div class="col">
				...
				<input type="text">
					...
					<xsl:attribute name="value"><xsl:value-of select="Datos_Registro/Remitente/Nombre_Apellidos/Primer_Apellido"/></xsl:attribute>
					<xsl:attribute name="disabled"></xsl:attribute>
				</input>
			</div>
			<div class="col">
				...
				<input type="text">
					...
					<xsl:attribute name="value"><xsl:value-of select="Datos_Registro/Remitente/Nombre_Apellidos/Segundo_Apellido"/></xsl:attribute>
					<xsl:attribute name="disabled"></xsl:attribute>
				</input>
			</div>
			<div class="col">
				...
				<input type="text">
					...
					<xsl:attribute name="name">nombreSolicitante</xsl:attribute>
					<xsl:attribute name="id">nombreSolicitante</xsl:attribute>
					<xsl:attribute name="value"><xsl:value-of select="Datos_Registro/Remitente/Nombre_Apellidos/Nombre"/></xsl:attribute>
					<xsl:attribute name="disabled"></xsl:attribute>
				</input>
			</div>
			-->
