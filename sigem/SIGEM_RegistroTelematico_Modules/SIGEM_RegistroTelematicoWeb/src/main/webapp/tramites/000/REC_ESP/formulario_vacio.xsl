	    ...
	    <tr id="row_{$row_id}" style="{$row_style}">
	        <td>
		        <input type="text">
				 ...
				 <xsl:attribute name="onkeyup">if(this.value.length==18){document.getElementById('<xsl:value-of select="$param_ref1"/>').focus();}</xsl:attribute>
