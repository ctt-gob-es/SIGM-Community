...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="VALIDACIONES">
			...
			function getDatosInteresado(nif){
				window.open('tramites/000/TRAM_COMUNES/buscaInteresado.jsp?valor='+nif+';000','','width=3,height=3');
			}

			//Recupera los datos del representante
			function getDatosRepresentante(nif){
				window.open('tramites/000/TRAM_COMUNES/buscaRepresentante.jsp?valor='+nif+';000','','width=3,height=3');
			}
