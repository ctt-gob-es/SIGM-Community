	...
	<xsl:template match="/" xmlns:java="http://xml.apache.org/xslt/java">
		<script language="Javascript">
			...
			function verificacionesEspecificas() {
				...
				if(document.getElementById('menores3anios').value == 'SI'){
					if(document.getElementById('numMenores').value=='' || document.getElementById('numMenores').value == '0'){
		...
		<div class="submenu">
   		...
   		<div class="cuadro" style="">	
			...
			<xsl:variable name="fileAyuntam" select="java:es.dipucr.sigem.registroTelematicoWeb.formulario.common.XmlCargaDatos.getDatosTablaValidacionConSustituto('DPCR_VLDTBL_MUNICIPIOS','000')"/>
