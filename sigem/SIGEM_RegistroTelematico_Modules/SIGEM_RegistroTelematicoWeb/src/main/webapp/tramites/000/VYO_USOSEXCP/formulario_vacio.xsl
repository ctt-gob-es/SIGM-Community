...
//				document.getElementById('localidad').value = document.getElementById('ciudad_repre').value;
			...
			function getDatosObligadoEntidad(nif){
				window.open('tramites/000/VYO_USOSEXCP/buscaObligadoEntidad.jsp?valor='+nif+';000','','width=3,height=3');
			}
		...
		<br/>
   		...
   		<div class="cuadro" style="">	
			...
			<div style="color: grey; text-align:justify">
				<label class="gr">
					<xsl:attribute name="style">position: relative; width:650px;</xsl:attribute>
					En cumplimiento de la Ley Orgánica 15/1999, de 13 de diciembre, de Protección de Datos de Carácter Personal, le informamos que sus datos serán incorporados a un fichero con datos de carácter personal cuya finalidad es la atención de las solicitudes realizadas por los ciudadanos a la Diputación Provincial de Ciudad Real. Le informamos asimismo que los datos podrán ser comunicados a otras Administraciones Públicas en el ámbito de competencias semejantes o materias comunes en cumplimiento de la legislación aplicable. Podrá comunicarnos su oposición a este tratamiento de datos así como ejercer sus derechos de acceso, rectificación y cancelación dirigiéndose al Responsable del Fichero, la Diputación Provincial de Ciudad Real en C/ Toledo, 17, 13071 Ciudad Real - España, siempre acreditando conforme a Derecho su identidad en la comunicación.
				</label>
			</div>
   		</div>
   		<br/>
