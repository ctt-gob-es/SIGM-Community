...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:template match="/">
		<script language="Javascript">
			...
			especificos[40] = new Array('opcion-b11','opcion-b11');
			especificos[41] = new Array('opcion-b21','opcion-b21');
			especificos[42] = new Array('opcion-b22','opcion-b22');
			especificos[43] = new Array('opcion-b23','opcion-b23');
			
			especificos[44] = new Array('nombresolihidden','nombresolihidden');
			especificos[45] = new Array('nifsolihidden','nifsolihidden');
			especificos[46] = new Array('ciudad','ciudad')
			especificos[47] = new Array('region','region');
			especificos[48] = new Array('observaciones','observaciones');

			especificos[49] = new Array('rcalle','rcalle');
			especificos[50] = new Array('rnumero','rnumero');
			especificos[51] = new Array('rescalera','rescalera');
			especificos[52] = new Array('rplanta_puerta','rplanta_puerta');
			especificos[53] = new Array('rc_postal','rc_postal');
			especificos[54] = new Array('rciudad','rciudad')
			especificos[55] = new Array('rregion','rregion');
		...
		<h1><xsl:value-of select="$lang.titulo"/></h1>
   		...
   		<div class="cuadro" style="">	
			...
			<!--<div class="col">
				...
				<input type="text">
					<xsl:attribute name="style">width:150px; </xsl:attribute>
					<xsl:attribute name="name">movilsol</xsl:attribute>
					<xsl:attribute name="id">movilsol</xsl:attribute>
					<xsl:attribute name="value"><xsl:value-of select="Datos_Registro/datos_especificos/movilsol"/></xsl:attribute>
				</input>
			</div>
			<div class="col">				
				<label class="gr">
				...
				<input type="text">
					...
					<xsl:attribute name="name">emailsol</xsl:attribute>
					<xsl:attribute name="id">emailsol</xsl:attribute>
					<xsl:attribute name="value"><xsl:value-of select="Datos_Registro/datos_especificos/emailsol"/></xsl:attribute>
				</input>
			</div>-->
		</div>
   		<div class="submenu">
