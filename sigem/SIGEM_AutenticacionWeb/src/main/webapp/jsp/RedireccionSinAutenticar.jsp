...
<html:html locale="true">
	<head>
		...
		request.getSession().removeAttribute(Defs.SESION_ID);
		request.getSession().removeAttribute(Defs.ENTIDAD_ID);
		request.getSession().removeAttribute("org.apache.struts.action.LOCALE");		
		...
		String url_completa = "../"+url+"?"+Defs.ENTIDAD_ID+"="+entidadId+"&"+Defs.SESION_ID+"="+sesionId+"&"+Defs.LANG+"="+lang+"&"+Defs.COUNTRY+"="+country;		
