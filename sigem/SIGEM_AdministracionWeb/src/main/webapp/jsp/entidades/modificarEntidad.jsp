...
<html>
	...
	<body>
		...
		<jsp:include flush="true" page="../cabecera.jsp">
			<jsp:param name="ayuda" value='<%=request.getContextPath() + "/jsp/ayudas/" + locale + "/entidades/modificar.html"%>' />
		</jsp:include>
					...
					<div class=cuerpomid>
						...
						<div class=cuadro>
							<div>
								...
								<br/>
								<html:form styleId="entidadBean" action="/modificarEntidad.do" method="post">
									<input type=hidden id=codigoINE name=codigoINE value="" />
									...
									<table border=0 cellpadding=0 cellspacing=0 align=center style="padding-left: 12px; padding-bottom:22px;">
										...
										<tr>
											<td>
												<label for='<%="_"+Defs.PARAMETRO_ID_ENTIDAD%>' class="gr_ext"><bean:message key="entidad.nueva.idEntidad" /></label>
											</td>
											<td>
						                		<html:text property="<%=Defs.PARAMETRO_ID_ENTIDAD%>" styleId='<%="_"+Defs.PARAMETRO_ID_ENTIDAD%>' maxlength="3" tabindex="1" disabled="true"></html:text>
						                	</td>
										</tr>
										<tr>
											<td>
