...
public class ExpedienteImpl{
	...
	protected Date fechaConvocatoria;
	
	protected String horaConvocatoria;
	...
	public void setFechaConvocatoria(Date fechaConv){
		this.fechaConvocatoria = fechaConv;
	}
	
	public String getHoraConvocatoria(){
		return this.horaConvocatoria;
	}
