...
<xsl:stylesheet version="1.0"
                ...
                xmlns:m="http://www.facturae.gob.es/formato/Versiones/Facturaev3_2_2.xml"
    ...
    <xsl:template match="m:Facturae">
        ...
        <fo:table>
            ...
            <fo:table-body>
                            ...
                            <fo:table-body>
                                ...
                                <fo:table-row height="1.1cm" border-top-style="solid" border-top-width="0.4mm">
                                    ...
                                    <fo:table-cell>
                                        ...
                                        <fo:block font-family="Courier" font-size="11pt" text-align="left">
											<xsl:choose>
												<xsl:when test='/*/Invoices/Invoice/ReceiverTransactionReference!=""'>
													<xsl:value-of select="/*/Invoices/Invoice/ReceiverTransactionReference"/>
												</xsl:when>
											</xsl:choose>
                                        </fo:block>
                                    </fo:table-cell>
				...
				<fo:table-row border-width="0.4mm" border-style="solid">
                    <fo:table-cell height="2.0cm" number-columns-spanned="2" >
                        <fo:block font-size="7.0pt" font-family="sans-serif" text-align="left">
                            Descripción general de la factura / Invoice Description
                        </fo:block>
						
						<fo:block font-family="Courier" font-size="11pt" text-align="left">
							<xsl:value-of select="/*/Invoices/Invoice/InvoiceIssueData/InvoiceDescription"/>
						</fo:block>
                                ...
                                <xsl:choose>
                                    <xsl:when test='UnitOfMeasure!=""'>
                                        <xsl:choose>
											...
											<xsl:when test='UnitOfMeasure="36"'>
                                                KWh
                                            </xsl:when>
                                            <xsl:otherwise>
                                                -
