...
// perfiles Contiene el numero de la pesta�a dnd se encuentra la capa de perfiles
// si no tiene pesta�a de perfiles definir a '9'
...
if (document.all || document.getElementById) { 
		if (active) {
			...
			tabcolor(active,inactivebgcolor, inactivetextcolor);
			 ...
			 // si la pesta�a mostrada no es igual la de dnd se encuentran los perfiles
