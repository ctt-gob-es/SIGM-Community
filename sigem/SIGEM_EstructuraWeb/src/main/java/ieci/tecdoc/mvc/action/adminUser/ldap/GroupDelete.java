...
public class GroupDelete extends BaseAction{
    ...
    public ActionForward executeLogic(ActionMapping mapping, ActionForm form,
    	...
    	boolean userCanDeleteGroup = true;
    	if (user != null) {
    		userCanDeleteGroup = ( user.getUserProfile().intValue() ==  UserDefs.PROFILE_SUPERUSER );
    	}
    	...
    	try {
        	...
        	ActionMessage msg = new ActionMessage("message.group.darDeBaja");
