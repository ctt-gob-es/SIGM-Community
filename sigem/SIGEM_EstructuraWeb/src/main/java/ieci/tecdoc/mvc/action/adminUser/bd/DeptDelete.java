...
public class DeptDelete extends BaseAction{
    ...
    public ActionForward executeLogic(ActionMapping mapping, ActionForm form,
        ...
        Departments departmentsList = new Departments();
        departmentsList.loadLite(id, entidad);
        if (departmentsList.count() > 0 )
        	throw new IeciTdException(String.valueOf(MvcError.EC_DEPT_HAS_DEPTS), null);
