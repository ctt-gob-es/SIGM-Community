...
public abstract class ServiceTree {
    ...
    */   
    ...
    public void creaNodoRaiz(StringBuffer sbuff, String titulo, String icon){
        ...
        String sentencia= "\n var tree = new WebFXTree('"+ titulo +"',\"javascript:nodoRaizEvent('"+StringUtils.replace(titulo, "'", "\\'")+"');\",'','"+icon+"','"+icon+"',''); \n";
    ...
    public void creaNodo(StringBuffer sbuff, String titulo, String id, String icon){
    	...
    	String sentencia = "var nodo" + id + " = new WebFXTreeItem('"+titulo+"',\"javascript:carga('"+ id+"', '"+StringUtils.replace(titulo, "'", "\\'")+"'  );\",'','"+icon+"','"+icon+"','"+id+"'); \n";            
        sbuff.append(sentencia);
    }
