 ...
 * @author jortizs
 */
public class ReportsDistributionOutAction extends GenericActions implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger LOG = Logger.getLogger(ReportsDistributionOutAction.class.getName());
     ...
     * Constructor.
     */
    public ReportsDistributionOutAction() {
	init();
