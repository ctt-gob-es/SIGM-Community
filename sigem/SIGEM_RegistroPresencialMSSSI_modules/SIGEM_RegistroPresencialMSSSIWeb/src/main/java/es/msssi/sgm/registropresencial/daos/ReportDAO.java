...
public class ReportDAO extends SqlMapClientBaseDao {
    ...
    private static Integer MAX_REPORT_REGISTER = new Integer(Configurator.getInstance()
	    .getProperty(ConfigurationKeys.KEY_DESKTOP_MAX_REPORT_REGISTERS));
    ...
    public List<LinkedHashMap<String, Object>> getRegisterCertReports(List<Integer> fdridList,
	    Integer bookId, boolean isInputRegisterSearch) {
	LOG.trace("Entrando en ReportDAO.getRegisterCertReports()");
	List<LinkedHashMap<String, Object>> reportsList =
		new ArrayList<LinkedHashMap<String, Object>>();
	List<InputRegisterReportsCert> iRegReportsCertResultsList =
		new ArrayList<InputRegisterReportsCert>();
	List<OutputRegisterReportsCert> oRegReportsCertResultsList =
		new ArrayList<OutputRegisterReportsCert>();
	try {
	    HashMap<String, Object> reportsRegisterCertParams = new HashMap<String, Object>();
	    reportsRegisterCertParams.put("idBook", bookId);
	    reportsRegisterCertParams.put("maxReportRegisters", MAX_REPORT_REGISTER);
	    reportsRegisterCertParams.put("fdridList", fdridList);
	    if (isInputRegisterSearch) {
		iRegReportsCertResultsList =
			(List<InputRegisterReportsCert>) getSqlMapClientTemplate().queryForList(
				"InputRegisterReportsCert.selectIRegReportsCert",
				reportsRegisterCertParams);
		...
		oRegReportsCertResultsList =
			(List<OutputRegisterReportsCert>) getSqlMapClientTemplate().queryForList(
				"OutputRegisterReportsCert.selectORegReportsCert",
				reportsRegisterCertParams);
     ...
     */
    private LinkedHashMap<String, Object> fillInputRegisterReportsList(
	    InputRegisterReportsCert inputRegisterReportsCert) throws SQLException {
	...
	inputRegisterHashMap.put("FLD12", inputRegisterReportsCert.getFld12()!=null?
		formatter.format(inputRegisterReportsCert.getFld12()):null);
	...
	String transporte = "";
	if (id != null){
	    List<ScrTt> transportes = ((ValidationListAction) FacesContext.getCurrentInstance().
		getExternalContext().getSessionMap().get(
		"validationListAction")).getListTransportes();
     ...
     *             Si se produce un error al obtener los datos.
     */
    private LinkedHashMap<String, Object> fillOutputRegisterReportsList(
	    OutputRegisterReportsCert outputRegisterReportsCert) throws SQLException {
