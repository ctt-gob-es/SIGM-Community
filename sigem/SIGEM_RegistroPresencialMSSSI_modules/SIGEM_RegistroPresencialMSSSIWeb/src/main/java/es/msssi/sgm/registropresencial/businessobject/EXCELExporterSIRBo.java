 ...
 * @author cmorenog
 * */
public class EXCELExporterSIRBo extends ExcelExporter implements Serializable {

    private static final Logger LOG = Logger.getLogger(EXCELExporterSIRBo.class.getName());
	...
	cellTitle.setCellValue(UtilExporter.TITULO_SIR);
	...
	listaCriterios = UtilExporter.putSIRSearchCriteria();
	...
	try {
	    ...
	    LOG.error(ErrorConstants.EXCEL_DOCUMENT_EXPORT_ERROR_MESSAGE +
		" . Código: " + rpExporterException.getCode().getCode() + " . Mensaje: " +
