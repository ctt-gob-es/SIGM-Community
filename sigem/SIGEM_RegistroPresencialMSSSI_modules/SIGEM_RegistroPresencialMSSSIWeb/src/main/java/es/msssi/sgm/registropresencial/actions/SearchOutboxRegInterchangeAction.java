	                  ...
	                  if (itemVO.getTipoLibro().equals(
		                    new Integer( 1))) {
        	                  ...
        	                  List<Interesado> interadosCon = 
        	                                  interestedBo.getAllInterested(book.getId(), idRegistro, useCaseConf);
        	                  inputRegisterBean.setInteresados(interadosCon);
        	                  
        	                  // INSERTAR REGISTRO                    
        	                  inputRegisterBean.setFdrid(InputRegisterBo.saveOrUpdateFolder(useCaseConf, book.getId(), null, null, inputRegisterBean,
        	                  ...
        	                  asocRegisterBean.setIdLibro(book.getId());
    	                  ...
    	                  // INSERTAR REGISTRO                    
    	                  outputRegisterBean.setFdrid(OutputRegisterBo.saveOrUpdateFolder(useCaseConf, book.getId(), null, null, outputRegisterBean,
        	                  ...
        	                  asocRegisterBean.setIdLibro(book.getId());
        	                  registerBo.saveAssociation(useCaseConf, asocRegisterBean,
	               			    outputRegisterBean.getFdrid(), book.getId());
        	                  try {
