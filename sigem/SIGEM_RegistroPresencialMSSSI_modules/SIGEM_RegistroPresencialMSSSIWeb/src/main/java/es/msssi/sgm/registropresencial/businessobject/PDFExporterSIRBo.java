 ...
 * @author cmorenog
 * */
public class PDFExporterSIRBo extends PDFExporter {
    private static final Logger LOG = Logger.getLogger(PDFExporterSIRBo.class);

    /**
     * Constructor.
     */
    public PDFExporterSIRBo() {
	super();
    }
