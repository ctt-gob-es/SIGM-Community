...
/**
 * Clase que implementa converter para el combo de Organismos de destino.
 * Permite que los valores de un combo sean Beans.
 * 
 * @author cmorenog
 */
@FacesConverter(value = "orgConverterDestination")
public class OrgConverterDestination implements Converter {
    private static final Logger LOG = Logger.getLogger(OrgConverterDestination.class);
	...
	LOG.trace("Entrando en OrgConverterDestination.getAsObject()");
	...
	String result = "";
	LOG.trace("Entrando en OrgConverterDestination.getAsString()");
	if (value == null ||
	    "".equals(value)) {
	    result = "";
	}
