 ...
 * @author cmorenog
 */
public class SearchUnitsBo extends LazyDataModel<ScrOrg> implements
    IGenericBo {
	...
	try {
	   UnitsResultsBean result = getUnits(
	    ...
	    LOG.error(
		ErrorConstants.GET_LIST_UNIT_REGISTER_ERROR_MESSAGE, sessionException);
	}
	catch (ValidationException validationException) {
	    LOG.error(
		ErrorConstants.GET_LIST_UNIT_REGISTER_ERROR_MESSAGE, validationException);
	}
	catch (AttributesException attributesException) {
	    LOG.error(
		ErrorConstants.GET_LIST_UNIT_REGISTER_ERROR_MESSAGE, attributesException);
	}
	return data;
    }
     ...
     */
    @Override
    public ScrOrg getRowData(
	String rowKey) {
	@SuppressWarnings("unchecked")
	List<ScrOrg> rowSearchUnitsBean =
	    (List<ScrOrg>) getWrappedData();
	ScrOrg result = null;
     ...
     */
    public UnitsResultsBean getUnits(
	...
	UnitsResultsBean unitsResults = unitsBo.searchUnits(
