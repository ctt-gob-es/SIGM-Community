...
public class Utils {
     ...
     * */
    public static String converterToCS(
	String valor) {
	LOG.trace("Entrando en Utils.converterToCS()");
	String result = null;
	if (valor != null) {
	    result = valor.toUpperCase().replace(
		"Á", "A").replace(
		"É", "E").replace(
		"Í", "I").replace(
		"Ó", "O").replace(
	...
	Map<String, Object> beans, boolean readOnly, String url) {
	...
	RPBaseException rpBaseException, TecDocException tecDocException, Exception exception) {
	...
	if (rpBaseException != null) {
	    ...
	    LOG.trace(MESSAGE +
		rpBaseException.getCode().getCode() + MESSAGE_MSG +
		rpBaseException.getShortMessage());
	}
	    ...
	    LOG.trace(MESSAGE +
		tecDocException.getCode() + MESSAGE_MSG + tecDocException.getMessage());
	}
	else {
	    ...
	    LOG.trace(MESSAGE +
		exception.getLocalizedMessage() + MESSAGE_MSG + exception.getMessage());
	}
	...
	try {
	    ...
	    LOG.error(
		"La página error.xhtml no existe", ioException);
	}
    }
     ...
     */
    public static String formatTimeStampInString(
	Timestamp date) {
     ...
     * @return dateFormatted fecha convertida.
     */
    public static String formatDateInString(
	Date date) {
	SimpleDateFormat format1 = new SimpleDateFormat(
	    "dd-MM-yyyy HH:mm:ss");
	String dateFormatted = format1.format(date);
     ...
     */
    public static byte[] convertInputStreamToByeArray(
     ...
     */
    public static AxSf mappingInputRegisterToAxSF(
     ...
     * @return newAxSF Bean mapeado.
     */
    public static AxSf mappingOutputRegisterToAxSF(
	...
	if (outputRegisterBean.getFld2() != null) {
	    newAxSF.addAttributeName(FLD2);
	    newAxSF.addAttributeValue(
		FLD2, outputRegisterBean.getFld2());
	}
	if (outputRegisterBean.getFld4() != null) {
	    newAxSF.addAttributeName(FLD4);
	    newAxSF.addAttributeValue(
		FLD4, outputRegisterBean.getFld4());
	}
	if (outputRegisterBean.getFld6() != null) {
	    newAxSF.addAttributeName(FLD6);
	    newAxSF.addAttributeValue(
		FLD6, outputRegisterBean.getFld6());
	}
	if (outputRegisterBean.getFld7() != null) {
	    newAxSF.addAttributeName(FLD7);
	    newAxSF.addAttributeValue(
		FLD7, outputRegisterBean.getFld7().getId());
	}
	if (outputRegisterBean.getFld8() != null) {
	    newAxSF.addAttributeName(FLD8);
	    newAxSF.addAttributeValue(
		FLD8, outputRegisterBean.getFld8().getId());
	}
	if (outputRegisterBean.getFld10() != null &&
	    !"".equals(outputRegisterBean.getFld10())) {
	    newAxSF.addAttributeName(FLD10);
	    newAxSF.addAttributeValue(
		FLD10, outputRegisterBean.getFld10());
	}
	if (outputRegisterBean.getFld11() != null &&
	    !"".equals(String.valueOf(outputRegisterBean.getFld11()))) {
	    newAxSF.addAttributeName(FLD11);
	    newAxSF.addAttributeValue(
		FLD11, outputRegisterBean.getFld11());
	}
	if (outputRegisterBean.getFld12() != null &&
	    !"".equals(String.valueOf(outputRegisterBean.getFld12()))) {
	    newAxSF.addAttributeName(FLD12);
	    newAxSF.addAttributeValue(
		FLD12, outputRegisterBean.getFld12().getId());
	}
	if (outputRegisterBean.getFld13() != null &&
	    !"".equals(outputRegisterBean.getFld13())) {
	    newAxSF.addAttributeName(FLD13);
	    newAxSF.addAttributeValue(
		FLD13, outputRegisterBean.getFld13());
	}
	if (outputRegisterBean.getFld14() != null &&
	    !"".equals(outputRegisterBean.getFld14())) {
	    newAxSF.addAttributeName(FLD14);
	    newAxSF.addAttributeValue(
		FLD14, outputRegisterBean.getFld14());
	}
	if (outputRegisterBean.getFld21() != null &&
	    !"".equals(outputRegisterBean.getFld21())) {
	    newAxSF.addAttributeName(FLD21);
	    newAxSF.addAttributeValue(
		FLD21, outputRegisterBean.getFld21());
	}
	if (outputRegisterBean.getFld22() != null &&
	    !"".equals(outputRegisterBean.getFld22())) {
	    newAxSF.addAttributeName(FLD22);
	    newAxSF.addAttributeValue(
		FLD22, outputRegisterBean.getFld22());
	}
	return newAxSF;
    }
