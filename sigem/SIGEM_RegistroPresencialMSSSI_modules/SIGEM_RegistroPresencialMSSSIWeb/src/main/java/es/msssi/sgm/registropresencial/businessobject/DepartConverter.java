...
public class DepartConverter implements Converter {
	...
	if ("".equals(submittedValue.trim())) {
		...
		LOG.info("Departamento convertido con id " +
			    p.getId());
		result = p;
	    }
		...
		throw new ConverterException(
			...
			ErrorConstants.USER_DOES_NOT_EXISTS_MESSAGE));
	...
	if (value == null) {
	    LOG.info("El Id del departamento a convertir es nulo o está vacío."
		+ " El departamento queda nulo");
	    idConverted = null;
	}
	else {
