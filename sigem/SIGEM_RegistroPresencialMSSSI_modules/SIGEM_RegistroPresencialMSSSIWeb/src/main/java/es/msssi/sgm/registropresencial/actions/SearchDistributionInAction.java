 ...
 * @author cmorenog
 * */
public class SearchDistributionInAction extends GenericActions implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger LOG = Logger.getLogger(SearchDistributionInAction.class.getName());
     ...
     */
    public SearchDistributionInAction() throws SessionException {
	...
	if (selectedResults != null &&
		...
		if ("1".equals(tipoAceptacion)){
		 ...
		 // List<ScrDistreg> listDistr =
			...
			// List<ScrDistreg> listDistr =
			distributionBo.accept(
			    useCaseConf, list, libroSelecAceptar,tipoRegistros);
		    }
		}
