...
/**
 * Bean con el formulario de búsqueda de los registros de salida.
 * 
 * @author cmorenog
 */
public class SearchOutputRegisterBean
		extends GenericBean {
	...
	public AxSfQueryField fieldtoQuery(String fld, Integer idbook) {
		...
		try {
			if ("fld2".equals(fld) || "fld4".equals(fld)) {
				Object valorDesde =
						SearchOutputRegisterBean.class
				...
				if (valorDesde != null && valorHasta == null) {
					valor =
							SearchOutputRegisterBean.class.getDeclaredField(
				...
				if ("fld12".equals(fld)) {
					try {
						valor =
								((ScrCa) SearchOutputRegisterBean.class.getDeclaredField(
					...
					operador =
							(String) SearchOutputRegisterBean.class.getDeclaredField(
									fld + "Select").get(this);
				}
				else {
					if ("fld7".equals(fld) || "fld8".equals(fld)) {
						try {
							valor =
									((ScrOrg) SearchOutputRegisterBean.class
							...
							SearchOutputRegisterBean.class.getDeclaredField(
        						...
        						if ("fld1".equals(fld)){
        						    ...
        						    Object valorHasta =
        								SearchOutputRegisterBean.class
        										.getDeclaredField(fld + "ValueHasta").get(this);
        						    operador = (String) SearchOutputRegisterBean.class.getDeclaredField(
									fld + "Select").get(this);
	...
	/**
	 * Obtiene el valor del parámetro fld11Select.
	 * 
	...
	/**
	 * Guarda el valor del parámetro fld11Select.
	 * 
	 * @param fld11Select
	 *            valor del campo a guardar.
	 */
	...
	/**
	 * Obtiene el valor del parámetro fld11Value.
	 * 
	...
	/**
	 * Guarda el valor del parámetro fld11Value.
	 * 
	 * @param fld11Value
	 *            valor del campo a guardar.
	 */
	...
	/**
	 * Obtiene el valor del parámetro fld12Select.
	 * 
	...
	/**
	 * Guarda el valor del parámetro fld12Select.
	 * 
	 * @param fld12Select
	 *            valor del campo a guardar.
	 */
	...
	/**
	 * Obtiene el valor del parámetro fld12Value.
	 * 
	...
	/**
	 * Guarda el valor del parámetro fld12Value.
	 * 
	 * @param fld12Value
	 *            valor del campo a guardar.
	 */
	...
	/**
	 * Obtiene el valor del parámetro fld13Select.
	 * 
	...
	/**
	 * Guarda el valor del parámetro fld13Select.
	 * 
	 * @param fld13Select
	 *            valor del campo a guardar.
	 */
	...
	/**
	 * Obtiene el valor del parámetro fld13Value.
	 * 
	...
	/**
	 * Guarda el valor del parámetro fld13Value.
	 * 
	 * @param fld13Value
	 *            valor del campo a guardar.
	 */
