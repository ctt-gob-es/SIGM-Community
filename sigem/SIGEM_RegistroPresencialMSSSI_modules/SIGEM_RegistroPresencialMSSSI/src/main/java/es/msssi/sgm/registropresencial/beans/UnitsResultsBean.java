...
/**
 * Bean que guarda los datos que devuelve la consulta de unidades.
 * 
 * @author cmorenog
 */
public class UnitsResultsBean
		extends GenericBean {
	...
	private List<ScrOrg> rows =
			new ArrayList<ScrOrg>();
	
	/**
	 * Constructor.
	 */
	public UnitsResultsBean() {
	}
	 ...
	 *            valor del campo a guardar.
	 */
	public void setRows(List<ScrOrg> rows) {
		this.rows = rows;
	}
