...
//		elementoInteresados
		...
		interesado.setDocIndentidad("122275223W");
		...
		representanteInteresado.setDocIndentidad("111275223W");
...
//	}
	...
	private static List<Interesado> getInteresadosFromRequest(
		...
		for(InteresadoFisico elemento: listInteresadoFisico){
			...
			interesado.setDocIndentidad(elemento.getNumeroDocumento());
			...
			if(elemento.getRepresentante() != null){
				...
				if(elementoRepresentante.getRepresentanteFisico() != null){					
					...
					representanteInteresado.setDocIndentidad(representante.getNumeroDocumento());
		...
		if(interesados != null){
			...
			for(Interesado item: interesados){
				...
				if(item.getTipo().equals(Constants.TIPO_PERSONA_FISICA)){
					...
					elemInteresado.setNumeroDocumento(item.getDocIndentidad());
					...
					if(rep != null){
						...
						if(rep.getTipo().equals(Constants.TIPO_PERSONA_FISICA)){
							...
							repItem.setNumeroDocumento(rep.getDocIndentidad());
