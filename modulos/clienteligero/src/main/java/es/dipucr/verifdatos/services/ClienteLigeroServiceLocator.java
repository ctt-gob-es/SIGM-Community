...
public class ClienteLigeroServiceLocator extends org.apache.axis.client.Service implements es.dipucr.verifdatos.services.ClienteLigeroService {
    ...
    private java.lang.String ClienteLigero_address = ServiciosWebSVDFunciones.getDireccionClienteLigeroSW();
    ...
    public es.dipucr.verifdatos.services.ClienteLigero getClienteLigero() throws javax.xml.rpc.ServiceException {
    ...
    public es.dipucr.verifdatos.services.ClienteLigero getClienteLigero(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.dipucr.verifdatos.services.ClienteLigeroSoapBindingStub _stub = new es.dipucr.verifdatos.services.ClienteLigeroSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.dipucr.verifdatos.services.ClienteLigero.class.isAssignableFrom(serviceEndpointInterface)) {
                es.dipucr.verifdatos.services.ClienteLigeroSoapBindingStub _stub = new es.dipucr.verifdatos.services.ClienteLigeroSoapBindingStub(new java.net.URL(ClienteLigero_address), this);
                _stub.setPortName(getClienteLigeroWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services.verifdatos.dipucr.es", "ClienteLigeroService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services.verifdatos.dipucr.es", "ClienteLigero"));
        }
