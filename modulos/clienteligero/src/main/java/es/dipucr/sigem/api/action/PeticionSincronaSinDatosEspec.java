...
public class PeticionSincronaSinDatosEspec {
	...
	public StringBuffer invoke(SessionAPI session, HttpServletRequest request, Element elementDatosEspecificos) throws ISPACException{
    	...
    	if(codigoCertif.equals("Q2827003ATGSS001")){
		...
		String literalError = "";
		try {
			literalError =  getTextNode(element,"LiteralError");
		} catch (Exception e1) {
		...
		if(!literalError.equals("USUARIO NO AUTORIZADO")){
			...
			try {
				...
				sIdPeticion =  getTextNode(element,"IdPeticion");
				...
				String sIdTransmision = getTextNode(element,"IdTransmision");
				...
				sb = new StringBuffer(getTextNode(respuestaPdf,"pdf"));
	 ...
	 * @throws Exception
	 */
	public String getTextNode(Element elemento, String nodeName) throws Exception {
