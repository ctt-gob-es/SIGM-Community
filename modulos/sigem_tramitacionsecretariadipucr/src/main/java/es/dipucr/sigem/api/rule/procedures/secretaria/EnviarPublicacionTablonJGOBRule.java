...
public class EnviarPublicacionTablonJGOBRule extends EnviarPublicacionTablonGenericaRule {
	
	private static final Logger logger = Logger.getLogger(EnviarPublicacionTablonJGOBRule.class);
	...
	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		...
		try {
			...
			logger.error("Error al mandar al tablon el número de expediente. "+rulectx.getNumExp()+" - "+e.getMessage(), e);
		}
