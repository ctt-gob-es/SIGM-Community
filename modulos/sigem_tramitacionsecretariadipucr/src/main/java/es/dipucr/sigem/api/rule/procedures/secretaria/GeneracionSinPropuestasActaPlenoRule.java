	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException{
    	...
    	try
		{
	        ...
	        try{
		        ...
		        //Generar el borrador
		        GeneratePlenoRule actaPleno = new GeneratePlenoRule();
		        actaPleno.execute(rulectx);
		        
		       // Borra los documentos intermedios del gestor documental
				collection = entitiesAPI.getDocuments(rulectx.getNumExp(), "NOMBRE='Propuesta' OR NOMBRE='Propuesta Urgencia'","");
