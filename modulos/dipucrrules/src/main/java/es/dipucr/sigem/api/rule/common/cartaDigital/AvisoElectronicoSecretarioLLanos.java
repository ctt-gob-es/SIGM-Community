...
public class AvisoElectronicoSecretarioLLanos extends AvisoElectronico {

	private static final Logger LOGGER = Logger.getLogger(AvisoElectronicoSecretarioLLanos.class);
