...
public class DipucrGeneraPropuestaPlanComarcasDeprimdasRule extends DipucrAutoGeneraDocIniTramiteRule{

	private static final Logger logger = Logger.getLogger(DipucrGeneraPropuestaPlanComarcasDeprimdasRule.class);	

	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		logger.info("INICIO - DipucrGeneraPropuestaPlanComarcasDeprimdasRule");
		
		tipoDocumento = "Contenido de la propuesta";
		plantilla = "Propuesta Subvenciones Comarcas Deprimidas";
		
		logger.info("FIN - DipucrGeneraPropuestaPlanComarcasDeprimdasRule");
		return true;
	}
...
//				File file = new File(fileName);
    		...
    		IItemCollection itemCol = entitiesAPI.getDocuments(numexp, "NOMBRE='Bases Subvención Comarcas Deprimidas'", "FDOC DESC");
    		...
    		itemCol = entitiesAPI.getDocuments(numexp, "NOMBRE='Datos Subvención Comarcas Deprimidas'", "FDOC DESC");
    		...
    		itemCol = entitiesAPI.getDocuments(numexp, "NOMBRE='Anexos Subvencion Comarcas Deprimidas'", "FDOC DESC");
    		iteratorDoc = itemCol.iterator();
    		if(iteratorDoc.hasNext()){
