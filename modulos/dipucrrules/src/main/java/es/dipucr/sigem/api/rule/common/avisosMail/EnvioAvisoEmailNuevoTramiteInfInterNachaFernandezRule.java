...
public class EnvioAvisoEmailNuevoTramiteInfInterNachaFernandezRule extends DipucrEnviaDocEmailConAcuse{
	 ...
	 */
	protected static final Logger logger = Logger.getLogger(EnvioAvisoEmailNuevoTramiteInfInterNachaFernandezRule.class);
	...
	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		...
		try{
			...
			VAR_EMAILS = "Nacha_Fernandez_Blanco@dipucr.es";
			nombreNotif = "Nacha Fernández Blanco";
