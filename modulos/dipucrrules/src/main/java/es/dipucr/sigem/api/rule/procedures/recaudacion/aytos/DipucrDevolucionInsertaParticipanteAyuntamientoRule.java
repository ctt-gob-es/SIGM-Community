...
public class DipucrDevolucionInsertaParticipanteAyuntamientoRule extends DipucrInsertarParticipantesTrasladoRule {
	private static final Logger logger = Logger.getLogger(DipucrDevolucionInsertaParticipanteAyuntamientoRule.class);
