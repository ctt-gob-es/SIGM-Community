...
public class GenerateLiquidacionRecibosRule extends GenerateLiquidacionRecibos implements IRule 
{
	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException {
		...
		return generarLiquidacion(rulectx, BopFacturasUtil._TIPO_CON_CREDITO);
	}
