...
public class DipucrGeneraPropuestaConvSubEELLRule extends DipucrAutoGeneraDocIniTramiteRule{

	private static final Logger logger = Logger.getLogger(DipucrGeneraPropuestaConvSubEELLRule.class);	

	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		logger.info("INICIO - DipucrGeneraPropuestaConvSubEELLRule");
		
		tipoDocumento = "Contenido de la propuesta";
		plantilla = "Contenido de la propuesta subvenciones";
		
		logger.info("FIN - DipucrGeneraPropuestaConvSubEELLRule");
		return true;
	}
	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException {
		try
    	{
    		...
    		IItemCollection itemCol = entitiesAPI.getDocuments(numexp, "NOMBRE='Anuncio de Convocatoria - Bases'", "FDOC DESC");
    		...
    		itemCol = entitiesAPI.getDocuments(numexp, "NOMBRE='Anuncio de Convocatoria - Datos'", "FDOC DESC");
    		...
    		itemCol = entitiesAPI.getDocuments(numexp, "NOMBRE='Anuncio de Convocatoria - Anexos'", "FDOC DESC");
    		iteratorDoc = itemCol.iterator();
    		if(iteratorDoc.hasNext()){
