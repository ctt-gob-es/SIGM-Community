...
public class DipucrGeneratePropuestaConvocatoriaRule implements IRule {

	private static final Logger logger = Logger.getLogger(DipucrGeneratePropuestaConvocatoriaRule.class);
