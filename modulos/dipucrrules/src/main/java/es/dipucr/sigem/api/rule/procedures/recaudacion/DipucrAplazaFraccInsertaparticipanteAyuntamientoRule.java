...
public class DipucrAplazaFraccInsertaparticipanteAyuntamientoRule extends DipucrInsertarParticipantesTrasladoRule {
	
	private static final Logger logger = Logger.getLogger(DipucrAplazaFraccInsertaparticipanteAyuntamientoRule.class);
	...
	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		...
		try {
	    	...
	    	IItemCollection datos_aplazamiento = entitiesAPI.queryEntities("REC_APLAZ_FRACC", strQuery);
	    	
	    	if(datos_aplazamiento.iterator().hasNext()){
	    		idTraslado = ((IItem)datos_aplazamiento.iterator().next()).getString("MUNICIPIO");
	    	}
	    	else idTraslado = "";
