...
public class PeticionSincronaAction extends BaseAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		String [] clienteLig = clienteLigero.getCertAutByCodCert(procSelec);
		...
		String[] service = scsp.getCoreServByCodCertificadoDescriVersion(procSelec);
		
		//Devuelve el contenido que tiene el fichero de la tabla 'certificados_autorizaciones' columna 'xml_template'
		String strDatosEspecificos = clienteLigero.getXmlDatosEspecificos(procSelec);
