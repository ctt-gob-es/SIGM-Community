...
public class DipucrGeneraDocPropuestaPlanesProvRule implements IRule {

	private static final Logger logger = Logger.getLogger(DipucrGeneraDocPropuestaPlanesProvRule.class);
	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException {
		...
		try{
			logger.info("INICIO - DipucrGeneraDocPropuestaPlanesProvRule");
        		...
        		if (documentTypeId != 0){
		        	...
		        	if(tpDocsTemplatesCollection==null || tpDocsTemplatesCollection.toList().isEmpty()){
		        		...
		        		while (docs.hasNext() && !encontrado){
		        			...
		        			if(((String)tpDocsTemplate.get("NOMBRE")).trim().toUpperCase().equals("Propuesta Planes Provinciales".trim().toUpperCase())){
			...
			cct.endTX(true);
			logger.info("FIN - DipucrGeneraProvidenciaPlanesProvRule");
		} catch(Exception e) {
