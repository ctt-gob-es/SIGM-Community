...
public class DipucrCambiaRespDevIngrIndInicioExp implements IRule {
	private static final Logger logger = Logger
			.getLogger(DipucrCambiaRespDevIngrIndInicioExp.class);

	private String opcion;

	// Mamen Alcaide
	private String id_mamen = "3-132";
	// Alberto Sánchez
	private String id_alberto = "3-151";
	// Paco Golderos
	private String id_pacog = "3-152";
