...
public class EnvioAvisoEmailNuevoTramiteInfContEduardoRule extends DipucrEnviaDocEmailConAcuse{
	...
	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		...
		try{
			...
			contenido = "Tiene un nuevo Trámite de Informe de Contratación (Procedimiento de Contratación) en SIGEM a visualizar con el número de expediente " + numexp;
			asunto = "[AL-SIGM] Tiene un nuevo Trámite de Informe de Contratación (Procedimiento de Contratación) en SIGEM a visualizar con el número de expediente " + numexp;
