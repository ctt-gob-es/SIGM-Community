...
public class DipucrInsertarParticipantesTrasladoFromDatosEspecificosRule implements IRule{
	
	private static final Logger logger = Logger.getLogger(DipucrInsertarParticipantesTrasladoFromDatosEspecificosRule.class);
