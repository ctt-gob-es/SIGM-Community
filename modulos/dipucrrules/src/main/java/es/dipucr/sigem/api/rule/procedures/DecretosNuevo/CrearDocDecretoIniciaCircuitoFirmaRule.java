...
public class CrearDocDecretoIniciaCircuitoFirmaRule implements IRule {
	
	private static final Logger logger = Logger.getLogger(CrearDocDecretoIniciaCircuitoFirmaRule.class);
