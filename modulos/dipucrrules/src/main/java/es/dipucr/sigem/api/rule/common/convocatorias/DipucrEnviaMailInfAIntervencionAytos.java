...
public class DipucrEnviaMailInfAIntervencionAytos extends DipucrEnviaDocEmailConAcuse {

	private static final Logger logger = Logger.getLogger(DipucrEnviaMailInfAIntervencionAytos.class);
	...
	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		...
		asunto= "[AL-SIGM] Traslado de Informe de anticipo de la subvención con número de expediente: "+rulectx.getNumExp();
		conDocumento = true;
