...
public class DipucrAvisoNuevoExpedienteConInteresado implements IRule {
	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException {
		...
		try {
			...
			String ayuntamiento = itemExpediente.getString("IDENTIDADTITULAR");
			...
			String message = "<a href=\"/SIGEM_TramitacionWeb/showTask.do?taskId=" + rulectx.getTaskId() +
				...
				"</a>.<br/>Asunto: " + asunto;
			if(ayuntamiento != null && !ayuntamiento.equals("")){
				message += " - " + ayuntamiento;
			}
