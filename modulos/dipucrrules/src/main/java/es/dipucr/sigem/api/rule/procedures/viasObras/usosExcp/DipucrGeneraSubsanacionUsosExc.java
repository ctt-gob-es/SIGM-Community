...
public class DipucrGeneraSubsanacionUsosExc extends DipucrAutoGeneraDocIniTramiteRule {

	private static final Logger logger = Logger.getLogger(DipucrGeneraSubsanacionUsosExc .class);

	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		logger.info("INICIO - " +this.getClass().getName());

		tipoDocumento = "Comunicación de subsanación";
		plantilla = "Requerimiento de Subsanación Autorización Usos Excepcionales";
