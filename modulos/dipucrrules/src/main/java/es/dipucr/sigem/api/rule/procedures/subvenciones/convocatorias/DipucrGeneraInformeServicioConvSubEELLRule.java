...
public class DipucrGeneraInformeServicioConvSubEELLRule extends DipucrAutoGeneraDocIniTramiteRule{

	private static final Logger logger = Logger.getLogger(DipucrGeneraInformeServicioConvSubEELLRule.class);	

	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		logger.info("INICIO - " + this.getClass().getName());
		
		tipoDocumento = "Informe del servicio";
		plantilla = "Informe del servicio Convocatoria a Subvenciones EELL ";
	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException {
		...
		try
    	{
    		...
    		IItemCollection itemCol = entitiesAPI.getDocuments(numexp, "NOMBRE='Convocatoria - Bases'", "FDOC DESC");
    		...
    		itemCol = entitiesAPI.getDocuments(numexp, "NOMBRE='Convocatoria - Datos'", "FDOC DESC");
    		...
    		itemCol = entitiesAPI.getDocuments(numexp, "NOMBRE='Convocatoria - Anexos'", "FDOC DESC");
    		iteratorDoc = itemCol.iterator();
    		if(iteratorDoc.hasNext()){
	...
	public void setSsVariables(IClientContext cct, IRuleContext rulectx) {
		try {
			cct.setSsVariable("ANIO", ""+(new Date().getYear()+1900));
