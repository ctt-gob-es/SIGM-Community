...
public class EnvioAvisoEmailNuevoTramiteInfInterRule extends DipucrEnviaDocEmailConAcuse{
	...
	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		...
		try{
			...
			contenido = "Tiene un nuevo Trámite de Intervención en SIGEM a visualizar con el número de expediente " + numexp;
			asunto = "[AL-SIGM] Tiene un nuevo Trámite de Intervención en SIGEM a visualizar con el número de expediente " + numexp;
