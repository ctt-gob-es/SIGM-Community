...
public class PrevioLiquidacionAlbaranesRule extends GenerateLiquidacionRecibos implements IRule 
{
	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException {
		...
		return previoLiquidacion(rulectx, BopFacturasUtil._TIPO_ALBARAN);
	}
