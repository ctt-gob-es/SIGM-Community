...
public class DipucrAvisoFaseDelegadaRule implements IRule {
	
	public static String _FASEDELEGADA_MESSAGE = "Fase Delegada";
	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException {
		...
		try {
			...
			String message = _FASEDELEGADA_MESSAGE + ": Se le ha delegado una fase del expediente " + numexp +" ("+nombreProcedimiento+").<br/>Asunto: " + asunto;
