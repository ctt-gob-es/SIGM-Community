...
public class DipucrGeneraPropuestaConvSubPlanEmpleoRule extends DipucrAutoGeneraDocIniTramiteRule{

	private static final Logger logger = Logger.getLogger(DipucrGeneraPropuestaConvSubPlanEmpleoRule.class);	

	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		logger.info("INICIO - DipucrGeneraPropuestaConvSubPlanEmpleoRule");
		
		tipoDocumento = "Contenido de la propuesta";
		plantilla = "Propuesta Subvenciones Plan de Empleo";
		
		logger.info("FIN - DipucrGeneraPropuestaConvSubPlanEmpleoRule");
		return true;
	}
