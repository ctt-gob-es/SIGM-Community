...
public class GenerateLiquidacionAlbaranesRule extends GenerateLiquidacionRecibos implements IRule 
{
	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException {
		...
		return generarLiquidacion(rulectx, BopFacturasUtil._TIPO_ALBARAN);
	}
