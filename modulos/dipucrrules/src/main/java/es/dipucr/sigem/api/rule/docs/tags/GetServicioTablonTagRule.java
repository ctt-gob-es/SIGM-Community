...
/**
 * [eCenpri-Felipe #504]
 * Devuelve el origen/servicio del tablón para el documento
 */
public class GetServicioTablonTagRule implements IRule 
{
	/** Logger de la clase. */
	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException 
	{
        try
        {
	        ...
	        if (collection.next()){
	        	...
	        	String categoria = itemPublicacion.getString("SERVICIO");
	        	sbCategoria.append(categoria);
	        	String categoriaOtros = itemPublicacion.getString("SERVICIO_OTROS");
