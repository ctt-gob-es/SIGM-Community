...
public class DipucrNoEliminarTramiteSiDocFirmadoRule implements IRule{
	
	private static final Logger logger = Logger.getLogger(DipucrNoEliminarTramiteSiDocFirmadoRule.class);
