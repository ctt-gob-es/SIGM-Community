package es.dipucr.ispacweb.tag;

import ieci.tdw.ispac.api.errors.ISPACException;
import ieci.tdw.ispac.ispaclib.bean.ItemBean;
import ieci.tdw.ispac.ispaclib.utils.StringUtils;
import ieci.tdw.ispac.ispacweb.tag.ParameterMultivalueTag;
import ieci.tdw.ispac.ispacweb.tag.ParameterTag;
...
public class UpdateFieldsOnChangeTag extends TagSupport {
	  ...
	  /**
	   * [eCenpri-Felipe #504] 
	   * Nombre de las propiedades que tienen onchange
	   */
	  protected final String propiedadCodigo = "COD";
  ...
  private String getTextSetElementValue(String element, String ids, String values) {
      ...
      //[eCenpri-Felipe #504]
      textValue.append("  element.onchange();\n");
	              ...
	              if (listById != null && listById.contains(sId)){
	            	  ...
	            	  javascript.append("element = parent.document.getElementById('" + sId + "');\n")
		                	...
		                	.append("  element.value = '" + sValue + "';\n")
	              			.append((sId.contains(propiedadCodigo)? "  element.onchange();\n":"")) //[eCenpri-Felipe #504]
		                	.append("}\n");
	              }else{
