...
public class CopyLiquidacionesCompRule implements IRule {
	
	private static final Logger logger = Logger.getLogger(CopyLiquidacionesCompRule.class);
	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException 
	{
        try
        {
            ...
            String strEntidadSolicitud = "REC_COMPENSACION";
        		...
        		if (!it2.hasNext())
        		{
        			for (int i=1 ; i<=20 ; i++)
        			{
	        			...
	        			if (strLiq != null && strLiq.length()>0)
	        			{
		    		        ...
		    		        String strPag = solicitud.getString(key_pag);
		    		        if (strPag != null)
		    		        {
		    		        	item.set("PAGADA", strPag);
		    		        }
