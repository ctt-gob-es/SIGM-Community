...
public class SolicitudTransmisionDatosGenericos  implements java.io.Serializable {
    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Emisor emisor;

    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitante solicitante;

    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Titular titular;

    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Transmision transmision;

    public SolicitudTransmisionDatosGenericos() {
    }

    public SolicitudTransmisionDatosGenericos(
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Emisor emisor,
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitante solicitante,
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Titular titular,
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Transmision transmision) {
           this.emisor = emisor;
     ...
     * @return emisor
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Emisor getEmisor() {
        return emisor;
    }
     ...
     * @param emisor
     */
    public void setEmisor(datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Emisor emisor) {
        this.emisor = emisor;
    }
     ...
     * @return solicitante
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitante getSolicitante() {
        return solicitante;
    }
     ...
     * @param solicitante
     */
    public void setSolicitante(datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitante solicitante) {
        this.solicitante = solicitante;
    }
     ...
     * @return titular
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Titular getTitular() {
        return titular;
    }
     ...
     * @param titular
     */
    public void setTitular(datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Titular titular) {
        this.titular = titular;
    }
     ...
     * @return transmision
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Transmision getTransmision() {
        return transmision;
    }
     ...
     * @param transmision
     */
    public void setTransmision(datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Transmision transmision) {
        this.transmision = transmision;
    }
