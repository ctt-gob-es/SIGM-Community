...
public class DatosGenericos  implements java.io.Serializable {
    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Emisor emisor;

    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Solicitante solicitante;

    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Titular titular;

    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmision transmision;

    public DatosGenericos() {
    }

    public DatosGenericos(
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Emisor emisor,
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Solicitante solicitante,
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Titular titular,
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmision transmision) {
           this.emisor = emisor;
     ...
     * @return emisor
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Emisor getEmisor() {
        return emisor;
    }
     ...
     * @param emisor
     */
    public void setEmisor(datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Emisor emisor) {
        this.emisor = emisor;
    }
     ...
     * @return solicitante
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Solicitante getSolicitante() {
        return solicitante;
    }
     ...
     * @param solicitante
     */
    public void setSolicitante(datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Solicitante solicitante) {
        this.solicitante = solicitante;
    }
     ...
     * @return titular
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Titular getTitular() {
        return titular;
    }
     ...
     * @param titular
     */
    public void setTitular(datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Titular titular) {
        this.titular = titular;
    }
     ...
     * @return transmision
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmision getTransmision() {
        return transmision;
    }
     ...
     * @param transmision
     */
    public void setTransmision(datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmision transmision) {
        this.transmision = transmision;
    }
