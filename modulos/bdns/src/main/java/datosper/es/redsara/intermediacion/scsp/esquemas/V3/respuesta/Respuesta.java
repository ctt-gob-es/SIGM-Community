...
public class Respuesta  implements java.io.Serializable {
    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Atributos atributos;

    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos[] transmisiones;

    public Respuesta() {
    }

    public Respuesta(
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Atributos atributos,
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos[] transmisiones) {
     ...
     * @return atributos
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Atributos getAtributos() {
        return atributos;
    }
     ...
     * @param atributos
     */
    public void setAtributos(datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Atributos atributos) {
        this.atributos = atributos;
    }
     ...
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos[] getTransmisiones() {
        return transmisiones;
    }
     ...
     * @param transmisiones
     */
    public void setTransmisiones(datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos[] transmisiones) {
        this.transmisiones = transmisiones;
    }
