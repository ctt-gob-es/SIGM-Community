...
public class Solicitudes  implements java.io.Serializable {
    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision[] solicitudTransmision;
    ...
    public Solicitudes(
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision[] solicitudTransmision,
           java.lang.String id) {
     ...
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision[] getSolicitudTransmision() {
        return solicitudTransmision;
    }
     ...
     */
    public void setSolicitudTransmision(datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision[] solicitudTransmision) {
        this.solicitudTransmision = solicitudTransmision;
    }

    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision getSolicitudTransmision(int i) {
        return this.solicitudTransmision[i];
    }

    public void setSolicitudTransmision(int i, datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision _value) {
