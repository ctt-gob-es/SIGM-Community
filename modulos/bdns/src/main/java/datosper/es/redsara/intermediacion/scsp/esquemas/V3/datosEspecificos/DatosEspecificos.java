...
public class DatosEspecificos  implements java.io.Serializable {
    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosPeticion datosEspecificosPeticion;

    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosRespuesta datosEspecificosRespuesta;

    public DatosEspecificos() {
    }

    public DatosEspecificos(
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosPeticion datosEspecificosPeticion,
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosRespuesta datosEspecificosRespuesta) {
     ...
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosPeticion getDatosEspecificosPeticion() {
        return datosEspecificosPeticion;
    }
     ...
     */
    public void setDatosEspecificosPeticion(datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosPeticion datosEspecificosPeticion) {
        this.datosEspecificosPeticion = datosEspecificosPeticion;
    }
     ...
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosRespuesta getDatosEspecificosRespuesta() {
        return datosEspecificosRespuesta;
    }
     ...
     */
    public void setDatosEspecificosRespuesta(datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosRespuesta datosEspecificosRespuesta) {
        this.datosEspecificosRespuesta = datosEspecificosRespuesta;
    }
