...
public class Peticion  implements java.io.Serializable {
    ...
    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitudes solicitudes;
    ...
    public Peticion(
           ...
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitudes solicitudes) {
     ...
     * @return solicitudes
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitudes getSolicitudes() {
        return solicitudes;
    }
     ...
     * @param solicitudes
     */
    public void setSolicitudes(datosper.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitudes solicitudes) {
        this.solicitudes = solicitudes;
    }
