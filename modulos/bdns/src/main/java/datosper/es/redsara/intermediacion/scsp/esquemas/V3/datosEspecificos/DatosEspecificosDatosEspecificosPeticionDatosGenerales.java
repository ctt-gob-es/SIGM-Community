...
public class DatosEspecificosDatosEspecificosPeticionDatosGenerales  implements java.io.Serializable {
    ...
    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.TipoMovimiento tipoMovimiento;
    ...
    public DatosEspecificosDatosEspecificosPeticionDatosGenerales(
           ...
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.TipoMovimiento tipoMovimiento) {
     ...
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.TipoMovimiento getTipoMovimiento() {
        return tipoMovimiento;
    }
     ...
     */
    public void setTipoMovimiento(datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.TipoMovimiento tipoMovimiento) {
        this.tipoMovimiento = tipoMovimiento;
    }
