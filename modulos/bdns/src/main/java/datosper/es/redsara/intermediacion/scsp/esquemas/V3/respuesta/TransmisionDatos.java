...
public class TransmisionDatos  implements java.io.Serializable {
    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.DatosGenericos datosGenericos;

    private datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificos datosEspecificos;

    public TransmisionDatos() {
    }

    public TransmisionDatos(
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.DatosGenericos datosGenericos,
           datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificos datosEspecificos) {
     ...
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.DatosGenericos getDatosGenericos() {
        return datosGenericos;
    }
     ...
     */
    public void setDatosGenericos(datosper.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.DatosGenericos datosGenericos) {
        this.datosGenericos = datosGenericos;
    }
     ...
     */
    public datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificos getDatosEspecificos() {
        return datosEspecificos;
    }
     ...
     */
    public void setDatosEspecificos(datosper.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificos datosEspecificos) {
        this.datosEspecificos = datosEspecificos;
    }
