...
public class SolicitudTransmisionDatosGenericos  implements java.io.Serializable {
    ...
    private concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Titular titular;
    ...
    public SolicitudTransmisionDatosGenericos(
           ...
           concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Titular titular,
     ...
     * @return titular
     */
    public concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Titular getTitular() {
        return titular;
    }
     ...
     * @param titular
     */
    public void setTitular(concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Titular titular) {
        this.titular = titular;
    }
