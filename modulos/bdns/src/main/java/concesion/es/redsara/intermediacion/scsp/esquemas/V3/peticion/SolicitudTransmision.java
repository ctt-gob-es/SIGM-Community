...
public class SolicitudTransmision  implements java.io.Serializable {
    private concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmisionDatosGenericos datosGenericos;
    ...
    public SolicitudTransmision(
           concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmisionDatosGenericos datosGenericos,
     ...
     */
    public concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmisionDatosGenericos getDatosGenericos() {
        return datosGenericos;
    }
     ...
     */
    public void setDatosGenericos(concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmisionDatosGenericos datosGenericos) {
        this.datosGenericos = datosGenericos;
    }
