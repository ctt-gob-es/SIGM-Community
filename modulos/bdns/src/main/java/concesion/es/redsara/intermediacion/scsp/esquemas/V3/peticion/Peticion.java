...
public class Peticion  implements java.io.Serializable {
    private concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Atributos atributos;

    private concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitudes solicitudes;

    public Peticion() {
    }

    public Peticion(
           concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Atributos atributos,
           concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitudes solicitudes) {
     ...
     * @return atributos
     */
    public concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Atributos getAtributos() {
        return atributos;
    }
     ...
     * @param atributos
     */
    public void setAtributos(concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Atributos atributos) {
        this.atributos = atributos;
    }
     ...
     * @return solicitudes
     */
    public concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitudes getSolicitudes() {
        return solicitudes;
    }
     ...
     * @param solicitudes
     */
    public void setSolicitudes(concesion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitudes solicitudes) {
        this.solicitudes = solicitudes;
    }
