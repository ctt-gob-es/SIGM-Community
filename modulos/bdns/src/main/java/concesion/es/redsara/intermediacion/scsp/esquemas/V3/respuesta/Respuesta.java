...
public class Respuesta  implements java.io.Serializable {
    private concesion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Atributos atributos;

    private concesion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmisiones transmisiones;

    public Respuesta() {
    }

    public Respuesta(
           concesion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Atributos atributos,
           concesion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmisiones transmisiones) {
     ...
     * @return atributos
     */
    public concesion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Atributos getAtributos() {
        return atributos;
    }
     ...
     * @param atributos
     */
    public void setAtributos(concesion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Atributos atributos) {
        this.atributos = atributos;
    }
     ...
     */
    public concesion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmisiones getTransmisiones() {
        return transmisiones;
    }
     ...
     * @param transmisiones
     */
    public void setTransmisiones(concesion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmisiones transmisiones) {
        this.transmisiones = transmisiones;
    }
