...
public class IdConcesion  implements java.io.Serializable {
    ...
    private concesion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.IdConcesionIdBeneficiario idBeneficiario;
    ...
    public IdConcesion(
           ...
           concesion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.IdConcesionIdBeneficiario idBeneficiario,
     ...
     */
    public concesion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.IdConcesionIdBeneficiario getIdBeneficiario() {
        return idBeneficiario;
    }
     ...
     */
    public void setIdBeneficiario(concesion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.IdConcesionIdBeneficiario idBeneficiario) {
        this.idBeneficiario = idBeneficiario;
    }
