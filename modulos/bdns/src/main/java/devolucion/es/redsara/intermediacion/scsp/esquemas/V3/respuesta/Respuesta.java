...
public class Respuesta  implements java.io.Serializable {
    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Atributos atributos;

    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmisiones transmisiones;

    public Respuesta() {
    }

    public Respuesta(
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Atributos atributos,
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmisiones transmisiones) {
     ...
     * @return atributos
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Atributos getAtributos() {
        return atributos;
    }
     ...
     * @param atributos
     */
    public void setAtributos(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Atributos atributos) {
        this.atributos = atributos;
    }
     ...
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmisiones getTransmisiones() {
        return transmisiones;
    }
     ...
     * @param transmisiones
     */
    public void setTransmisiones(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmisiones transmisiones) {
        this.transmisiones = transmisiones;
    }
