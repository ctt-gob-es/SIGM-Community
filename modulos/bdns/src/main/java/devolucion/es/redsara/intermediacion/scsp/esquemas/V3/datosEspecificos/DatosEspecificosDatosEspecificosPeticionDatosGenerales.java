...
public class DatosEspecificosDatosEspecificosPeticionDatosGenerales  implements java.io.Serializable {
    ...
    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.TipoMovimiento tipoMovimiento;
    ...
    public DatosEspecificosDatosEspecificosPeticionDatosGenerales(
           ...
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.TipoMovimiento tipoMovimiento) {
     ...
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.TipoMovimiento getTipoMovimiento() {
        return tipoMovimiento;
    }
     ...
     */
    public void setTipoMovimiento(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.TipoMovimiento tipoMovimiento) {
        this.tipoMovimiento = tipoMovimiento;
    }
