...
public class Transmisiones  implements java.io.Serializable {
    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos[] transmisionDatos;
    ...
    public Transmisiones(
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos[] transmisionDatos,
           java.lang.String id) {
     ...
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos[] getTransmisionDatos() {
        return transmisionDatos;
    }
     ...
     */
    public void setTransmisionDatos(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos[] transmisionDatos) {
        this.transmisionDatos = transmisionDatos;
    }

    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos getTransmisionDatos(int i) {
        return this.transmisionDatos[i];
    }

    public void setTransmisionDatos(int i, devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos _value) {
