...
public class TransmisionDatos  implements java.io.Serializable {
    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.DatosGenericos datosGenericos;
    ...
    public TransmisionDatos(
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.DatosGenericos datosGenericos,
     ...
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.DatosGenericos getDatosGenericos() {
        return datosGenericos;
    }
     ...
     */
    public void setDatosGenericos(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.DatosGenericos datosGenericos) {
        this.datosGenericos = datosGenericos;
    }
