...
public class DatosEspecificosDatosEspecificosPeticion  implements java.io.Serializable {
    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosPeticionDatosGenerales datosGenerales;

    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosPeticionEnvio envio;

    public DatosEspecificosDatosEspecificosPeticion() {
    }

    public DatosEspecificosDatosEspecificosPeticion(
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosPeticionDatosGenerales datosGenerales,
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosPeticionEnvio envio) {
     ...
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosPeticionDatosGenerales getDatosGenerales() {
        return datosGenerales;
    }
     ...
     */
    public void setDatosGenerales(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosPeticionDatosGenerales datosGenerales) {
        this.datosGenerales = datosGenerales;
    }
     ...
     * @return envio
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosPeticionEnvio getEnvio() {
        return envio;
    }
     ...
     * @param envio
     */
    public void setEnvio(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificosDatosEspecificosPeticionEnvio envio) {
        this.envio = envio;
    }
