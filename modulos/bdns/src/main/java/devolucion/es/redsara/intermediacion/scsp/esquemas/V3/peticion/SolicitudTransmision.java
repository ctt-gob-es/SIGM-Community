...
public class SolicitudTransmision  implements java.io.Serializable {
    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmisionDatosGenericos datosGenericos;

    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificos datosEspecificos;

    public SolicitudTransmision() {
    }

    public SolicitudTransmision(
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmisionDatosGenericos datosGenericos,
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificos datosEspecificos) {
     ...
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmisionDatosGenericos getDatosGenericos() {
        return datosGenericos;
    }
     ...
     */
    public void setDatosGenericos(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmisionDatosGenericos datosGenericos) {
        this.datosGenericos = datosGenericos;
    }
     ...
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificos getDatosEspecificos() {
        return datosEspecificos;
    }
     ...
     */
    public void setDatosEspecificos(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.DatosEspecificos datosEspecificos) {
        this.datosEspecificos = datosEspecificos;
    }
