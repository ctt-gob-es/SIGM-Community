...
public class SolicitudTransmisionDatosGenericos  implements java.io.Serializable {
    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Emisor emisor;

    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitante solicitante;

    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Titular titular;

    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Transmision transmision;

    public SolicitudTransmisionDatosGenericos() {
    }

    public SolicitudTransmisionDatosGenericos(
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Emisor emisor,
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitante solicitante,
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Titular titular,
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Transmision transmision) {
           this.emisor = emisor;
     ...
     * @return emisor
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Emisor getEmisor() {
        return emisor;
    }
     ...
     * @param emisor
     */
    public void setEmisor(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Emisor emisor) {
        this.emisor = emisor;
    }
     ...
     * @return solicitante
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitante getSolicitante() {
        return solicitante;
    }
     ...
     * @param solicitante
     */
    public void setSolicitante(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitante solicitante) {
        this.solicitante = solicitante;
    }
     ...
     * @return titular
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Titular getTitular() {
        return titular;
    }
     ...
     * @param titular
     */
    public void setTitular(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Titular titular) {
        this.titular = titular;
    }
     ...
     * @return transmision
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Transmision getTransmision() {
        return transmision;
    }
     ...
     * @param transmision
     */
    public void setTransmision(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Transmision transmision) {
        this.transmision = transmision;
    }
