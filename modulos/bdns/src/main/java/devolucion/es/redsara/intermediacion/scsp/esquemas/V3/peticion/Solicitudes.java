...
public class Solicitudes  implements java.io.Serializable {
    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision[] solicitudTransmision;
    ...
    public Solicitudes(
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision[] solicitudTransmision,
           java.lang.String id) {
     ...
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision[] getSolicitudTransmision() {
        return solicitudTransmision;
    }
     ...
     */
    public void setSolicitudTransmision(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision[] solicitudTransmision) {
        this.solicitudTransmision = solicitudTransmision;
    }

    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision getSolicitudTransmision(int i) {
        return this.solicitudTransmision[i];
    }

    public void setSolicitudTransmision(int i, devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision _value) {
