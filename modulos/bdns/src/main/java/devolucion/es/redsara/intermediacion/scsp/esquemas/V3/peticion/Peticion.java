...
public class Peticion  implements java.io.Serializable {
    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Atributos atributos;

    private devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitudes solicitudes;

    public Peticion() {
    }

    public Peticion(
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Atributos atributos,
           devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitudes solicitudes) {
     ...
     * @return atributos
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Atributos getAtributos() {
        return atributos;
    }
     ...
     * @param atributos
     */
    public void setAtributos(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Atributos atributos) {
        this.atributos = atributos;
    }
     ...
     * @return solicitudes
     */
    public devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitudes getSolicitudes() {
        return solicitudes;
    }
     ...
     * @param solicitudes
     */
    public void setSolicitudes(devolucion.es.redsara.intermediacion.scsp.esquemas.V3.peticion.Solicitudes solicitudes) {
        this.solicitudes = solicitudes;
    }
