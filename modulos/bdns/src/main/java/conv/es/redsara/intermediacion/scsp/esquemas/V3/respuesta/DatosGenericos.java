...
public class DatosGenericos  implements java.io.Serializable {
    private conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Emisor emisor;

    private conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Solicitante solicitante;

    private conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Titular titular;

    private conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmision transmision;

    public DatosGenericos() {
    }

    public DatosGenericos(
           conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Emisor emisor,
           conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Solicitante solicitante,
           conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Titular titular,
           conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmision transmision) {
           this.emisor = emisor;
     ...
     * @return emisor
     */
    public conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Emisor getEmisor() {
        return emisor;
    }
     ...
     * @param emisor
     */
    public void setEmisor(conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Emisor emisor) {
        this.emisor = emisor;
    }
     ...
     * @return solicitante
     */
    public conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Solicitante getSolicitante() {
        return solicitante;
    }
     ...
     * @param solicitante
     */
    public void setSolicitante(conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Solicitante solicitante) {
        this.solicitante = solicitante;
    }
     ...
     * @return titular
     */
    public conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Titular getTitular() {
        return titular;
    }
     ...
     * @param titular
     */
    public void setTitular(conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Titular titular) {
        this.titular = titular;
    }
     ...
     * @return transmision
     */
    public conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmision getTransmision() {
        return transmision;
    }
     ...
     * @param transmision
     */
    public void setTransmision(conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.Transmision transmision) {
        this.transmision = transmision;
    }
