...
public class TransmisionDatos  implements java.io.Serializable {
    private conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.DatosGenericos datosGenericos;
    ...
    public TransmisionDatos(
           conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.DatosGenericos datosGenericos,
     ...
     */
    public conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.DatosGenericos getDatosGenericos() {
        return datosGenericos;
    }
     ...
     */
    public void setDatosGenericos(conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.DatosGenericos datosGenericos) {
        this.datosGenericos = datosGenericos;
    }
