...
public class Transmisiones  implements java.io.Serializable {
    private conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos[] transmisionDatos;
    ...
    public Transmisiones(
           conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos[] transmisionDatos,
           java.lang.String id) {
     ...
     */
    public conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos[] getTransmisionDatos() {
        return transmisionDatos;
    }
     ...
     */
    public void setTransmisionDatos(conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos[] transmisionDatos) {
        this.transmisionDatos = transmisionDatos;
    }

    public conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos getTransmisionDatos(int i) {
        return this.transmisionDatos[i];
    }

    public void setTransmisionDatos(int i, conv.es.redsara.intermediacion.scsp.esquemas.V3.respuesta.TransmisionDatos _value) {
