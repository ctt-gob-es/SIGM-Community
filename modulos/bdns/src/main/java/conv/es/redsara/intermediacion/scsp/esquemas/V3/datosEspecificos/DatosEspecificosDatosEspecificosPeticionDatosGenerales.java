...
public class DatosEspecificosDatosEspecificosPeticionDatosGenerales  implements java.io.Serializable {
    ...
    private conv.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.TipoMovimiento tipoMovimiento;
    ...
    public DatosEspecificosDatosEspecificosPeticionDatosGenerales(
           ...
           conv.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.TipoMovimiento tipoMovimiento) {
     ...
     */
    public conv.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.TipoMovimiento getTipoMovimiento() {
        return tipoMovimiento;
    }
     ...
     */
    public void setTipoMovimiento(conv.es.redsara.intermediacion.scsp.esquemas.V3.datosEspecificos.TipoMovimiento tipoMovimiento) {
        this.tipoMovimiento = tipoMovimiento;
    }
