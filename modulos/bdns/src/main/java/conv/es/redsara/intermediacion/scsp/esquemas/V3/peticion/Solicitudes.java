...
public class Solicitudes  implements java.io.Serializable {
    private conv.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision[] solicitudTransmision;
    ...
    public Solicitudes(
           conv.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision[] solicitudTransmision,
           java.lang.String id) {
     ...
     */
    public conv.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision[] getSolicitudTransmision() {
        return solicitudTransmision;
    }
     ...
     */
    public void setSolicitudTransmision(conv.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision[] solicitudTransmision) {
        this.solicitudTransmision = solicitudTransmision;
    }

    public conv.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision getSolicitudTransmision(int i) {
        return this.solicitudTransmision[i];
    }

    public void setSolicitudTransmision(int i, conv.es.redsara.intermediacion.scsp.esquemas.V3.peticion.SolicitudTransmision _value) {
