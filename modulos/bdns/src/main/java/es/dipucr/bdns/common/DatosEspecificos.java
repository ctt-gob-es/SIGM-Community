...
public class DatosEspecificos  implements java.io.Serializable {
    private es.dipucr.bdns.common.DatosEspecificosDatosEspecificosPeticionAbstracta datosEspecificosPeticion;

    private es.dipucr.bdns.common.DatosEspecificosDatosEspecificosRespuestaAbstracta datosEspecificosRespuesta;

    public DatosEspecificos() {
    }

    public DatosEspecificos(
           es.dipucr.bdns.common.DatosEspecificosDatosEspecificosPeticionAbstracta datosEspecificosPeticion,
           es.dipucr.bdns.common.DatosEspecificosDatosEspecificosRespuestaAbstracta datosEspecificosRespuesta) {
     ...
     */
    public es.dipucr.bdns.common.DatosEspecificosDatosEspecificosPeticionAbstracta getDatosEspecificosPeticion() {
        return datosEspecificosPeticion;
    }
     ...
     */
    public void setDatosEspecificosPeticion(es.dipucr.bdns.common.DatosEspecificosDatosEspecificosPeticionAbstracta datosEspecificosPeticion) {
        this.datosEspecificosPeticion = datosEspecificosPeticion;
    }
     ...
     */
    public es.dipucr.bdns.common.DatosEspecificosDatosEspecificosRespuestaAbstracta getDatosEspecificosRespuesta() {
        return datosEspecificosRespuesta;
    }
     ...
     */
    public void setDatosEspecificosRespuesta(es.dipucr.bdns.common.DatosEspecificosDatosEspecificosRespuestaAbstracta datosEspecificosRespuesta) {
        this.datosEspecificosRespuesta = datosEspecificosRespuesta;
    }
