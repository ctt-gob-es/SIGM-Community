...
<%
			...
			if (setAction == null) {
				...
				setAction = "setSubstitutePortaFirma.do";
			}
...
<script language='JavaScript' type='text/javascript'><!--
			...
			function SelectSubstitute(value, sustituto, cargo, descripcion_cargo) {
		
				document.defaultForm.action = '<%=setSubstitute%>' + "?value=" + value +"&sustituto=" + sustituto+"&cargo=" + cargo+"&descripcion_cargo=" + descripcion_cargo;
					...
					<logic:iterate name="Formatter" id="format"
						...
						<logic:equal name="format" property="fieldType" value="LINK">
							<display:column titleKey='<%=format.getTitleKey()%>'
								...
								<bean:define name="substitute" property="property(CARGO)" id="cargo"/>
								<bean:define name="substitute" property="property(DESCRIPCION_CARGO)" id="descripcion_cargo"/>
								<a class="element"
									href="javascript:SelectSubstitute('<%= value.toString() %>', '<%= sustituto.toString() %>', '<%= cargo.toString() %>', '<%= descripcion_cargo.toString() %>');">
