...
<ispac:tabs>
	<ispac:tab title='<%=aux0%>'>
		<div id="dataBlock_CONTRATACION_PERS_CONTACTO"
			...
			<div id="label_CONTRATACION_PERS_CONTACTO:EMAIL_CM_OA"
				style="position: absolute; top: 500px; left: 10px; width: 110px;"
				class="formsTitleB">
				<bean:write name="defaultForm"
					property="entityApp.label(CONTRATACION_PERS_CONTACTO:EMAIL_CM_OA)" />
				:
			</div>
			<div id="data_CONTRATACION_PERS_CONTACTO:EMAIL_CM_OA"
				style="position: absolute; top: 500px; left: 150px; width: 100%;">
				<ispac:htmlText
					property="property(CONTRATACION_PERS_CONTACTO:EMAIL_CM_OA)"
					readonly="false" propertyReadonly="readonly" styleClass="input"
					styleClassReadonly="inputReadOnly" size="80" maxlength="100">
				</ispac:htmlText>
			</div>
			<div id="label_CONTRATACION_PERS_CONTACTO:CALLE_CM_OA"
				style="position: absolute; top: 525px; left: 10px; width: 110px;"
				class="formsTitleB">
				<bean:write name="defaultForm"
					property="entityApp.label(CONTRATACION_PERS_CONTACTO:CALLE_CM_OA)" />
				:
			</div>
			<div id="data_CONTRATACION_PERS_CONTACTO:CALLE_CM_OA"
				style="position: absolute; top: 525px; left: 150px; width: 100%;">
				<ispac:htmlText
					property="property(CONTRATACION_PERS_CONTACTO:CALLE_CM_OA)"
					readonly="false" propertyReadonly="readonly" styleClass="input"
					styleClassReadonly="inputReadOnly" size="80" maxlength="255">
				</ispac:htmlText>
			</div>
			<div id="label_CONTRATACION_PERS_CONTACTO:NUMERO_CM_OA"
				style="position: absolute; top: 525px; left: 600px; width: 110px;"
				class="formsTitleB">
				<bean:write name="defaultForm"
					property="entityApp.label(CONTRATACION_PERS_CONTACTO:NUMERO_CM_OA)" />
				:
			</div>
			<div id="data_CONTRATACION_PERS_CONTACTO:NUMERO_CM_OA"
				style="position: absolute; top: 525px; left: 660px; width: 100%;">
				<ispac:htmlText
					property="property(CONTRATACION_PERS_CONTACTO:NUMERO_CM_OA)"
					readonly="false" propertyReadonly="readonly" styleClass="input"
					styleClassReadonly="inputReadOnly" size="5" maxlength="255">
				</ispac:htmlText>
			</div>
			<div id="label_CONTRATACION_PERS_CONTACTO:CP_CM_OA"
				style="position: absolute; top: 550px; left: 10px; width: 110px;"
				class="formsTitleB">
				<bean:write name="defaultForm"
					property="entityApp.label(CONTRATACION_PERS_CONTACTO:CP_CM_OA)" />
				:
			</div>
			<div id="data_CONTRATACION_PERS_CONTACTO:CP_CM_OA"
				style="position: absolute; top: 550px; left: 150px; width: 100%;">
				<ispac:htmlText property="property(CONTRATACION_PERS_CONTACTO:CP_CM_OA)"
					readonly="false" propertyReadonly="readonly" styleClass="input"
					styleClassReadonly="inputReadOnly" size="80" maxlength="5">
				</ispac:htmlText>
			</div>
			<div id="label_CONTRATACION_PERS_CONTACTO:LOCALIDAD_CM_OA"
				style="position: absolute; top: 575px; left: 10px; width: 110px;"
				class="formsTitleB">
				<bean:write name="defaultForm"
					property="entityApp.label(CONTRATACION_PERS_CONTACTO:LOCALIDAD_CM_OA)" />
				:
			</div>
			<div id="data_CONTRATACION_PERS_CONTACTO:LOCALIDAD_CM_OA"
				style="position: absolute; top: 575px; left: 150px; width: 100%;">
				<ispac:htmlText
					property="property(CONTRATACION_PERS_CONTACTO:LOCALIDAD_CM_OA)"
					readonly="false" propertyReadonly="readonly" styleClass="input"
					styleClassReadonly="inputReadOnly" size="80" maxlength="255">
				</ispac:htmlText>
			</div>
			<div id="label_CONTRATACION_PERS_CONTACTO:PROVINCIA_CM_OA"
				style="position: absolute; top: 600px; left: 10px; width: 110px;"
				class="formsTitleB">
				<bean:write name="defaultForm"
					property="entityApp.label(CONTRATACION_PERS_CONTACTO:PROVINCIA_CM_OA)" />
				:
			</div>
			<div id="data_CONTRATACION_PERS_CONTACTO:PROVINCIA_CM_OA"
				style="position: absolute; top: 600px; left: 150px; width: 100%;">
				<ispac:htmlText
					property="property(CONTRATACION_PERS_CONTACTO:PROVINCIA_CM_OA)"
					readonly="false" propertyReadonly="readonly" styleClass="input"
					styleClassReadonly="inputReadOnly" size="80" maxlength="255">
				</ispac:htmlText>
			</div>
			
			<div id="label_CONTRATACION_PERS_CONTACTO:LOCALIZACIONGEOGRAFICA_CM_OA"
				style="position: absolute; top: 625px; left: 10px; width: 250px;"
				class="formsTitleB">
				<bean:write name="defaultForm"
					property="entityApp.label(CONTRATACION_PERS_CONTACTO:LOCALIZACIONGEOGRAFICA_CM_OA)" />
				:
			</div>
			<div id="data_CONTRATACION_PERS_CONTACTO:LOCALIZACIONGEOGRAFICA_CM_OA"
				style="position: absolute; top: 625px; left: 150px; width: 100%;">
				<nobr>
					<ispac:htmlTextareaImageFrame property="property(CONTRATACION_PERS_CONTACTO:LOCALIZACIONGEOGRAFICA_CM_OA)" readonly="true" readonlyTag="false" 
					propertyReadonly="readonly" styleClass="input" styleClassReadonly="inputReadOnly" rows="1" cols="80" 
					id="SEARCH_CONTRATACION_PERS_CONTACTO:LOCALIZACIONGEOGRAFICA_CM_OA" target="workframe"
					action="selectListadoCodicePliego.do?atributo=COD_LOCALIZACIONGEOGRAFICA" 
					image="img/search-mg.gif" jsDelete="deleteAdjudicado" titleKeyLink="select.rol" imageDelete="img/borrar.gif" titleKeyImageDelete="title.delete.data.selection" 
					styleClassDeleteLink="tdlink" confirmDeleteKey="msg.delete.data.selection" showDelete="true" showFrame="true" width="640" height="480" 
					tabindex="113">
						<ispac:parameter name="SEARCH_CONTRATACION_PERS_CONTACTO:LOCALIZACIONGEOGRAFICA_CM_OA" id="property(CONTRATACION_PERS_CONTACTO:LOCALIZACIONGEOGRAFICA_CM_OA)" property="SUSTITUTO" />
					</ispac:htmlTextareaImageFrame>
				</nobr>
			</div>
			
			<div id="label_CONTRATACION_PERS_CONTACTO:MOVIL_CM_OA"
				style="position: absolute; top: 650px; left: 10px; width: 110px;"
				class="formsTitleB">
				<bean:write name="defaultForm"
					property="entityApp.label(CONTRATACION_PERS_CONTACTO:MOVIL_CM_OA)" />
				:
			</div>
			<div id="data_CONTRATACION_PERS_CONTACTO:MOVIL_CM_OA"
				style="position: absolute; top: 650px; left: 150px; width: 100%;">
				<ispac:htmlText
					property="property(CONTRATACION_PERS_CONTACTO:MOVIL_CM_OA)"
					readonly="false" propertyReadonly="readonly" styleClass="input"
					styleClassReadonly="inputReadOnly" size="80" maxlength="10">
				</ispac:htmlText>
			</div>
