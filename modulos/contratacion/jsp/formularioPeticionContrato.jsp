	...
	<ispac:tab title='<%=aux0%>'>
		<div id="dataBlock_CONTRATACION_PETICION"
			...
			<div id="data_CONTRATACION_PETICION:SERVICIO_RESPONSABLE"
				...
				<ispac:htmlText property="property(CONTRATACION_PETICION:SERVICIO_RESPONSABLE)"
			...
			<div id="label_CONTRATACION_PETICION:PRESUPUESTO"
				style="position: absolute; top: 105px; left: 10px; width: 110px;"
				class="formsTitleB">
				<bean:write name="defaultForm"
				property="entityApp.label(CONTRATACION_PETICION:PRESUPUESTO)" />(ej: 1568.13):
			</div>
			<div id="data_CONTRATACION_PETICION:PRESUPUESTO"
				style="position: absolute; top: 105px; left: 130px; width: 100%;">
			...
			<div id="label_CONTRATACION_PETICION:IVA"
				style="position: absolute; top: 130px; left: 10px; width: 110px;"
				class="formsTitleB">
				<bean:write name="defaultForm"
				property="entityApp.label(CONTRATACION_PETICION:IVA)" />:
			</div>
			<div id="data_CONTRATACION_PETICION:IVA"
				style="position: absolute; top: 130px; left: 130px; width: 100%;">
				<nobr> 
			...
			<div id="data_CONTRATACION_PETICION:IMPORTEIVA"
				style="position: absolute; top: 130px; left: 420px; width: 100%;">
				<ispac:htmlText property="property(CONTRATACION_PETICION:IMPORTEIVA)"
			...
			<div id="label_CONTRATACION_PETICION:RESP_CONTRATO"
				style="position: absolute; top: 180px; left: 10px; width: 110px;"
				class="formsTitleB">
				<bean:write name="defaultForm"
				property="entityApp.label(CONTRATACION_PETICION:RESP_CONTRATO)" />:
			</div>
			<div id="data_CONTRATACION_PETICION:RESP_CONTRATO"
				style="position: absolute; top: 180px; left: 130px; width: 100%;">
				<ispac:htmlText property="property(CONTRATACION_PETICION:RESP_CONTRATO)"
					readonly="false" propertyReadonly="readonly" styleClass="input"
			...
			<div id="label_CONTRATACION_PETICION:DIRECTOR_OBRA"
				style="position: absolute; top: 205px; left: 10px; width: 110px;"
				class="formsTitleB">
				<bean:write name="defaultForm"
				property="entityApp.label(CONTRATACION_PETICION:DIRECTOR_OBRA)" />:
			</div>
			<div id="data_CONTRATACION_PETICION:DIRECTOR_OBRA"
				style="position: absolute; top: 205px; left: 130px; width: 100%;">
				<ispac:htmlTextarea
