...
public class DipucrEnviaMailActaRecepcion extends DipucrEnviaDocEmailConAcuse {

	private static final Logger logger = Logger.getLogger(DipucrEnviaMailActaRecepcion.class);

	public boolean init(IRuleContext rulectx) throws ISPACRuleException {

		logger.info("INICIO - " + this.getClass().getName());
				
		VAR_EMAILS = "EMAIL_CARTA_ACTARECEPCION"; //Variable de sistema de la que tomamos los emails
