...
public class ReqSubsanDocAdminGenericoRule extends DipucrAutoGeneraDocIniTramiteRule {
	...
	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		...
		tipoDocumento = "Requerimiento de Subsanación de la Documentación Administrativa";
		plantilla = "Diligencia Subsanación Genérica";
