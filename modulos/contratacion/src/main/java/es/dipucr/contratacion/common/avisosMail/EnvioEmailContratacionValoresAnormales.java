...
public class EnvioEmailContratacionValoresAnormales   implements IRule 
{
	...
	public boolean validate(IRuleContext rulectx) throws ISPACRuleException {
	 ...
	 public Object execute(IRuleContext rulectx) throws ISPACRuleException{
		 try{
			...
			String contenido = "Tiene en el expediente del Licitador "+rulectx.getNumExp()+ " valores anormales o desproporcionados";
			String asunto = "Tiene en el expediente del Licitador "+rulectx.getNumExp()+ " valores anormales o desproporcionados";
