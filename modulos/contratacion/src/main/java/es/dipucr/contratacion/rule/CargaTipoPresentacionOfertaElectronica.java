...
public class CargaTipoPresentacionOfertaElectronica implements IRule{
	
	public static final Logger logger = Logger.getLogger(CargaTipoPresentacionOfertaElectronica.class);
	public static String tipoPresentacionOferta = "1 - Electrónica";
