...
public class CargaTipoPresentacionOfertaManualoElectronica implements IRule{
	
	public static final Logger logger = Logger.getLogger(CargaTipoPresentacionOfertaManualoElectronica.class);
	public static String tipoPresentacionOferta = "3 - Manual y/o Electrónica";
