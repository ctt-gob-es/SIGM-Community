...
public class CargaTipoPresentacionOfertaManual implements IRule{
	
	public static final Logger logger = Logger.getLogger(CargaTipoPresentacionOfertaManual.class);
