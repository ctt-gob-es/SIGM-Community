...
public class GenerarSolicitudInformeIncidContratoRule extends CrearDocumentoconAnexosRule{
	...
	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		try{
			...
			super.setCodTramiteGenerar("Sol-Inf-Tecn-Inc");
			
			super.setCodTipoDocGenerar("Sol-Inf-Inc-Cont");
