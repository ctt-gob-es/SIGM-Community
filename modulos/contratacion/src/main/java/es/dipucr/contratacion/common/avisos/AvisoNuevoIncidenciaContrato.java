...
public class AvisoNuevoIncidenciaContrato implements IRule 
{
	private Logger logger = Logger.getLogger(AvisoNuevoIncidenciaContrato.class);
	...
	public static String _ADVERTISE_MESSAGE = "Solicitud de Informe sobre Incidencia del Contrato";
