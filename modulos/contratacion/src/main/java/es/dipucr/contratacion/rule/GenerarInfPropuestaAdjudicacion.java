...
public class GenerarInfPropuestaAdjudicacion extends DipucrAutoGeneraDocIniTramiteRule {
	private static final Logger logger = Logger.getLogger(GenerarInfPropuestaAdjudicacion.class);
