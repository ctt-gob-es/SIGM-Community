...
public class GeneraCalificaDocAdmRule  extends DipucrAutoGeneraDocIniTramiteRule {
	...
	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		...
		tipoDocumento = "Informe/Propuesta sobre Calificación de la Documentación Administrativa";
		plantilla = "Informe - Propuesta sobre Calificación de Documentación Administrativa";
		refTablas = "%TABLA1%";
