...
public class EnvioAvisoEmailRecepcionPlicasSecret   implements IRule 
{
	...
	public boolean validate(IRuleContext rulectx) throws ISPACRuleException {
	 ...
	 public Object execute(IRuleContext rulectx) throws ISPACRuleException{
		 try{
			...
			String contenido = "Aprobado nuevo expediente de contratación "+rulectx.getNumExp()+" inicio recepción de Plicas.";
			String asunto = "Aprobado nuevo expediente de contratación "+rulectx.getNumExp()+" inicio recepción de Plicas.";
