...
public class GeneralErrorDetails  implements java.io.Serializable {
    private es.dipucr.contratacion.resultadoBeans.Mensaje[] message;

    public GeneralErrorDetails() {
    }
    ...
    /**
     * Gets the message value for this GeneralErrorDetails.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this GeneralErrorDetails.
     * 
     * @param message
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GeneralErrorDetails)) return false;
        GeneralErrorDetails other = (GeneralErrorDetails) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GeneralErrorDetails.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://resultadoBeans.contratacion.dipucr.es", "GeneralErrorDetails"));
