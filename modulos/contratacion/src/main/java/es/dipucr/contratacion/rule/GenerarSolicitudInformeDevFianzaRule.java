...
public class GenerarSolicitudInformeDevFianzaRule extends CrearDocumentoconAnexosRule{
	...
	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		try{
			...
			super.setCodTramiteGenerar("Sol-Inf-Dev-Fian");
			
			super.setCodTipoDocGenerar("Sol-Inf-Dev-Fian");
