...
public class EnvioAvisoEmailTerminarTramiteIncidenciaContrato   implements IRule 
{
	...
	public boolean validate(IRuleContext rulectx) throws ISPACRuleException {
	 ...
	 public Object execute(IRuleContext rulectx) throws ISPACRuleException{
		 try{
	        ...
	        String emailNotif = "pmayor@dipucr.es";
			String contenido = "Ha sido añadido una nueva Incidencidencia de contrato del expediente "+rulectx.getNumExp();
			String asunto = "Ha sido añadido una nueva Incidencidencia de contrato del expediente "+rulectx.getNumExp();
