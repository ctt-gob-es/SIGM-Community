...
public class MandarPublicacionPLACSPRule implements IRule{
	
	public static final Logger LOGGER = Logger.getLogger(MandarPublicacionPLACSPRule.class);
	public static String OPERACIONPLACE = null;
	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException {
		try{
			...
			if(OPERACIONPLACE.equals("PUB_ANUNC")){
			...
			peticionALSIGM.setOperacionPlace(OPERACIONPLACE);
