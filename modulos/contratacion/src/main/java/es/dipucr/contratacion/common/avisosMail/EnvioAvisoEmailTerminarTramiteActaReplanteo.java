...
public class EnvioAvisoEmailTerminarTramiteActaReplanteo extends DipucrEnviaDocEmailConAcuse {
	/**
	...
	public boolean init(IRuleContext rulectx) throws ISPACRuleException {
		try{
	        ...
	        conDocumento = false;
	        contenido = "Ha sido añadido un Acta de replanteo del expediente "+rulectx.getNumExp();
			asunto = "Ha sido añadido un Acta de replanteo del expediente "+rulectx.getNumExp();
