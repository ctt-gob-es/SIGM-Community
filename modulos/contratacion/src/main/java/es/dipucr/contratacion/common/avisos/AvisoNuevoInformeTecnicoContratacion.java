...
public class AvisoNuevoInformeTecnicoContratacion implements IRule 
{
	private Logger logger = Logger.getLogger(AvisoNuevoInformeTecnicoContratacion.class);
	...
	public static String _ADVERTISE_MESSAGE = "Solicitud de Informe sobre Documentación Técnica";
