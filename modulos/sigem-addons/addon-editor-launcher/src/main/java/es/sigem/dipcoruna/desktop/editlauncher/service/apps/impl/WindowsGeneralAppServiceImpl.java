...
public class WindowsGeneralAppServiceImpl extends AbstractGeneralAppServiceImpl {
	private static final Logger LOGGER = LoggerFactory.getLogger(WindowsGeneralAppServiceImpl.class);
