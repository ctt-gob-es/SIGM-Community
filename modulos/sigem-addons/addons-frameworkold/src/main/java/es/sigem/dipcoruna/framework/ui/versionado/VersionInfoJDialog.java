...
public class VersionInfoJDialog extends JDialog implements InitializingBean {
	...
	public void setTexts(String versionActual, String nuevaVersion, String urlDescarga){
		this.urlDescarga = urlDescarga;
		labelVersion.setText(messageSource.getMessage("desktop.framework.version.nuevaVersion.info", new Object[] {versionActual, nuevaVersion}));	
		pack();
	}
