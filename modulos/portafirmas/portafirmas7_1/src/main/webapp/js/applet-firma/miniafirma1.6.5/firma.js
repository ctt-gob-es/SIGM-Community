...
function firmaDocumento(indice){
	...
	if(dataB64 == null || dataB64 === "" || dataB64 == "") {
		...
		if ((documento.operation == 'sign') || (documento.format.indexOf("PDF") != -1)) {
			...
			MiniApplet.counterSign(dataB64, documento.hashAlgorithm, documento.signFormatParameter, paramsParam, signCorrect, signError);

		} else if (documento.operation == 'cosign') {

			MiniApplet.coSign(dataB64, null, documento.hashAlgorithm, documento.signFormatParameter, paramsParam, signCorrect, signError);
