...
/**
 * <p>Clase Java para TipoOpcionesVisualizacionIndiceWS complex type.
 * 
...
@XmlType(name = "TipoOpcionesVisualizacionIndiceWS", namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/conversion", propOrder = {
    "estamparImagen",
...
public class TipoOpcionesVisualizacionIndiceWS {
    ...
    public static class FilasNombreOrganismo {
        ...
        @XmlElement(name = "Fila", namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/conversion", required = true)
