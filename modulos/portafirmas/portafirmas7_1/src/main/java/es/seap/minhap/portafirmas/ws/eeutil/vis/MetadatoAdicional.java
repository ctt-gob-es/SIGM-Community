...
@XmlType(name = "MetadatoAdicional", namespace = "https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/metadatosAdicionales", propOrder = {
    "valor"
})
public class MetadatoAdicional {

    @XmlElement(namespace = "https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/metadatosAdicionales", required = true)
