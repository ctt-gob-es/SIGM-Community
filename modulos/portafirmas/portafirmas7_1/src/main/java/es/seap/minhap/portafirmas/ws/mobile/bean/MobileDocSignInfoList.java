...
@XmlType(name = "mobileDocSignInfoList", propOrder = { "mobileDocSignInfo" })
public class MobileDocSignInfoList implements Serializable {
	...
	public void setMobileDocSignInfo(List<MobileDocSignInfo> mobileDocSignInfo) {
		this.mobileDocSignInfo = mobileDocSignInfo;
	}
