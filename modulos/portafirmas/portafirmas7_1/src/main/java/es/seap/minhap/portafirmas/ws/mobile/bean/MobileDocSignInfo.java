...
@XmlType(name = "mobileDocSignInfo", propOrder = { "documentId", "signature", "signFormat" })
public class MobileDocSignInfo implements Serializable {
	...
	public void setSignature(DataHandler signature) {
