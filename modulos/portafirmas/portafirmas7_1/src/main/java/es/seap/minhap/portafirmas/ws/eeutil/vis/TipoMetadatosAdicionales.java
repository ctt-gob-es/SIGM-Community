 ...
 *       &lt;sequence>
 *         &lt;element name="MetadatoAdicional" type="{https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/metadatosAdicionales}MetadatoAdicional" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "TipoMetadatosAdicionales", namespace = "https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/metadatosAdicionales", propOrder = {
    "metadatoAdicional"
})
public class TipoMetadatosAdicionales {

    @XmlElement(name = "MetadatoAdicional", namespace = "https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/metadatosAdicionales", required = true)
