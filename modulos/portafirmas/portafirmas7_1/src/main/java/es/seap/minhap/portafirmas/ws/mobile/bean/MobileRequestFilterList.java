...
@XmlType(name = "mobileRequestFilterList", propOrder = { "requestFilter" })
public class MobileRequestFilterList implements Serializable {
	...
	public void setRequestFilter(List<MobileRequestFilter> requestFilter) {
