...
@XmlType(name = "TipoEstadoElaboracion", namespace = "https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/documento/metadatos", propOrder = {
    "valorEstadoElaboracion",
    "identificadorDocumentoOrigen"
})
public class TipoEstadoElaboracion {

    @XmlElement(name = "ValorEstadoElaboracion", namespace = "https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/documento/metadatos", required = true)
    @XmlSchemaType(name = "string")
    protected EnumeracionEstadoElaboracion valorEstadoElaboracion;
    @XmlElement(name = "IdentificadorDocumentoOrigen", namespace = "https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/documento/metadatos")
