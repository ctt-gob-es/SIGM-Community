 ...
 *       &lt;sequence>
 *         &lt;element name="firma" type="{https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/firma}TipoFirmasElectronicas" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "firmas", namespace = "https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/firma", propOrder = {
    "firma"
})
public class Firmas {

    @XmlElement(namespace = "https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/firma", required = true)
