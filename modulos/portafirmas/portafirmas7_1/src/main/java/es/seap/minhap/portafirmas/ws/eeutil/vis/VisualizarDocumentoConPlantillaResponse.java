...
/**
 * <p>Clase Java para visualizarDocumentoConPlantillaResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="visualizarDocumentoConPlantillaResponse">
 *   &lt;complexContent>
...
@XmlType(name = "visualizarDocumentoConPlantillaResponse", propOrder = {
    "salidaVisualizar"
})
public class VisualizarDocumentoConPlantillaResponse {
