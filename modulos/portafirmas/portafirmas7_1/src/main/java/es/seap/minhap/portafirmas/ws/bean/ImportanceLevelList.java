...
/**
 * Contains a List of {@link ImortanceLevel}
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "importanceLevelList", propOrder = { "importanceLevels" })
public class ImportanceLevelList implements Serializable {
	 ...
	 * 
	 * @return {@link ImportanceLevels} list.
	 */
