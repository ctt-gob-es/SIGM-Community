...
/**
 * @author MINHAP
 * InterfazGenerica web service implementation for SOAP 1.1
 */
@Service("InterfazGenericaSoap11Impl")
@WebService(name = "InterfazGenerica", serviceName = "InterfazGenerica", portName = "InterfazGenericaSoapHttpPort", targetNamespace = "http://ip2.docelweb.wsInterfazGenerica/", wsdlLocation = "WSDL/InterfazGenerica.wsdl", endpointInterface = "es.seap.minhap.portafirmas.ws.docelweb.interfazgenerica.InterfazGenerica")
public class InterfazGenericaSoap11Impl implements InterfazGenerica {

	private Logger LOG = Logger.getLogger(InterfazGenericaSoap11Impl.class);
	...
	/* (non-Javadoc)
	 * @see es.seap.minhap.portafirmas.ws.docelweb.interfazgenerica.InterfazGenerica#registrarSolicitud(RegistrarSolicitudElement  parameters )*
	 */
	 ...
	 */
	public ConsultarSolicitudResponseElement consultarSolicitud(ConsultarSolicitudElement parameters) throws ConsultarSolicitudFault {
