...
import es.seap.minhap.portafirmas.ws.eeutil.utilfirma.EeUtilServiceImplService;

@Service
public class EeUtilUtilClientManager {


	Logger log = Logger.getLogger(EeUtilUtilClientManager.class);
	 ...
	 */
	public EeUtilService getEEUtilUtilFirmaClient (String wsdlLocation) throws EeutilException {
		...
		try {
			...
			log.error("No se puede crear el WS de EEUTIL a partir de la URL:  ", t);
