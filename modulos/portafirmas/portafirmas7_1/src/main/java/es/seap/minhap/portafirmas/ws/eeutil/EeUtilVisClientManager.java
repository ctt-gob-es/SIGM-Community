...
import es.seap.minhap.portafirmas.ws.eeutil.vis.EeUtilServiceImplService;

@Service
public class EeUtilVisClientManager {


	Logger log = Logger.getLogger(EeUtilVisClientManager.class);
	 ...
	 */
	public EeUtilService getEEUtilVisClient (String wsdlLocation) throws EeutilException {
