...
/**
 * <p>Clase Java para guardarDocumentoENI complex type.
 * 
...
@XmlType(name = "guardarDocumentoENI", namespace = "urn:es:gob:aapp:csvstorage:webservices:document:v1.0", propOrder = {
    "guardarDocumentoEniRequest"
})
