...
public class PfRequestsTextDTO extends AbstractBaseDTO {
	...
	public PfRequestsTextDTO() {
		super();
	}

	public PfRequestsTextDTO(String ccreated, Date fcreated, String cmodified,
			Date fmodified, String chash) {
		super();
	...
	public PfRequestsTextDTO(String ccreated, Date fcreated, String cmodified,
			Date fmodified, String chash, String trequest) {
		super();
		this.ccreated = ccreated;
		this.fcreated = fcreated;
		this.cmodified = cmodified;
	...
	@Override
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PF_S_PET")
	@SequenceGenerator(allocationSize = 1, name = "PF_S_PET", sequenceName = "PF_S_PET")
