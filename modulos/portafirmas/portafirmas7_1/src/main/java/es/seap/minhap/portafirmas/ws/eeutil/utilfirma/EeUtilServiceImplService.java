...
@WebServiceClient(name = "EeUtilServiceImplService", 
                  wsdlLocation = "http://localhost:8090/eeutil-util-firma/ws/EeUtilService?wsdl",
...
public class EeUtilServiceImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8090/eeutil-util-firma/ws/EeUtilService?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from http://localhost:8090/eeutil-util-firma/ws/EeUtilService?wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
