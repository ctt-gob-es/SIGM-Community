...
import es.seap.minhap.portafirmas.ws.eeutil.operfirma.EeUtilServiceImplService;

@Service
public class EeUtilOperClientManager {


	Logger log = Logger.getLogger(EeUtilOperClientManager.class);
	 ...
	 */
	public EeUtilService getEEUtilOperFirmaClient (String wsdlLocation) throws EeutilException {
		...
		try {
			if (eeutilClients.containsKey(wsdlLocation)) {
				...
				EeUtilServiceImplService eeutilService = 
						new EeUtilServiceImplService(url);
