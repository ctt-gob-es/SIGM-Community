...
public class RequestPermissionRestrictionImpl implements Restriction {
	...
	public boolean check(ServletRequest request) {
		...
		//Identificador de la etiqueta-peticion
		String hash = req.getParameter("idRequestTag");
		...
		return restrictionUtil.checkRequestTagByHash(hash, usuarioSesion);
