...
/**
 * <p>Java class for postProcesarFirmaResponse complex type.
 * 
...
public class PostProcesarFirmaResponse {
    ...
    /**
     * Gets the value of the firmaProcesada property.
     * 
     * @return
     *     possible object is
     *     byte[]
    ...
    /**
     * Sets the value of the firmaProcesada property.
     * 
     * @param value
     *     allowed object is
     *     byte[]
    ...
    public void setFirmaProcesada(byte[] value) {
        this.firmaProcesada = ((byte[]) value);
    }
