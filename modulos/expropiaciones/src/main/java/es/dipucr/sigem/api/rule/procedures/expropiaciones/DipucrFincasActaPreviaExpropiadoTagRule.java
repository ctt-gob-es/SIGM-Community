...
public class DipucrFincasActaPreviaExpropiadoTagRule implements IRule {
	
	/** Logger de la clase. */
	private static final Logger logger = Logger.getLogger(DipucrFincasActaPreviaExpropiadoTagRule.class);
	
	protected String STR_notificacionEXP = Constants.PLANTILLADOC.NOTIFICACIONES_LEVANTAMIENTO_ACTAS;
