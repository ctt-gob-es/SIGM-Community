...
/**
 * Generar múltiples actas de valoración.
 */
public class GenerarActasPreviasPorPropietarioRule implements IRule {
	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException {
		try {
			//logger.warn("Ejecutando regla GenerarActasPreviasPorPropietarioRule");
			...
			//logger.warn("Fin de ejecución regla GenerarActasPreviasPorPropietarioRule");
		} catch (Exception e) {
