 ...
 */
public class ListaFincasActaPreviaExpropiadoTagRule implements IRule {
	
	/** Logger de la clase. */
	private static final Logger logger = 
		Logger.getLogger(ListaFincasActaPreviaExpropiadoTagRule.class);
	...
	public Object execute(IRuleContext 	rulectx) throws ISPACRuleException {
		try {
			//logger.warn("Ejecutando regla ListaFincasActaPreviaExpropiadoTagRule");
