 ...
 */
public class ListaFincasDecretoConsignaPropietarioTagRule implements IRule {
	
	/** Logger de la clase. */
	private static final Logger logger = 
		Logger.getLogger(ListaFincasDecretoConsignaPropietarioTagRule.class);
	...
	public Object execute(IRuleContext 	rulectx) throws ISPACRuleException {
		try {
			//logger.warn("Ejecutando regla ListaFincasDecretoConsignaPropietarioTagRule");
