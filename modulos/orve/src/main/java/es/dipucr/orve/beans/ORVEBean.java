...
import es.minhap.seap.ssweb.orve.FiltrosIdentificadores;
import es.minhap.seap.ssweb.orve.ObtenerIdentificaoresRespuestaWS;
import es.minhap.seap.ssweb.orve.ObtenerRegistroRespuestaWS;
import es.minhap.seap.ssweb.orve.Security;
import es.minhap.seap.ssweb.orve.WSExportacionPortType;
import es.minhap.seap.ssweb.orve.WSExportacionPortTypeProxy;
import es.minhap.seap.ssweb.orve.holders.SecurityHolder;

public class ORVEBean extends ORVEBeanSuperClass implements ORVEBeanInterface{
    
    public static final Logger LOGGER = Logger.getLogger(ORVEBean.class);

    private WSExportacionPortType wsExportacion = null;
    private SecurityHolder securityHolder = null;
    
    public ORVEBean(Entidad entidad){
        super(entidad);
