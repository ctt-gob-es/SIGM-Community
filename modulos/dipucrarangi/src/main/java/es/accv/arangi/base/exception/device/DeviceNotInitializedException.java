...
/**
 * Se está accediendo a un dispositivo que no ha sido abierto.
 * 
...
public class DeviceNotInitializedException extends DeviceException {
	...
	public DeviceNotInitializedException(String message, Throwable cause) {
		super(message, cause);
	}
	...
	public DeviceNotInitializedException(Throwable cause) {
		super(cause);
	}
