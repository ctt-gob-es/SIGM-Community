...
/**
 * Excepción producida durante el proceso de contrafirma.
 * 
 * @author <a href="mailto:jgutierrez@accv.es">José M Gutiérrez</a>
 */
public class CounterSignatureException extends es.accv.arangi.base.exception.SignatureException {

	private static final long serialVersionUID = 1L;

	public CounterSignatureException() {
		super();
	}
