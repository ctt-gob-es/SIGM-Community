...
public class DipucrSERSODatosSolPlanEmerComedor25 implements IRule{
    private static final Logger LOGGER = Logger.getLogger(DipucrSERSODatosSolPlanEmerComedor25.class);
                    ...
                    while (expSolicitudesIt.hasNext()){
                        ...
                        if(concesionIterator.hasNext()){
                            ...
                            try{
                                ...
                                importe = (Double.parseDouble(concesion.getString(ConstantesPlanEmergencia.DpcrSERSOLibrosComedor.IMPORTETOTALCOMEDOR))) * 0.25;
                            } catch(Exception e){
