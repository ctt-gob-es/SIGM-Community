...
public class DipucrGeneraNotificacionesConvocatoriasSubAsociGrupos extends FuncionesComunesDocumentos implements IRule {

    public static final Logger LOGGER = Logger.getLogger(DipucrGeneraNotificacionesConvocatoriasSubAsociGrupos.class);
    
    public static final String[] ESTADOS_ADM = {ExpedientesUtil.EstadoADM.AP, ExpedientesUtil.EstadoADM.RC, ExpedientesUtil.EstadoADM.RN};
    
    public static final double[] DISTRIBUCION_5_COLUMNAS_AP = {22, 25, 30, 13, 10};
    public static final double[] DISTRIBUCION_5_COLUMNAS_RC = {22, 25, 25, 13, 15};
    public static final double[] DISTRIBUCION_5_COLUMNAS_RN = {22, 25, 25, 13, 15};
    ...
    public Object execute(IRuleContext rulectx) throws ISPACRuleException {
        ...
        try {
            ...
            List<String> expedientesResolucion = ExpedientesRelacionadosUtil.getExpedientesRelacionadosHijosByVariosEstadosAdm(rulectx, Arrays.asList(ESTADOS_ADM));
    ...
    public void insertaTabla(IRuleContext rulectx, XComponent component, String refTabla, IEntitiesAPI entitiesAPI, String numexp) {
        ...
        try {
            ...
            if(null != tabla){
                ...
                LibreOfficeUtil.setTextoCelda(tabla, 2, 2, beneficiario);
