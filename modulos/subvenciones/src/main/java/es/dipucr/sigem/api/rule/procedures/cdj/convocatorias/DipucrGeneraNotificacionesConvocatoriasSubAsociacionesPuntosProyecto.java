...
public class DipucrGeneraNotificacionesConvocatoriasSubAsociacionesPuntosProyecto extends FuncionesComunesDocumentos implements IRule {
    ...
    private static final double [] DISTRIBUCION_7_COLUMNAS = {20, 10, 20, 20, 10, 10, 10};
