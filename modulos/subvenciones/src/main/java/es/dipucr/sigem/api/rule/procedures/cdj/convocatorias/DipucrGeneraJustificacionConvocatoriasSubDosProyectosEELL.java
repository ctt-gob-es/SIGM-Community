...
public class DipucrGeneraJustificacionConvocatoriasSubDosProyectosEELL extends DipucrAutoGeneraDocIniTramiteRule{
    ...
    public static final double[] DISTRIBUCION_6_COLUMNAS = {30, 15, 25, 10, 10, 10};
    public static final double[] DISTRIBUCION_4_COLUMNAS = {30, 15, 30, 25};
        ...
        try{
            ...
            if(LibreOfficeUtil.ReferenciasTablas.TABLA1.equals(refTabla)){
                for(String numexpHijo : expedientesList){
                    IItemCollection resolucionesCollection = entitiesAPI.queryEntities(ConstantesSubvenciones.DatosResolucion.NOMBRE_TABLA, ConstantesString.WHERE + ConstantesSubvenciones.DatosResolucion.NUMEXP + " = '" + numexpHijo + "'");
                    ...
                    if(resolucionesIterator.hasNext()){
                        ...
                        if(StringUtils.isNotEmpty(proyecto1CuentaFilas) && StringUtils.isNotEmpty(justificado1CuentaFilas) && !"NO".equals(justificado1CuentaFilas)){
                            numFilas++;
                        }
                        ...
                        if(StringUtils.isNotEmpty(proyecto2CuentaFilas) && StringUtils.isNotEmpty(justificado2CuentaFilas) && !"NO".equals(justificado2CuentaFilas)){
                            numFilas++;
                        }
                    }
                }
