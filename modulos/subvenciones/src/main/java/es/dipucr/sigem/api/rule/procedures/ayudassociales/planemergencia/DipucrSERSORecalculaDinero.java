...
public class DipucrSERSORecalculaDinero implements IRule{
    private static final Logger LOGGER = Logger.getLogger(DipucrSERSORecalculaDinero.class);
        ...
        try{
            ...
            if (solicitudIterator.hasNext()){
                ...
                if (ConstantesPlanEmergencia.ALIMENTACION.equals(tipoAyuda)){
                    ...
                    if(ExpedientesUtil.EstadoADM.RC.equals(estadoAdm) && cantidadesIt.hasNext()){                        
            ...
            LOGGER.error(ConstantesString.LOGGER_ERROR + " al recalcular las cantidades del plan de emergencia social del expediente: " + numexp + ". " + e.getMessage(), e);
            throw new ISPACRuleException(ConstantesString.LOGGER_ERROR + " al recalcular las cantidades del plan de emergencia social del expediente: " + numexp + ". " + e.getMessage(), e);
        }
    }
