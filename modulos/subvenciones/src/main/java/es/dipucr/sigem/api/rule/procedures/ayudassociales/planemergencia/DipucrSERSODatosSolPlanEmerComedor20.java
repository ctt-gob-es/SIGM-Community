...
public class DipucrSERSODatosSolPlanEmerComedor20 implements IRule{
    private static final Logger LOGGER = Logger.getLogger(DipucrSERSODatosSolPlanEmerComedor20.class);
    ...
    public Object execute(IRuleContext rulectx) throws ISPACRuleException{
        try{
            ...
            //LOGGER.warn("list--" +expRelCol.toList().size());
            ...
            if(expRelIt.hasNext()){
                while (expRelIt.hasNext()){
                    ...
                    if(expHijo != null && (!"CR".equals(expHijo.get("ESTADOADM")) && !"RC".equals(expHijo.get("ESTADOADM")))){
            ...
            if(!expedientesResolucion.isEmpty()){
                ...
                //LOGGER.warn("strQuery2 " +strQuery2);
                ...
                while(ciudadOrdenIt.hasNext()){
                    ...
                    //LOGGER.warn("consulta. " +strQuery+" AND TIPOAYUDA = 'COMEDOR' AND CIUDAD = '" +((IItem)ciudadOrdenIt.next()).getString("VALOR")+"' ORDER BY TIPOAYUDA, NOMBRESOLICITANTE, NOMBRE");
                    ...
                    while (expSolicitudesIt.hasNext()){
                        ...
                        if(!ciudad.equals(expSolicitud.get(ConstantesPlanEmergencia.DpcrSERSOPlanEmer.CIUDAD))){
                            ...
                            //LOGGER.warn("REC_VLDTBL_MUNICIPIOS " + "WHERE VALOR='" +expSolicitud.getString(ConstantesPlanEmergencia.DPCR_SERSO_PLAN_EMER.CIUDAD)+"'");
                        ...
                        if(concesionIterator.hasNext()){
                            ...
                            try{
                                ...
                                importe = (Double.parseDouble(concesion.getString(ConstantesPlanEmergencia.DpcrSERSOLibrosComedor.IMPORTETOTALCOMEDOR))) * 0.23;
                            } catch(Exception e){
