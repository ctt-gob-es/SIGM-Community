...
public class DipucrGeneraInformeCierreConvSubEELLDevolActCult extends DipucrAutoGeneraDocIniTramiteRule{
    ...
    public static final double[] DISTRIBUCION_7_COLUMNAS = {20, 15, 10, 10, 15, 15, 15};
    ...
    public void insertaTabla(IRuleContext rulectx, XComponent component, String refTabla, IEntitiesAPI entitiesAPI, String numexp) {    
        ...
        try{
            ...
            if(null != tabla){
                ...
                if(7 == numeroColumnas){
                    LibreOfficeUtil.setTextoCeldaCabecera(tabla, 3, ConstantesString.CabeceraTabla.IMPORTE);
                    LibreOfficeUtil.setTextoCeldaCabecera(tabla, 4, ConstantesString.CabeceraTabla.CANT_JUSTIF);
                    LibreOfficeUtil.setTextoCeldaCabecera(tabla, 5, ConstantesString.CabeceraTabla.FECHA_JUSTIF);
                    LibreOfficeUtil.setTextoCeldaCabecera(tabla, 6, ConstantesString.CabeceraTabla.FECHA_PAGO);
                    LibreOfficeUtil.setTextoCeldaCabecera(tabla, 7, ConstantesString.CabeceraTabla.MINOR_O_RENUNCIA);
                ...
                for (String numexpHijo : expedientesList){
                    ...
                    if(expResolucion.hasNext()){
                        ...
                        importe = SubvencionesUtils.getDouble(resolucion, ConstantesSubvenciones.DatosResolucion.IMPORTEPROYECTO1);
                    ...
                    if(7 == numeroColumnas){
                        LibreOfficeUtil.setTextoCelda(tabla, 3, i, SubvencionesUtils.formateaDouble(ConstantesString.FORMATO_IMPORTE, importe));
                        LibreOfficeUtil.setTextoCelda(tabla, 4, i, "");
                        LibreOfficeUtil.setTextoCelda(tabla, 5, i, "");
                        LibreOfficeUtil.setTextoCelda(tabla, 6, i, "");
                        LibreOfficeUtil.setTextoCelda(tabla, 7, i, SubvencionesUtils.formateaDouble(ConstantesString.FORMATO_IMPORTE, devolucion));
                    } else if(4 == numeroColumnas){
