...
public class DipucrGeneraJustificacionConvocatoriasSubEELLDevol extends DipucrAutoGeneraDocIniTramiteRule{
    ...
    public void setSsVariables(IClientContext cct, IRuleContext rulectx) {
        try {
            ...
            String consulta = "WHERE NUMEXP = '" +numexpConvocatoria+"' " +
        ...
        try{
            ...
            if(!listaExp.isEmpty()){
                ...
                if (xSearchInterface != null) {
                    ...
                    setHeaderCellText(xTable, "E1", "DEVOLUCIÓN / MINORIZACIÓN");
                    ...
                    for(int i=0; i<listaExp.size(); i++){
                        ...
                        if(expResolucion.hasNext()){
                            ...
                            setCellText(xTable, "C" + (i+2), proyecto);
                            setCellText(xTable, "D" + (i+2), "" + new DecimalFormat("#,##0.00").format(importe));
                            String devolStr = new DecimalFormat("#,##0.00").format(devolucion);
                            if(null != devolStr && !"0,00".equals(devolStr.trim())){
                                setCellText(xTable, "E" + (i+2), devolStr);
                            } else{
                                setCellText(xTable, "E" + (i+2), "");
                            }
                    }//fin For listaExp
    ...
    private void colocaColumnas1(XTextTable xTextTable){
        ...
        try {
            ...
            double dRelativeWidth = ( double ) 17000 * dRatio;
