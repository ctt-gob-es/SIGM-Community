...
public class DipucrGeneraPRENotificacionesConvocatoriasSub3AsociGrupos extends FuncionesComunesDocumentos implements IRule {

    public static final Logger LOGGER = Logger.getLogger(DipucrGeneraPRENotificacionesConvocatoriasSub3AsociGrupos.class);
    
    protected String refTablas = LibreOfficeUtil.ReferenciasTablas.TABLA1 + "," + LibreOfficeUtil.ReferenciasTablas.TABLA2 + "," + LibreOfficeUtil.ReferenciasTablas.TABLA3;
            ...
            if(templateId > 0){
                ...
                if (!expedientesResolucion.isEmpty()) {
                    for (String expedienteResolucion : expedientesResolucion) {
                        generaNotificacion(expedienteResolucion, rulectx, cct, entitiesAPI, genDocAPI);
                    }
                }
            }
        } catch (ISPACException e) {
    ...
    private void generaNotificacion(String numexp, IRuleContext rulectx, ClientContext cct, IEntitiesAPI entitiesAPI, IGenDocAPI genDocAPI) {
        try {
            String cifAsociacion1 = "";
            String cifAsociacion2 = "";
            String cifAsociacion3 = "";
            ...
            if (participantesIterator.hasNext()) {
                ...
                if(resolucionIterator.hasNext()){
                    ...
                    renuncia3 = SubvencionesUtils.getString(resolucion, ConstantesSubvenciones.DatosResolucion.RENUNCIA3);
                    cifAsociacion3 = SubvencionesUtils.getString(resolucion, ConstantesSubvenciones.DatosResolucion.CIFGRUPOASOCIACION3);
                }
                ...
                String textoResol3 = SubvencionesUtils.getTextoResol(cifAsociacion3, renuncia1, estadoAdm);
                ...
                cct.setSsVariable(ConstantesSubvenciones.VariablesSesion.TEXTO_RESOLUCION3, textoResol3);
                ...
                cct.deleteSsVariable(ConstantesSubvenciones.VariablesSesion.TEXTO_RESOLUCION3);
    ...
    public void insertaTabla(IRuleContext rulectx, XComponent component, String refTabla, IEntitiesAPI entitiesAPI, String numexp) {
        ...
        try {
            Object[] formatoTabla = SubvencionesUtils.getFormatoTabla(rulectx.getClientContext(), numexp, refTabla, renuncia1, renuncia2, renuncia3); 
