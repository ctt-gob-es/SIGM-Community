...
public class DipucrGeneraJustificacionConvocatoriasSubEELLSinMinor extends SuperClaseUnaTabla {
    ...
    public void insertaTabla(IRuleContext rulectx, XComponent component, String refTabla, IEntitiesAPI entitiesAPI, String numexp) {
        ...
        try {
            ...
            if(null != tabla){
                ...
                double[] distribucionColumnas = {22, 25, 30, 13, 10};
                ...
                LibreOfficeUtil.setTextoCeldaCabecera(tabla, 5, ConstantesString.CabeceraTabla.RECHAZO);
