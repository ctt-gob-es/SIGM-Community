...
public class DipucrGeneraJustificacionConvocatoriasSubEELLSinMinor extends DipucrAutoGeneraDocIniTramiteRule {

    public static final Logger LOGGER = Logger.getLogger(DipucrGeneraJustificacionConvocatoriasSubEELLSinMinor.class);
    ...
    public void setSsVariables(IClientContext cct, IRuleContext rulectx) {
        try {
            ...
            IItemCollection expRelacionadosPadreCollection = cct
                    .getAPI()
                    .getEntitiesAPI()
                    .queryEntities(Constants.TABLASBBDD.SPAC_EXP_RELACIONADOS,
                            "WHERE NUMEXP_PADRE='" + numexpConvocatoria + "' " + QueryUtils.EXPRELACIONADOS.ORDER_DESC);
            ...
            IItemCollection expRelacionadosPadreCollectionBop = cct
                    .getAPI()
                    .getEntitiesAPI()
                    .queryEntities(Constants.TABLASBBDD.SPAC_EXP_RELACIONADOS,
                            "WHERE NUMEXP_PADRE='" + numexpConvocatoria + "' " + QueryUtils.EXPRELACIONADOS.ORDER_ASC);
    ...
    public void insertaTabla(IRuleContext rulectx, XComponent component, String refTabla, IEntitiesAPI entitiesAPI, String numexp) {
        ...
        try {
            ...
            IItemCollection expedientesCollection = entitiesAPI.queryEntities(Constants.TABLASBBDD.SPAC_EXPEDIENTES,
                    "WHERE NUMEXP IN (SELECT NUMEXP_HIJO FROM SPAC_EXP_RELACIONADOS WHERE NUMEXP_PADRE = '" + numexp
                            + "') AND ESTADOADM IN ('JF','RC') ORDER BY IDENTIDADTITULAR");
            ...
            if (xSearchInterface != null) {
                ...
                setHeaderCellText(xTable, "E1", "RECHAZO");
                int i = 0;
