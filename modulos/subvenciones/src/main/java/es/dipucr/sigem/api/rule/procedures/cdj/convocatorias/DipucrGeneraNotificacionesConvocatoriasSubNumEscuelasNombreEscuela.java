...
public class DipucrGeneraNotificacionesConvocatoriasSubNumEscuelasNombreEscuela extends FuncionesComunesDocumentos implements IRule {

    public static final Logger LOGGER = Logger.getLogger(DipucrGeneraNotificacionesConvocatoriasSubNumEscuelasNombreEscuela.class);
    
    public static final String [] ESTADOSADM = {ExpedientesUtil.EstadoADM.AP, ExpedientesUtil.EstadoADM.RC};
    
    public static final double[] DISTRIBUCION_5_COLUMNAS_AP = {35, 15, 15, 20, 15};
    ...
    public void insertaTabla(IRuleContext rulectx, XComponent component, String refTabla, IEntitiesAPI entitiesAPI, String numexp) {
        ...
        try{
            ...
            if(ExpedientesUtil.EstadoADM.AP.equals(estadoAdm)){
                ...
                numeroColumnas = 5;
                tituloCol4 = ConstantesString.CabeceraTabla.NOMBRE_ESCUELAS;
                tituloCol5 = ConstantesString.CabeceraTabla.IMPORTE;
            ...
            if(null != tabla){
                ...
                if(ExpedientesUtil.EstadoADM.AP.equals(estadoAdm)){
                    ...
                    LibreOfficeUtil.setTextoCelda(tabla, 4, 2, nombreEscuelas);
