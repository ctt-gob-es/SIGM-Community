...
public class DipucrGeneraJustificacionConvocatoriasSubUnProyectoEELL extends DipucrAutoGeneraDocIniTramiteRule{

    public static final Logger LOGGER = Logger.getLogger(DipucrGeneraJustificacionConvocatoriasSubUnProyectoEELL.class);
    ...
    public void setSsVariables(IClientContext cct, IRuleContext rulectx) {
        ...
        try {
            ...
            if(fechaDecreto != null){
                ...
                cct.setSsVariable(ConstantesSubvenciones.VariablesSesion.FECHA_DECRETO, "");
            }
            ...
            if( fechaBoletin != null){
                ...
                cct.setSsVariable(ConstantesSubvenciones.VariablesSesion.FECHA_BOLETIN, "");
            }
            ...
            if(null != tabla){
                ...
                for (String numexpHijo : expedientesList){
                    ...
                    if(expResolucion.hasNext()){
                        ...
                        proyecto = SubvencionesUtils.getString(resolucion, ConstantesSubvenciones.DatosResolucion.PROYECTO1);
                        puntos = SubvencionesUtils.getFormattedDouble(resolucion, ConstantesSubvenciones.DatosResolucion.PUNTOSPROYECTO1, ConstantesString.FORMATO_PUNTOS);
                        importe = SubvencionesUtils.getFormattedDouble(resolucion, ConstantesSubvenciones.DatosResolucion.IMPORTEPROYECTO1);
                    ...
                    if (LibreOfficeUtil.ReferenciasTablas.TABLA1.equals(refTabla)){
                        ...
                        LibreOfficeUtil.setTextoCelda(tabla, 6,  i, devolucion);
                    } else {
