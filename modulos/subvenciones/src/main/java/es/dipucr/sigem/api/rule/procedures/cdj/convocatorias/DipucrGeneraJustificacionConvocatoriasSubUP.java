...
public class DipucrGeneraJustificacionConvocatoriasSubUP extends DipucrAutoGeneraDocIniTramiteRule{
        ...
        try{
            ...
            if(!listaExp.isEmpty()){
                ...
                if (xSearchInterface != null){
                    ...
                    setHeaderCellText(xTable, "A1", "UNIVERSIDAD POPULAR");    
                    setHeaderCellText(xTable, "B1", "C.I.F");                
                    setHeaderCellText(xTable, "C1", "RUTA/GUÍA");                
                    ...
                    for(int i=0; i<listaExp.size(); i++){
                        ...
                        if(expResolucion.hasNext()){
                            ...
                            setCellText(xTable, "E" + (i+2), devol);    
                    }//fin For listaExp
