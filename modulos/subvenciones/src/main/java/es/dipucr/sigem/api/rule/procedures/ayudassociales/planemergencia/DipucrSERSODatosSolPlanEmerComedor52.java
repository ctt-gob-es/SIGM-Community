...
public class DipucrSERSODatosSolPlanEmerComedor52 implements IRule{
    private static final Logger LOGGER = Logger.getLogger(DipucrSERSODatosSolPlanEmerComedor52.class);
                    ...
                    while (expSolicitudesIt.hasNext()){
                        ...
                        if(concesionIterator.hasNext()){
                            ...
                            try{
                                ...
                                importe = (Double.parseDouble(concesion.getString(ConstantesPlanEmergencia.DpcrSERSOLibrosComedor.IMPORTETOTALCOMEDOR))) * 0.52;
                            } catch(Exception e){
