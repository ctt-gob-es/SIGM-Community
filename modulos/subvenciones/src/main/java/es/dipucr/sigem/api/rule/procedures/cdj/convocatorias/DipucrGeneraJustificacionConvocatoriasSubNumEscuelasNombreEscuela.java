...
public class DipucrGeneraJustificacionConvocatoriasSubNumEscuelasNombreEscuela extends SuperClaseUnaTabla{

    public static final Logger LOGGER = Logger.getLogger(DipucrGeneraJustificacionConvocatoriasSubNumEscuelasNombreEscuela.class);
    
    public static final double[] DISTRIBUCION_5_COLUMNAS = {35, 15, 15, 20, 15};
    ...
    public void insertaTabla(IRuleContext rulectx, XComponent component, String refTabla, IEntitiesAPI entitiesAPI, String numexp) {
        ...
        try{
            ...
            if(null != tabla){
                LibreOfficeUtil.colocaColumnas(tabla, DISTRIBUCION_5_COLUMNAS);
                ...
                for (String numexpHijo : expedientesList){
                    ...
                    if(expResolucion.hasNext()){
                        ...
                        nombreEscuelas = SubvencionesUtils.getString(resolucion, ConstantesSubvenciones.DatosResolucion.NOMBREGRUPOASOCIACION);
