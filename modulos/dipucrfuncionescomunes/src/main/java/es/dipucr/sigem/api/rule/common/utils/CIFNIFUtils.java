...
public class CIFNIFUtils {
	...
	/**
	 * Devuelve true si se trata de un NIF o NIE (persona física)
	 * @param documento
	 * @return
	 */
	...
	/**
	 * [dipucr-Felipe #1293] Método copiado de SIGEM
	 * 
	 * Identifica el tipo de documento de identificación del solicitante y lo
	 * válida.
	 * 
	 * Un CIF debe tener 9 cifras. La primera cifra (una letra), indica el tipo
	 * de sociedad al que hace referencia:
	 * 
	 * A - Sociedades Anónimas B - Sociedades de responsabilidad limitada C -
	 ...
	 * Organismos autónomos S - Organos de la administración K, L, M -
	 ...
	 * bien una letra, en función del tipo de sociedad. A las categorías K, P,
	 * Q, S y X, Y, Z (Extranjeros) les corresponde una letra en lugar de un
	 * número. A las categorías A, B, E, H les corresponde siempre un número.
	 * 
	 * http://es.wikipedia.org/wiki/C%C3%B3digo_de_identificaci%C3%B3n_fiscal
	 * 
	 * El dígito de control se calcula con las 7 cifras restantes del CIF
