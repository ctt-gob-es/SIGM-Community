...
public class PrepararBopRule implements IRule {
    ...
    private static final String STR_DOCUMENTO = "BOP - Anuncio";
    ...
    public Object execute(IRuleContext rulectx) throws ISPACRuleException {
        ...
        try{
            ...
            if (!StringUtils.isEmpty(sPrepararBop) && "NO".equals(sPrepararBop)){
                return null;
            }
...
//            IClientContext cct =  rulectx.getClientContext();
            ...
            IItemCollection collAllProps = entitiesAPI.getEntities("BOP_ANUNCIOS", rulectx.getNumExp());
    ...
    //            item.store(cct);
                ...
                while (itClasificacion.hasNext()){
                    ...
                    while (it.hasNext()) {
                        ...
                        strQuery2 = "WHERE NUMEXP='" + doc.getString("NUMEXP") + "' AND NOMBRE='" + STR_DOCUMENTO + "'";
