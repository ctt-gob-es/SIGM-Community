 ...
 * 
 * @author teresa
 * Inicia solicitud BOP segunda del Procedimiento Aprobación y Modificación del Plan de Ordenación
 *
 */

public class InitSolicitudBopSegundaPlaneamientoRule extends InitSolicitudBopPlaneamientoRule {
	...
	public boolean init(IRuleContext rulectx) throws ISPACRuleException
	{
		...
		STR_BOP_sumario = "Publicación segunda de expediente de Aprobación y Modificación del Plan de Ordenación Municipal";
