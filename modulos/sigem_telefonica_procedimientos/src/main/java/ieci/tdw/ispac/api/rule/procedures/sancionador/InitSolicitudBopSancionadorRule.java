...
public class InitSolicitudBopSancionadorRule implements IRule {
    
    private static final Logger LOGGER = Logger.getLogger(InitSolicitudBopSancionadorRule.class);
