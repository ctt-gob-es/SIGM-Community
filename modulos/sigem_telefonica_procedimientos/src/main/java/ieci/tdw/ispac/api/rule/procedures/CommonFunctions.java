...
public class CommonFunctions 
{
	...
	public static File getFile(IRuleContext rulectx, String strInfoPag) throws ISPACException
	{
		...
		try
		{
			...
			//[eCenpri-Manu] Ticket #182 Modificamos la extensión para que recupere la propia del documento, y no asigne .doc a todos los documentos.
...
//			xText.insertString(xViewCursor, "J", false);
	...
	/**
	 * Predicado que indica si se ha ejecutado previamente un cierto trámite
	 *
	 * @param rulectx El contexto de la regla.
	 * @param tramite Nombre del trámite.
	 * @return Devuelve 'true' si ya existía con anterioridad otro trámite con el nombre 'tramite'
	 * @throws ISPACException Debido a errores en la API de SIGEM.
	 */	
