 ...
 * 
 * @author teresa
 * Inicia tarea de Resolución de Archivo del Procedimiento Sancionador
 *
 */

public class InitTaskResolucionArchivoSancionadorRule extends InitTaskResolucionSancionadorRule {
    ...
    public boolean init(IRuleContext rulectx) throws ISPACRuleException {
        ...
        strQueryDocumentos = "NOMBRE = 'Providencia de Alcaldía' OR " +  
                                ...
                                "NOMBRE = 'Propuesta de Resolución'"; 
