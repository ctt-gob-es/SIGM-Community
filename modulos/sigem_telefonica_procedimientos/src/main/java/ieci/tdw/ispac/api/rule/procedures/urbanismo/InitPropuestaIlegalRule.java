...
public class InitPropuestaIlegalRule implements IRule {
    
    private static final Logger LOGGER = Logger.getLogger(InitPropuestaIlegalRule.class);

    protected String strEntidad = "";
    protected String strExtracto = "";
    protected String strEstado = "";
    protected String strQueryDocumento = "";
    ...
    public Object execute(IRuleContext rulectx) throws ISPACRuleException {
        try {
            ...
            entidad.set(strEstado, "Propuesta");
            entidad.store(cct);
            ...
            IItemCollection documentsCollection = entitiesAPI.getDocuments(numexpEnt, strQueryDocumento, "FDOC DESC");
            ...
            IItemCollection collExpsAux = entitiesAPI.getEntities("SPAC_FASES", numexpProp);
