...
public class InitSolicitudBopPlaneamientoRule implements IRule {

    private static final Logger LOGGER = Logger.getLogger(InitSolicitudBopPlaneamientoRule.class);
    ...
    public Object execute(IRuleContext rulectx) throws ISPACRuleException {
        try {
            ...
            IItemCollection documentsCollection = entitiesAPI.getDocuments(numexpEnt, "NOMBRE='Publicación'", "FDOC DESC");
            ...
            IItemCollection collExpsAux = entitiesAPI.getEntities(SpacEntities.SPAC_FASES, numexpSolicitud);
