 ...
 * @author teresa
 * @date 20/03/2009
 * @propósito Modificar el campo Estado Administrativo con el valor "FASE DE RESOLUCION"
 */
public class SetAdmStatusFRSubNomELRule implements IRule {
