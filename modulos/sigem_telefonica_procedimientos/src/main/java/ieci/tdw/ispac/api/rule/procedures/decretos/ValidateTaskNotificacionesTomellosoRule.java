...
public class ValidateTaskNotificacionesTomellosoRule implements IRule{
        ...
        try{
            ...
            if (itemCollection!=null && itemCollection.toList().size()>4){
                ...
                while (iteratorCollection.hasNext()){
                    ...
                    } else if ("Informe Jefe del Departamentos/Responsable".equalsIgnoreCase(task.getString("NOMBRE"))){
                        numInforme++;
                ...
                if (isCerrados(creacionCerrado, preparacionCerrado) && isUnTramiteTipo(numCreacion, numInforme, numPreparacion, numNotificaciones)){
                    return true;    
                } else {
    ...
    private boolean isUnTramiteTipo(int numCreacion, int numInforme, int numPreparacion, int numNotificaciones) {
           return numCreacion == 1 && numInforme == 1 && numPreparacion == 1 && numNotificaciones == 1;
    }
