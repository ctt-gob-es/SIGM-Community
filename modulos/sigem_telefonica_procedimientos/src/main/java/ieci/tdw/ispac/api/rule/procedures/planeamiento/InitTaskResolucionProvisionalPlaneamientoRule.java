 ...
 * 
 * @author teresa
 * Inicia tarea aprobación provisional Procedimiento Aprobación y Modificación del Plan de Ordenación Municipal
 *
 */

public class InitTaskResolucionProvisionalPlaneamientoRule extends InitTaskResolucionPlaneamientoRule {
