							...
							for (int i=0;i<participantes.toList().size();i++){
								try {
									...
									if (participante!=null){
										...
										String infoPag = plantillaNotificacionesDecreto.getString("INFOPAG");
										...
										String autor = plantillaNotificacionesDecreto.getString("AUTOR");
								        String autorInfo = plantillaNotificacionesDecreto.getString("AUTOR_INFO");								        
...
//			}
			...
			logger.error ("Error en getInfoPag al obtener el valor INFOPAG del documento: "+e);
			return null;
		}
	...
	private int getDocumentId (IRuleContext rulectx){
		try{
			...
			logger.error ("Error en getDocumentId al obtener el valor ID del documento: "+e);
			return -1;
		}
