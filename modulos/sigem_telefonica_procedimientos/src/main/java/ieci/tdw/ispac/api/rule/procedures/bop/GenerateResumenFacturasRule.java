 ...
 *
 */
public class GenerateResumenFacturasRule implements IRule 
{
    /** Logger de la clase. */
    ...
    public Object execute(IRuleContext rulectx) throws ISPACRuleException {
        ...
        try{
            ...
            strQuery = "WHERE TIPO_FACTURACION = 'Pago sin crédito' AND FECHA_PUBLICACION BETWEEN '" + fechaInicio +"' AND '" + fechaFin + "' ORDER BY ENTIDAD";
