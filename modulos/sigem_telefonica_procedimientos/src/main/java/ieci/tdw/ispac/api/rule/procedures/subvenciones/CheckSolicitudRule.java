...
public class CheckSolicitudRule implements IRule {
    ...
    public boolean validate(IRuleContext rulectx) throws ISPACRuleException
    {
    	...
    	try
    	{
	        ...
	        else
	        {
	        	...
	        	//Obtención de datos
	        	String strPresentadaOld = solicitudOld.getString("PRESENTADA"); if (strPresentadaOld==null) strPresentadaOld="NO"; 
	        	String strPresentadaNew = solicitudNew.getString("PRESENTADA"); if (strPresentadaNew==null) strPresentadaNew="NO";
	        	String strSubsanadaOld = solicitudOld.getString("SUBSANADA"); if (strSubsanadaOld==null) strSubsanadaOld="NO";
	        	String strSubsanadaNew = solicitudNew.getString("SUBSANADA"); if (strSubsanadaNew==null) strSubsanadaNew="NO";
	        	String strSeleccionadaOld = solicitudOld.getString("SELECCIONADA"); if (strSeleccionadaOld==null) strSeleccionadaOld="NO";
	        	String strSeleccionadaNew = solicitudNew.getString("SELECCIONADA"); if (strSeleccionadaNew==null) strSeleccionadaNew="NO";
	        	String strJustificadaOld = solicitudOld.getString("JUSTIFICADA"); if (strJustificadaOld==null) strJustificadaOld="NO";
	        	String strJustificadaNew = solicitudNew.getString("JUSTIFICADA"); if (strJustificadaNew==null) strJustificadaNew="NO";
    ...
    public Object execute(IRuleContext rulectx) throws ISPACRuleException
    {
    	...
    	try
    	{
	        ...
	        strQuery = "WHERE NUMEXP='" + strNumexpConvNew + "'";
	        coll = entitiesAPI.queryEntities("SUBV_CONVOCATORIA", strQuery);
	    	...
	    	strQuery = "WHERE NUMEXP_PADRE = '" + strNumexpConvOld + "'" +
	...
	private boolean dentroDelPlazo(IRuleContext rulectx, String numExpConv) throws ISPACRuleException{
		...
		try
		{
			...
			String strQuery = "WHERE NUMEXP='" + numExpConv + "'";
			IItemCollection coll = entitiesAPI.queryEntities("TSOL_FECHAS", strQuery);
			Iterator it = coll.iterator();
			if (it.hasNext())
			{
