...
public class InitDecretoRaminpRule implements IRule {
    ...
    public Object execute(IRuleContext rulectx) throws ISPACRuleException {
        try {
            ...
            List<String> expedientesRelacioandos = ExpedientesRelacionadosUtil.getExpRelacionadosPadres(entitiesAPI, numexpDecr);
            
            if (expedientesRelacioandos.isEmpty()){
                return Boolean.FALSE;
            }        
            
            String numexpEnt = expedientesRelacioandos.get(0);
