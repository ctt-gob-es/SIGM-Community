...
public class InitDecretoIlegalRule implements IRule {
    ...
    private static final Logger LOGGER = Logger.getLogger(InitDecretoIlegalRule.class);
    ...
    public Object execute(IRuleContext rulectx) throws ISPACRuleException {
        ...
        try {
            ...
            IItemCollection collExpsAux = entitiesAPI.getEntities("SPAC_FASES", numexpDecr);
