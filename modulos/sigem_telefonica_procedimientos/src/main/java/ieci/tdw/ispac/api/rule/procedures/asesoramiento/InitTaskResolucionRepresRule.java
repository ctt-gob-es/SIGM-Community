...
public class InitTaskResolucionRepresRule implements IRule {
    
    private static final Logger LOGGER = Logger.getLogger(InitTaskResolucionRepresRule.class);

    protected String strQueryDocumentos = "NOMBRE = 'Providencia' OR " + "NOMBRE = 'Informe jurídico'";        
