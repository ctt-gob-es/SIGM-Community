 ...
 */
public class DeleteStatusTaskSancionadorRule implements IRule {
            ...
            if (itExps.hasNext()){
                ...
                if (ValidateStatusTaskSancionadorRule.isTramiteIniciado(transicion)){
                    if (transicionAnterior != null){
                        ...
                        String inicio = ValidateStatusTaskSancionadorRule.getPrimerTramite(transicion);
                        //String fin = transicion.substring(6, 11);
                        String fin = ValidateStatusTaskSancionadorRule.getSegundoTramite(transicion);
