...
public class InitPropuestaRepresRule implements IRule {
    ...
    private static final Logger LOGGER = Logger.getLogger(InitPropuestaRepresRule.class);
    
    protected String strEntidad = "ASES_REPRES";
    protected String strExtracto = "Propuesta de autorización de representación en juicio";
