...
public class InitTaskResolucionPlaneamientoRule implements IRule {
    
    private static final Logger LOGGER = Logger.getLogger(InitTaskResolucionPlaneamientoRule.class);
