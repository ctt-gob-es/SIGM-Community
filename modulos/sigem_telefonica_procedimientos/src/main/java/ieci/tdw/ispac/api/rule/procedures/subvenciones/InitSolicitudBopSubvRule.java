...
public class InitSolicitudBopSubvRule implements IRule {
	...
	protected String STR_entidad = "SUBV_CONVOCATORIA";
	protected String STR_BOP_entidad = "Servicio de ";
	protected String STR_BOP_urgencia = "Normal";
	protected String STR_BOP_sumario = "Convocatoria de ";
	protected String STR_BOP_observaciones = "Solicitud automática desde expediente: Convocatoria de Subvenciones";
    ...
    public Object execute(IRuleContext rulectx) throws ISPACRuleException
    {
    	try
    	{
			...
			if (solicitud != null)
			{
				solicitud.set("ENTIDAD", STR_BOP_entidad + entidad.getString("SERVICIO"));
				solicitud.set("URGENCIA", STR_BOP_urgencia);
				solicitud.set("SUMARIO", STR_BOP_sumario + entidad.getString("TITULO"));
			...
			IItemCollection documentsCollection = entitiesAPI.getDocuments(numexp_ent, "NOMBRE LIKE 'Anuncio%'", "FDOC DESC");
