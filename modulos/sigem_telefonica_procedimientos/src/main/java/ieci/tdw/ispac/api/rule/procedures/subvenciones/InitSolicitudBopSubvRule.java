...
public class InitSolicitudBopSubvRule implements IRule {
    
    private static final Logger LOGGER = Logger.getLogger(InitSolicitudBopSubvRule.class);

    protected String strEntidad = "SUBV_CONVOCATORIA";
    protected String strBOPEntidad = "Servicio de ";
    protected String strBOPUrgencia = "Normal";
    protected String strBOPSumario = "Convocatoria de ";
    protected String strBOPObservaciones = "Solicitud automática desde expediente: Convocatoria de Subvenciones";
    ...
    public Object execute(IRuleContext rulectx) throws ISPACRuleException {
        try {
            ...
            if (solicitud != null) {
                solicitud.set("ENTIDAD", strBOPEntidad + entidad.getString("SERVICIO"));
                solicitud.set("URGENCIA", strBOPUrgencia);
                solicitud.set("SUMARIO", strBOPSumario + entidad.getString("TITULO"));
            ...
            IItemCollection documentsCollection = entitiesAPI.getDocuments(numexpEnt, "NOMBRE LIKE 'Anuncio%'", "FDOC DESC");
