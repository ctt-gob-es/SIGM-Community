...
public class InitSolicitudBopRaminpRule implements IRule {
    
    private static final Logger LOGGER = Logger.getLogger(InitSolicitudBopRaminpRule.class);

    protected String strEntidad = "URB_LIC_RAMINP";
    protected String strBOPEntidad = "ÁREA DE INFRAESTRUCTURAS";
    protected String strBOPUrgencia = "Normal";
    protected String strBOPSumario = "Solicitud de licencia para actividad sujeta al RAMINP vigente en CLM";
    protected String strBOPObservaciones = "Solicitud automática desde expediente: Licencia de actividad sujeta al RAMINP";
