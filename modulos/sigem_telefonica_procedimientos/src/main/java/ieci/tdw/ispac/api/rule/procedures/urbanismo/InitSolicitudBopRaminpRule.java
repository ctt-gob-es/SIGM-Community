...
public class InitSolicitudBopRaminpRule implements IRule {
	...
	protected String STR_entidad = "URB_LIC_RAMINP";
	protected String STR_BOP_entidad = "ÁREA DE INFRAESTRUCTURAS";
	protected String STR_BOP_urgencia = "Normal";
	protected String STR_BOP_sumario = "Solicitud de licencia para actividad sujeta al RAMINP vigente en CLM";
	protected String STR_BOP_observaciones = "Solicitud automática desde expediente: Licencia de actividad sujeta al RAMINP";
