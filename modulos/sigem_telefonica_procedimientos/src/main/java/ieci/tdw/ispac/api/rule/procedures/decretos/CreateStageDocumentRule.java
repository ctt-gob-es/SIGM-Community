 ...
 * @author diezp
 * @date 27/11/2008
 * @propósito Al iniciar la fase "Traslados, Notificaciones y Acuses de recibo", se crea un documento para este trámite
 ...
 */
public class CreateStageDocumentRule implements IRule {
    ...
    public Object execute(IRuleContext rulectx) throws ISPACRuleException {
        ...
        try{
            ...
            // Obtener el único documento que tiene hasta el momento el expediente
            ...
            if (documentsCollection!=null && documentsCollection.next()){
                ...
                IItemCollection collection = entitiesAPI.getEntities(SpacEntities.SPAC_FASES, rulectx.getNumExp());
                IItem item = (IItem)collection.iterator().next();
                
                IItem nuevoDecreto = (IItem)genDocAPI.createStageDocument(item.getInt("ID"),decreto.getInt("ID_TPDOC"));
