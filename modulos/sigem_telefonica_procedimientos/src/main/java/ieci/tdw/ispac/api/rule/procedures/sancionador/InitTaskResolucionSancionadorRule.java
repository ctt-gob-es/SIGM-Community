...
public class InitTaskResolucionSancionadorRule implements IRule {
    
    private static final Logger LOGGER = Logger.getLogger(InitTaskResolucionSancionadorRule.class);
