...
/**
 * Error ocurrido durante el proceso del anuncio. Impide que se procese
 * todo el envio
 */
public class Error  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.boe.es/ServicioNotificaciones/", "Error"));
