...
public class CargaCabeceraPieExpedienteRule implements IRule{
	
	public static final Logger logger = Logger.getLogger(CargaCabeceraPieExpedienteRule.class);
	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException {
		...
		try {
			...
			itAnuncioTexto.store(rulectx.getClientContext());
			itAnuncioTexto = ConsultasGenericasUtil.createEntities(rulectx, "TABLON_EDICTAL_BOE_PARRAFOS");
			itAnuncioTexto.set("PARRAFO", "Contra los actos objeto de notificación podrá interponerse recurso de reposición ante el Presidente  de la Diputación, en el plazo de un mes a contar desde el día siguiente al que tenga efectividad la notificación de los citados actos, de conformidad con lo establecido en el artículo 14.2 c) del R.D. Legislativo 2/2004 de 5 de marzo, por el que se aprueba el Texto Refundido de  la Ley  Reguladora de las Haciendas Locales.");
			itAnuncioTexto.store(rulectx.getClientContext());
			itAnuncioTexto = ConsultasGenericasUtil.createEntities(rulectx, "TABLON_EDICTAL_BOE_PARRAFOS");
