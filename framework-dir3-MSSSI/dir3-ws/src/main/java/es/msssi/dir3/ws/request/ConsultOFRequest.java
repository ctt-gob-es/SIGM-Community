...
/**
 * Datos entrada del servicio web de consulta de OF.
 * 
 * @author cmorenog
 * 
 */
@XmlType(name = "consultOFRequest",
    namespace = "http://es.msssi.dir3.ws.ConsultService/consultOFRequest")
