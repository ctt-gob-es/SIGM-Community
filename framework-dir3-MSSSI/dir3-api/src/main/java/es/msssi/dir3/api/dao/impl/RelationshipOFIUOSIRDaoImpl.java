 ...
 * 
 */
public class RelationshipOFIUOSIRDaoImpl extends SqlMapClientBaseDao implements
		RelationshipDao {
	...
	private static final Logger logger = Logger
			.getLogger(RelationshipOFIUOSIRDaoImpl.class);
	...
	public void update(RelationshipOFIUOVO entity) throws SQLException {
		logger.info("Modifico una relación SIR:" + entity.getId());
	...
	public boolean isSIR(RelationshipOFIUOVO entity) throws SQLException {
		...
		boolean exist = false;
		Integer rel;
		rel = (Integer) getSqlMapClientTemplate().queryForObject(ISSIR, entity);
		if (rel != null && rel > 0) {
			exist = true;
		}
		return exist;
