...
/**
 * Interfaz de los DAOs de datos básicos de contacto de ofcinas.
 * 
 * @author cmorenog
 * 
 */
public interface ContactOFIDao extends BaseDao<ContactOFIVO, Integer, CriterionEnum> {
