...
public class XmlDcoToObject {
     ...
     */
    public OfficesVO getOfficesFromXmlFile(
	String xmlFilePath)
	throws DIR3Exception {
	...
	OfficesVO officesVO = null;
	 if (xmlFilePath != null){
        	try {
        		...
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTOOFFICE_ERROR, fileNotFoundException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTOOFFICE_ERROR, fileNotFoundException);
        	    }
        	    try {
        		officesVO = (OfficesVO) getUnmarshaller().unmarshal(
        		    new StreamSource(
        			is));
        	    }
        	    catch (XmlMappingException xmlMappingException) {
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTOOFFICE_ERROR, xmlMappingException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTOOFFICE_ERROR, xmlMappingException);
        	    }
        	    catch (IOException iOException) {
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTOOFFICE_ERROR, iOException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTOOFFICE_ERROR, iOException);
        	    }
        	}
        	finally {
        	    if (is != null) {
     ...
     * @throws DIR3Exception .
     */
    public ContactsOFIVO getContactsOFIFromXmlFile(
	String xmlFilePath)
	throws DIR3Exception {
	FileInputStream is = null;
	...
	if (xmlFilePath != null){
        	try {
        		...
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTOCONTACTS_ERROR, fileNotFoundException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTOCONTACTS_ERROR, fileNotFoundException);
        	    }
        	    try {
        		ContactsOFIVO = (ContactsOFIVO) getUnmarshaller().unmarshal(
        		    new StreamSource(
        			is));
        	    }
        	    catch (XmlMappingException xmlMappingException) {
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTOCONTACTS_ERROR, xmlMappingException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTOCONTACTS_ERROR, xmlMappingException);
        	    }
        	    catch (IOException iOException) {
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTOCONTACTS_ERROR, iOException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTOCONTACTS_ERROR, iOException);
        	    }
        	}
        	finally {
        	    if (is != null) {
     ...
     * @throws DIR3Exception .
     */
    public ServicesVO getServicesFromXmlFile(
	String xmlFilePath)
	throws DIR3Exception {
	FileInputStream is = null;
	...
	if (xmlFilePath != null){
        	try {
        		...
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTOSERVICES_ERROR, fileNotFoundException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTOSERVICES_ERROR, fileNotFoundException);
        	    }
        	    try {
        		servicesVO = (ServicesVO) getUnmarshaller().unmarshal(
        		    new StreamSource(
        			is));
        	    }
        	    catch (XmlMappingException xmlMappingException) {
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTOSERVICES_ERROR, xmlMappingException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTOSERVICES_ERROR, xmlMappingException);
        	    }
        	    catch (IOException iOException) {
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTOSERVICES_ERROR, iOException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTOSERVICES_ERROR, iOException);
        	    }
        	}
        	finally {
        	    if (is != null) {
     ...
     * @throws DIR3Exception .
     */
    public ContactsUOVO getContactsUOFromXmlFile(
	String xmlFilePath)
	throws DIR3Exception {
	FileInputStream is = null;
	...
	if (xmlFilePath != null){
        	try {
        	    ...
        	    try {
        		ContactsUOVO = (ContactsUOVO) getUnmarshaller().unmarshal(
        		    new StreamSource(
        			is));
        	    }
        	    catch (XmlMappingException xmlMappingException) {
     ...
     * @throws DIR3Exception .
     */
    public UnitsVO getUnitsFromXmlFile(
	String xmlFilePath)
	throws DIR3Exception {
	FileInputStream is = null;
	...
	if (xmlFilePath != null){
        	try {
        		...
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTOUNITS_ERROR, fileNotFoundException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTOUNITS_ERROR, fileNotFoundException);
        	    }
        	    try {
        		unitsVO = (UnitsVO) getUnmarshaller().unmarshal(
        		    new StreamSource(
        			is));
        	    }
        	    catch (XmlMappingException xmlMappingException) {
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTOUNITS_ERROR, xmlMappingException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTOUNITS_ERROR, xmlMappingException);
        	    }
        	    catch (IOException iOException) {
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTOUNITS_ERROR, iOException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTOUNITS_ERROR, iOException);
        	    }
        	}
        	finally {
        	    if (is != null) {
     ...
     *         Organismos de DCO.
     */
    public HistoriesVO getHistoriesFromXmlFile(
	String xmlFilePath) {
	FileInputStream is = null;
	...
	if (xmlFilePath != null) {
		...
		try {
		    ...
		    logger.error(
			ErrorConstants.CONVERT_XMLTOHISTORIC_ERROR, fileNotFoundException);
		}
		try {
		    historiesVO = (HistoriesVO) getUnmarshaller().unmarshal(
			new StreamSource(
			    is));
		}
		catch (XmlMappingException xmlMappingException) {
		    logger.error(
			ErrorConstants.CONVERT_XMLTOHISTORIC_ERROR, xmlMappingException);
		}
		catch (IOException iOException) {
		    logger.error(
			ErrorConstants.CONVERT_XMLTOHISTORIC_ERROR, iOException);
		}
	    }
	    finally {
		if (is != null) {
     ...
     * @throws DIR3Exception .
     */
    public RelationshipsOFIUOVO getRelationsFromXmlFile(
	String xmlFilePath)
	throws DIR3Exception {
	FileInputStream is = null;
	...
	if (xmlFilePath != null){
        	try {
        		...
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTORELATIONS_ERROR, fileNotFoundException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTORELATIONS_ERROR, fileNotFoundException);
        	    }
        	    try {
        		relationshipsOFIUOVO = (RelationshipsOFIUOVO) getUnmarshaller().unmarshal(
        		    new StreamSource(
        			is));
        	    }
        	    catch (XmlMappingException xmlMappingException) {
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTORELATIONS_ERROR, xmlMappingException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTORELATIONS_ERROR, xmlMappingException);
        	    }
        	    catch (IOException iOException) {
        		logger.error(
        		    ErrorConstants.CONVERT_XMLTORELATIONS_ERROR, iOException);
        		new DIR3Exception(
        		    DIR3ErrorCode.CONVERT_XMLTORELATIONS_ERROR, iOException);
        	    }
        	}
        	finally {
        	    if (is != null) {
     ...
     * @throws DIR3Exception .
     */
    public RelationshipsOFIUOVO getRelationsSIRFromXmlFile(
	String xmlFilePath)
	throws DIR3Exception {
	FileInputStream is = null;
	RelationshipsOFIUOVO relationshipsOFIUOVO = null;
	...
	if (xmlFilePath != null){
        	try {
        	    ...
        	    try {
        		relationshipsOFIUOSIRVO = (RelationshipsOFIUOSIRVO) getUnmarshaller().unmarshal(
        		    new StreamSource(
        			is));
     ...
     * @throws DIR3Exception .
     */
    public ContactsUOVO getContactsUNOFromXmlFile(
	String xmlFilePath)
	throws DIR3Exception {
	FileInputStream is = null;
	ContactsUOVO contactsUOVO = null;
	...
	if (xmlFilePath != null){
        	try {
        	    ...
        	    try {
        		contactsUNOVO = (ContactsUNOVO) getUnmarshaller().unmarshal(
        		    new StreamSource(
        			is));
