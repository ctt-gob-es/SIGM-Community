...
public class AddressVO extends Entity {
     ...
     * Observaciones de la dirección.
     */
    private String observationsloc;
	...
	public String getObservationsloc() {
		return observationsloc;
	}

	public void setObservationsloc(String observationsloc) {
		this.observationsloc = observationsloc;
	}
