 ...
 * 
 */
public interface UnitRegistroDao extends BaseDao<UnitVO, String, UOCriterionEnum> {
	...
	public void save(UnitRegistro tempUnit) throws SQLException;
	public void update(UnitRegistro tempUnit) throws SQLException;
}
