...
public class ServiceDaoImpl extends SqlMapClientBaseDao implements ServiceDao {
	 ...
	 * @throws SQLException .
	 */
	public ServiceVO get(HashMap<String, String> ids) throws SQLException {
		logger.info("Obteniendo un servicio con el id de oficina: "
				+ ids.get("officeId") + ";idservicio" + ids.get("service"));
		ServiceVO service;
		service = (ServiceVO) getSqlMapClientTemplate().queryForObject( GETSERVICE, ids);
	 ...
	 * @throws SQLException .
	 */
	public boolean exists(HashMap<String, String> ids) throws SQLException {
	 ...
	 * @throws SQLException .
	 */
	public void save(ServiceVO entity) throws SQLException {
		logger.info("Guardar un servivio");
		getSqlMapClient().insert(INSERTSERVICE, entity);
	}
	 ...
	 * @throws SQLException .
	 */
	public void update(ServiceVO entity) throws SQLException {
		logger.info("Modifico un servicio:" + entity.getId() + " y oficina: " + entity.getOfficeId());
		getSqlMapClient().update(UPDATESERVICE, entity);
	}
	...
	public void deleteServices(String id) throws SQLException {
		logger.info("Borrar los servicios de la oficina:" + id);
		getSqlMapClient().update(DELETESERVICE, id);
	}
	...
	public List<ServiceVO> getServices(String id) throws SQLException {
		logger.info("Devuelve los servicios de la oficina:" + id);
		List<ServiceVO> list;
		list = (List<ServiceVO>) getSqlMapClientTemplate().queryForList( LISTSERVICES, id);
		return list;
	}
}
