...
public class RelationshipRegistroManagerImpl implements RelationshipRegistroManager, Serializable {
	 ...
	 */
	public void updateRelationships(RelationshipsOFIUOVO relationshipsVO, ServicesVO servicesDCO) throws DIR3Exception {
		if (relationshipsVO != null) {
			Map<String, String> ids = null;
			for (RelationshipOFIUOVO relation : relationshipsVO.getRelationships()) {
				try {
					ids = new HashMap<String, String>();
					ids.put("unitId", relation.getUnitId());
					ids.put("officeId", relation.getOfficeId());
					...
					LOG.error(ErrorConstants.INSERT_RELATIONSHIP_ERROR_MESSAGE + "OfficeId:" + relation.getOfficeId() + " UnitId:" + relation.getUnitId() + "; ", exception);
				}
			}
		}
		if (servicesDCO != null) {
	 ...
	 * 
	 */
	public void save(RelationshipOFIUOVO relation) throws DIR3Exception {
		try {
			if (relation != null) {
			...
			LOG.error(ErrorConstants.INSERT_RELATIONSHIP_ERROR_MESSAGE, sqlException);
			LOG.error("ERROR Insertando la relación: unitId: " + relation.getUnitId() + "; officeId: " + relation.getOfficeId());
			/*
			 * throw new DIR3Exception( DIR3ErrorCode.INSERT_RELATIONSHIP_ERROR,
	 ...
	 * 
	 */
	public boolean isSIR(RelationshipOFIUOVO relation) throws DIR3Exception {
		boolean result = true;
		try {
			if (relation != null) {
	 ...
	 * 
	 */
	public List<RelationshipOFIUOVO> getUnitsDir(String idEntity) throws DIR3Exception {
	 ...
	 * 
	 */
	public void update(RelationshipOFIUOVO relation) throws DIR3Exception {
		try {
			if (relation != null) {
				LOG.info("Modificamos la relación: unitId" + relation.getUnitId() + "; officeId: " + relation.getOfficeId());
				relationshipDao.startTransaction();
				relationshipDao.update(relation);
				relationshipDao.commitTransaction();
			}
		} catch (SQLException sqlException) {
			LOG.error(ErrorConstants.UPDATE_RELATIONSHIP_ERROR_MESSAGE, sqlException);
			LOG.error("ERROR Modificando la relación: unitId" + relation.getUnitId() + "; officeId: " + relation.getOfficeId());
			/*
			 * throw new DIR3Exception( DIR3ErrorCode.UPDATE_RELATIONSHIP_ERROR,
	 ...
	 * 
	 */
	public void delete(RelationshipOFIUOVO relation) throws DIR3Exception {
		try {
			if (relation != null) {
				relationshipDao.startTransaction();
			...
			LOG.error(ErrorConstants.DELETE_RELATIONSHIPREGISTER_ERROR_MESSAGE, sqlException);
			LOG.error("ERROR Borrando la relación: unitId" + relation.getUnitId() + "; officeId: " + relation.getOfficeId());
			throw new DIR3Exception( DIR3ErrorCode.DELETE_RELATIONSHIPREGISTER_ERROR, ErrorConstants.DELETE_RELATIONSHIPREGISTER_ERROR_MESSAGE, sqlException);
		} finally {
			relationshipDao.endTransaction();
		}
	}
	 ...
	 * @throws DIR3Exception .
	 */
	public RelationshipOFIUOVO get(Map<String, String> ids) throws DIR3Exception {
		RelationshipOFIUOVO result = null;
		try {
			if (ids != null && (ids.get("unitId") != null && ids.get("officeId") != null)) {
				LOG.info("Recuperando una relación: unitId: " + ids.get("unitId") + "; officeId: " + ids.get("officeId"));
				// Buscamos datos basicos de la unidad organica
				result = (RelationshipOFIUOVO) relationshipDao.get(ids);
			}
		} catch (SQLException sqlException) {
			LOG.error(ErrorConstants.GET_RELATIONSHIP_ERROR_MESSAGE, sqlException);
			throw new DIR3Exception(DIR3ErrorCode.GET_RELATIONSHIP_ERROR, ErrorConstants.GET_RELATIONSHIP_ERROR_MESSAGE, sqlException);
		}
		return result;
	}
	 ...
	 * @throws DIR3Exception .
	 */
	public boolean exists(Map<String, String> anId) throws DIR3Exception {
		...
		try {
			...
			LOG.error(ErrorConstants.EXISTS_RELATIONSHIP_ERROR_MESSAGE, sqlException);
			throw new DIR3Exception(DIR3ErrorCode.EXISTS_RELATIONSHIP_ERROR, ErrorConstants.EXISTS_RELATIONSHIP_ERROR_MESSAGE, sqlException);
		}
		return result;
	}
	 ...
	 */
	public void setRelationshipDao(RelationshipRegisterDao relationshipDao) {
