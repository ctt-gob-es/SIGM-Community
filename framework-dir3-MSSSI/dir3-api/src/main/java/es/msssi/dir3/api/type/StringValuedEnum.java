...
public class StringValuedEnum extends Enum {
     ...
     *            the class of the <code>Enum</code> to get.
     * @param name
     *            the name of the <code>Enum</code> to get.
     * @return the enum object, or null if the enum does not exist.
     */
    @SuppressWarnings("rawtypes")
    public static Enum getEnumName(
	Class enumClass, String name) {
	StringValuedEnum result = null;
	if (enumClass == null) {
	    throw new IllegalArgumentException(
		"The Enum Class must not be null");
