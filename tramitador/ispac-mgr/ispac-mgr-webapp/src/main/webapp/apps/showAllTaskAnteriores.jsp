			...
			<logic:iterate name="Formatter" id="format"
				...
				<logic:equal name="format" property="fieldType" value="LINK">
					...
					<display:column titleKey='<%=format.getTitleKey()%>'
						...
						<a class="tdlink"
							href="javascript:redirect(<%="'"+request.getContextPath()+"/showTask.do?key="%><bean:write name='value' property='property(SPAC_DT_TRAMITES:ID)'/>
							<%="&taskId="%><bean:write name='value' property='property(SPAC_DT_TRAMITES:ID_TRAM_EXP)'/>
							<%="&stagePcdIdActual="%><bean:write name='value' property='property(SPAC_DT_TRAMITES:ID_FASE_PCD)'/>');">
