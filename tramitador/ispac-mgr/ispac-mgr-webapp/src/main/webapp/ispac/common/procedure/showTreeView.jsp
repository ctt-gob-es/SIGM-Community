...
<%@ taglib uri="/WEB-INF/ispac-util.tld" prefix="ispac"%>
	...
	<link rel="shortcut icon" href='/SIGEM_TramitacionWeb/ispac/skin1/img/favicon.ico' type="image/x-icon"/>
  	<link rel="icon" href='/SIGEM_TramitacionWeb/ispac/skin1/img/favicon.ico' type="image/x-icon"/>
	<link rel="stylesheet" href='/SIGEM_TramitacionWeb/ispac/skin1/css/styles.css'/>
	<link rel="stylesheet" href='/SIGEM_TramitacionWeb/ispac/skin1/css/estilos.css'/>
	<link rel="stylesheet" href='/SIGEM_TramitacionWeb/ispac/skin1/css/menus.css'/>

	<link rel="stylesheet" type="text/css" href='/SIGEM_TramitacionWeb/ispac/skin1/css/estilos_cab.css'/>
	
	<!--[if lte IE 5]>
		<link rel="stylesheet" type="text/css" href='/SIGEM_TramitacionWeb/ispac/skin1/css/estilos_ie5.css'/>
		<link rel="stylesheet" type="text/css" href='/SIGEM_TramitacionWeb/ispac/skin1/css/estilos_cab_ie5.css'/>
	<![endif]-->	

	<!--[if IE 6]>
		<link rel="stylesheet" type="text/css" href='/SIGEM_TramitacionWeb/ispac/skin1/css/estilos_ie6.css'>
		<link rel="stylesheet" type="text/css" href='/SIGEM_TramitacionWeb/ispac/skin1/css/estilos_cab_ie6.css'/>
	<![endif]-->	

	<!--[if gte IE 7]>
		<link rel="stylesheet" type="text/css" href='/SIGEM_TramitacionWeb/ispac/skin1/css/estilos_ie7.css'>
		<link rel="stylesheet" type="text/css" href='/SIGEM_TramitacionWeb/ispac/skin1/css/estilos_cab_ie7.css'/>
	<![endif]-->

	<link rel="stylesheet" href='/SIGEM_TramitacionWeb/ispac/skin1/css/nicetabs.css'/>
	<script type="text/javascript" src='/SIGEM_TramitacionWeb/ispac/skin1/../scripts/forms.js'></script>
	<script type="text/javascript" src='/SIGEM_TramitacionWeb/ispac/skin1/../scripts/sorttable.js'> </script>
	<script type="text/javascript" src='/SIGEM_TramitacionWeb/ispac/skin1/../scripts/utilities.js'> </script>
	...
	<div class="ficha"> 
		<div class="encabezado_ficha">
			<div class="titulo_ficha">
				<h4><label alt = '<bean:message key="menu.ayuda" />' title = '<bean:message key="menu.ayuda" />' id="titulo"><bean:message key="menu.ayuda" /></label></h4>
		...
		<!-- [eCenpri-Manu #281] - INICIO - Edición de plantillas desde el tramitador por usuarios -->			
			<c:if test="${PUEDE_EDITAR_TEMPLATES}">
				<script>
					function consultaEdicionTemplate(idTemplate){
						jConfirm('<bean:message key="form.template.edicionTemplate"/><bean:message key="form.template.edicionTemplate.info"/>', '<bean:message key="common.confirm"/>' , '<bean:message key="common.message.ok"/>' , '<bean:message key="common.message.cancel"/>', function(r) {
							if(r) {
								var url = document.location.href + '/editTemplateArbol.do?template=' + idTemplate;
								url = url.replace('manageVistaCuadroProcedimiento.do/', '');
			...
			<c:if test="${!PUEDE_EDITAR_TEMPLATES}">
				<script>
					function consultaEdicionTemplate(idTemplate){
						jConfirm('<bean:message key="form.template.consultaTemplate"/>', '<bean:message key="common.alert"/>' , '<bean:message key="common.message.ok"/>' , '<bean:message key="common.message.cancel"/>', function(r) {
							if(r) {
								var url = document.location.href + '/showTemplateArbol.do?template=' + idTemplate;
								url = url.replace('manageVistaCuadroProcedimiento.do/', '');
		...
		<!-- [eCenpri-Manu #281] - FIN - Edición de plantillas desde el tramitador por usuarios -->
			...
			<div class="divArbol">
				...
				<tree:show action="manageVistaCuadroProcedimiento.do" name='<%=viewName%>' imagesPath='<%=images_tree_path%>' jsCodeFile='<%=scripts_tree_path+"tree.js"%>' imageConfFile='<%=scripts_tree_path+"entidades_tree_tpl.js"%>' target="ibasefrm">
