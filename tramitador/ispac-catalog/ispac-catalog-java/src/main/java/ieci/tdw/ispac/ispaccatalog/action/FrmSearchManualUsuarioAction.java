...
public class FrmSearchManualUsuarioAction extends BaseDispatchAction {
 ...
 */
	public ActionForward show(ActionMapping mapping, ActionForm form,
		...
		if(StringUtils.isNotEmpty(idFrmS)){
			IItemCollection itemcol=catalogAPI.getManualesUsuarioByType(CTManualUsuarioDAO.SEARCH_TYPE);
//		    IItemCollection itemcolAsociate=catalogAPI.getAsociateMaualesUsuario(Integer.parseInt(idFrmS));
