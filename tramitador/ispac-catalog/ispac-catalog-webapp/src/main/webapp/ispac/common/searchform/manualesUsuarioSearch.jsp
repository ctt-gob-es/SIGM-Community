...
<script>
	...
	function save(){
		var actionURL='<c:url value="/frmSearchManualesUsuarioAction.do?method=save"/>';
...
<div id="navSubMenuTitle">
	<bean:message key="form.search.manualUsuarioAsociate"/>
</div>
<div id="navmenu" >
...
<html:form action="/frmSearchManualUsuarioAction.do" method="post">
	...
	%>
	<display:table name="CTManualesUsuarioList"
				   id='itemobj'
				   form="defaultForm"
				   ...
				   sort="list"
				   pagesize="45"
				   requestURI='/frmSearchManualUsuarioAction.do'>

		<logic:present name="itemobj">

			<bean:define id='item' name='itemobj' type='ieci.tdw.ispac.ispaclib.bean.ObjectBean'/>

			 <logic:iterate name="CTManualesUsuarioListFormatter" id="format" type="ieci.tdw.ispac.ispaclib.bean.BeanPropertyFmt">
