	...
	<ul class="tabButtonList">
		<li>
			<ispac:linkframe id="EVENTMANAGER"
					 styleClass=""
				     target="workframe"
					action='<%="selectObject.do?codetable=SPAC_CT_MANUALES_USUARIO&codefield=ID&valuefield=NOMBRE&caption=select.manualesUsuario.caption&decorator=/formatters/manualesUsuario/choosemanualusuarioformatter.xml&pcdId=" + pcdId + "&tpObj="+TpObj+"&sqlquery=" + java.net.URLEncoder.encode("WHERE TIPO=2")%>'
					 titleKey="procedure.tabs.manualesUsuario.add"
					 width="640"
					 height="480"
					 showFrame="true">
			</ispac:linkframe>
...
<div class="tabContent">
	...
	<display:table name="manualesUsuarioList" id="itemobj" export="false"
