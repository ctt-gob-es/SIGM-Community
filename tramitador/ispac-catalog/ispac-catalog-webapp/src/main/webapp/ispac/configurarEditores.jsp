...
.ficha2 {
	zoom: 1;
	background: url("skin1/img/bottom_right.gif") bottom right no-repeat;
}
...
.ficha2 .encabezado_ficha,.encabezado_ficha, .ficha_tabs .encabezado_ficha, .inner_ficha_tabs .encabezado_ficha {
	background: url("skin1/img/top_right.gif") top right no-repeat;
}

.encabezado_ficha .titulo_ficha {
	/*background: #E8E9EE;*/
	background: url("skin1/img/top_left.gif") left 0px no-repeat;
	padding: 0px 0px 6px 0px;
	margin: 0px;
}

.ficha2 div.cuerpo_ficha2, .ficha_tabs2 div.cuerpo_ficha2 {
	background: url("skin1/img/bottom_left.gif") bottom left no-repeat;
	padding-bottom: 6px;
	clear:right;
}
		...
		<div class="encabezado_ficha">
			<div class="titulo_ficha">
				...
				<div class="acciones_ficha">
					...
					<a href="#" id="btnCancel" onclick='javascript:top.ispac_needToConfirm=false;<ispac:hideframe refresh="true"/>' class="btnCancel" alt = '<bean:message key="forms.button.close" />' title = '<bean:message key="forms.button.close" />'><bean:message key="forms.button.close" /></a>
				</div>
			</div>
		</div>
		<div class="cuerpo_ficha2">
			<div class="seccion_ficha2" id="seccion1">

				<span class="pagebanner2" id="totalRegistros">&nbps;</span>
			...
			<div class="seccion_ficha2" id="seccion2" style=" display: none">
