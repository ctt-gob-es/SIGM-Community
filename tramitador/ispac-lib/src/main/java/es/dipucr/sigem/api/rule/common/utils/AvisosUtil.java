...
public class AvisosUtil {
	...
	/**
	 * Borrar todos los avisos electrónicos de un expediente
	 * @param rulectx
	 ...
	 */
	public static boolean borrarTodosAvisosByNumExp(IRuleContext rulectx, String numexp) throws ISPACRuleException{
	 ...
	 */
	public static void generarAviso(IEntitiesAPI entitiesAPI, int processId, String numexp, String message, String destiny, IClientContext ctx) throws ISPACException
	{
	 ...
	 * @throws ISPACException
	 */	
	public static void generarAvisoAtramite(IEntitiesAPI entitiesAPI, int processId, int tramiteId, String numexp, String message, String destiny,	IClientContext ctx) throws ISPACException
	{
		...
		notice.set("ID_EXPEDIENTE", numexp);
		notice.set("ESTADO_AVISO", 0);
		notice.set("ID_TRAMITE", tramiteId);
