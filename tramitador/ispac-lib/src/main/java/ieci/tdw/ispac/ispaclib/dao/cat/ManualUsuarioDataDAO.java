...
public class ManualUsuarioDataDAO extends ObjectDAO {

	private final static int CHUNK_SIZE = 10240;

	static final String TBNAME	= "SPAC_P_BLP_MANUALES_USUARIO";
	 ...
	 */
	public ManualUsuarioDataDAO() throws ISPACException {
	 ...
	 * @throws ISPACException
	 */
	public ManualUsuarioDataDAO(DbCnt cnt) throws ISPACException {
	 ...
	 * @throws ISPACException
	 */
	public ManualUsuarioDataDAO(DbCnt cnt, int id) throws ISPACException	{
	...
	throws ISPACException
	{
		...
		try
		{
			...
			sBuffer.append("DELETE FROM SPAC_P_BLP_MANUALES_USUARIO WHERE ID = ");
			sBuffer.append(id);
			cnt.directExec(sBuffer.toString());

			sBuffer.setLength(0);
			sBuffer.append("INSERT INTO SPAC_P_BLP_MANUALES_USUARIO (ID,NBYTES,MIMETYPE, BLOQUE) VALUES(");
			sBuffer.append(id);
